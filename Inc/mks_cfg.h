...
#define EPR_SINGLE_NOZZLE								EPR_E_ENABLE_ON + 2
#define EPR_ENABLE_LED								EPR_SINGLE_NOZZLE + 1
#define EPR_ENABLE_OFF								EPR_ENABLE_LED + 1
#define EPR_PRINT_FINESH_COUNT								EPR_ENABLE_OFF + 1
...
#define EPR_STANDBY_MODE								EPR_PRINT_FINESH_COUNT + 2
#define EPR_STANDBY_TIME								EPR_STANDBY_MODE + 1

#define EPR_ZERO_X_POS			EPR_STANDBY_TIME + 4
#define EPR_ZERO_Y_POS			EPR_ZERO_X_POS+4

#define EPR_END_ADDR			EPR_ZERO_Y_POS + 4
...
typedef struct
{
    ...
    volatile uint8_t wifi_type;
		...
		volatile uint8_t enable_led;
		volatile uint8_t enable_off;
