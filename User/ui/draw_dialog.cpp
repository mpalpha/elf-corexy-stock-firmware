				...
				else if(DialogType == DIALOG_TYPE_PRINT_FILE)
				{
					...
					else
					{
						...
						if((gCfgItems.filament_det0_level_flg == 0 && MKS_MT_DET1_OP == 0)
							||(gCfgItems.filament_det0_level_flg == 1 && MKS_MT_DET1_OP == 1)
							||((mksCfg.extruders == 2)&&(gCfgItems.filament_det1_level_flg == 0 && MKS_MT_DET2_OP == 0))
							||((mksCfg.extruders == 2)&&(gCfgItems.filament_det1_level_flg == 1 && MKS_MT_DET2_OP == 1)))
						{
							Clear_dialog();
