...
*/
	...
	TFT_Type_text = TEXT_CreateEx(BTN_X_PIXEL,BTN_Y_PIXEL-60, LCD_WIDTH-BTN_X_PIXEL, 30, hAboutWnd, WM_CF_SHOW,TEXT_CF_LEFT|GUI_TA_VCENTER, GUI_ID_TEXT1, "elf");
	...
	SPI_FLASH_BufferRead((u8 *)cmd_code,ABOUT_TYPE_ADDR,201);
	//strcat((char*)cmd_code,(const char *)about_menu.type_name);
	//strcat((char*)cmd_code,(const char *)cmd_code);
	TEXT_SetText(TFT_Type_text,(char *)cmd_code);
	HAL_Delay(30);
	memset(cmd_code,0,sizeof(cmd_code));
	SPI_FLASH_BufferRead((u8 *)cmd_code,ABOUT_VERSION_ADDR,201);
