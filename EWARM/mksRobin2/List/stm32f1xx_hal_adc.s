///////////////////////////////////////////////////////////////////////////////
//
// IAR ANSI C/C++ Compiler V7.10.1.6676/W32 for ARM       25/Feb/2020  18:23:22
// Copyright 1999-2014 IAR Systems AB.
//
//    Cpu mode     =  thumb
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_ºŒ∫Ã»˝Œ¨\mksRobin_Nano_code\Drivers\STM32F1xx_HAL_Driver\Src\stm32f1xx_hal_adc.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_ºŒ∫Ã»˝Œ¨\mksRobin_Nano_code\Drivers\STM32F1xx_HAL_Driver\Src\stm32f1xx_hal_adc.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_ºŒ∫Ã»˝Œ¨\mksRobin_Nano_code\EWARM\mksRobin2/List\stm32f1xx_hal_adc.s
//
///////////////////////////////////////////////////////////////////////////////
...
//  501                  tmp_cr2             );
        LDR      R2,[R4, #+0]
        LDR      R3,[R2, #+8]
        LDR.W    R6,??DataTable8_1  ;; 0xffe1f7fd
        ANDS     R3,R6,R3
        ORRS     R3,R1,R3
        STR      R3,[R2, #+8]
//  502 
...
//  531          == tmp_cr2)
        LDR      R2,[R4, #+0]
        LDR      R2,[R2, #+8]
        LDR.W    R3,??DataTable8_2  ;; 0xff1f0efe
        ANDS     R2,R3,R2
        CMP      R2,R1
...
//  613                                     ADC_CR1_AWDIE   | ADC_CR1_EOCIE  | ADC_CR1_AWDCH    ));
        LDR      R0,[R4, #+0]
        LDR      R1,[R0, #+4]
        LDR.W    R2,??DataTable8_3  ;; 0xff3f0000
        ANDS     R1,R2,R1
        STR      R1,[R0, #+4]
//  614     
...
//  620                                     ADC_CR2_ADON                                          ));
        LDR      R0,[R4, #+0]
        LDR      R1,[R0, #+8]
        LDR.W    R2,??DataTable8_4  ;; 0xff0106f0
        ANDS     R1,R2,R1
        STR      R1,[R0, #+8]
//  621     
...
//  789                       HAL_ADC_STATE_REG_BUSY);
        LDR      R1,[R4, #+40]
        LDR.W    R2,??DataTable8_5  ;; 0xfffffdfe
        ANDS     R1,R2,R1
        ORR      R1,R1,#0x100
        STR      R1,[R4, #+40]
//  790     
...
//  794     if (ADC_NONMULTIMODE_OR_MULTIMODEMASTER(hadc))
        ...
        LDR.W    R2,??DataTable8_7  ;; 0x40012404
        LDR      R2,[R2, #+0]
        AND      R2,R2,#0xF0000
        SUBS     R2,R2,#+1
        SBCS     R2,R2,R2
...
//  851         ADC_NONMULTIMODE_OR_MULTIMODEMASTER(hadc)  )
        ...
        SBCS     R1,R1,R1
        LSRS     R1,R1,#+31
        B.N      ??HAL_ADC_Start_13
??HAL_ADC_Start_12:
        MOVS     R1,#+1
??HAL_ADC_Start_13:
        CMP      R1,#+0
        BEQ.N    ??HAL_ADC_Start_11
//  852     {
...
??HAL_ADC_PollForConversion_11:
        ...
        SUBS     R0,R0,R6
        CMP      R5,R0
        BCS.N    ??HAL_ADC_PollForConversion_12
...
// 1126                       HAL_ADC_STATE_REG_BUSY);
        LDR      R1,[R4, #+40]
        LDR.W    R2,??DataTable8_15  ;; 0xfffff1fe
        ANDS     R1,R2,R1
        ORR      R1,R1,#0x100
        STR      R1,[R4, #+40]
// 1127     
...
// 1188         ADC_NONMULTIMODE_OR_MULTIMODEMASTER(hadc)  )
        ...
        SBCS     R1,R1,R1
        LSRS     R1,R1,#+31
        B.N      ??HAL_ADC_Start_IT_13
??HAL_ADC_Start_IT_12:
        MOVS     R1,#+1
??HAL_ADC_Start_IT_13:
        CMP      R1,#+0
        BEQ.N    ??HAL_ADC_Start_IT_11
// 1189     {
...
// 1304     if (ADC_NONMULTIMODE_OR_MULTIMODEMASTER(hadc))
        LDR.W    R0,??DataTable8_6  ;; 0x40012800
        LDR      R1,[R4, #+0]
        CMP      R1,R0
        BNE.N    ??HAL_ADC_Start_DMA_7
        LDR.W    R1,??DataTable8_7  ;; 0x40012404
        LDR      R1,[R1, #+0]
        AND      R1,R1,#0xF0000
        SUBS     R1,R1,#+1
...
// 1323       if (ADC_MULTIMODE_AUTO_INJECTED(hadc))
        LDR      R1,[R4, #+0]
        CMP      R1,R7
        BEQ.N    ??HAL_ADC_Start_DMA_11
        CMP      R1,R0
        BNE.N    ??HAL_ADC_Start_DMA_12
...
??HAL_ADC_ConfigChannel_7:
        ...
        CMP      R3,R4
        BNE.N    ??HAL_ADC_ConfigChannel_9
// 1765     {
// 1766       if (READ_BIT(hadc->Instance->CR2, ADC_CR2_TSVREFE) == RESET)
        LDR      R4,[R3, #+8]
        LSLS     R4,R4,#+8
        BMI.N    ??HAL_ADC_ConfigChannel_8
// 1767       {
...
// 1774           wait_loop_index = (ADC_TEMPSENSOR_DELAY_US * (SystemCoreClock / 1000000));
        ...
        LDR      R2,[R2, #+0]
        LDR.N    R3,??DataTable8_16  ;; 0xf4240
        UDIV     R2,R2,R3
        ADD      R3,R2,R2, LSL #+2
        LSLS     R2,R3,#+1
        STR      R2,[SP, #+0]
...
??HAL_ADC_AnalogWDGConfig_3:
        LDR      R2,[R0, #+0]
        LDR      R3,[R2, #+4]
        LDR.N    R4,??DataTable8_17  ;; 0xff3ffde0
        ANDS     R3,R4,R3
        LDR      R4,[R1, #+0]
        ORRS     R3,R4,R3
        LDR      R4,[R1, #+4]
