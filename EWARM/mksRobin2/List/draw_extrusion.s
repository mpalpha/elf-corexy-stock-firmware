///////////////////////////////////////////////////////////////////////////////
//
// IAR ANSI C/C++ Compiler V7.10.1.6676/W32 for ARM       25/Feb/2020  18:22:44
// Copyright 1999-2014 IAR Systems AB.
//
//    Cpu mode     =  thumb
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\User\ui\draw_extrusion.cpp
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\User\ui\draw_extrusion.cpp
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\EWARM\mksRobin2/List\draw_extrusion.s
//
///////////////////////////////////////////////////////////////////////////////
...
//  364 	extructAmount = 0;
        ...
        STR      R0,[R6, #+80]
//  365 	
//  366 	disp_sprayer_temp();
          CFI FunCall disp_sprayer_temp
        BL       disp_sprayer_temp
//  367 	disp_extru_amount();
          CFI FunCall disp_extru_amount
        BL       disp_extru_amount
//  368 
//  369 	gCfgItems.curSprayerChoose = active_extruder;
        LDR.W    R0,??DataTable29_17
        LDRSB    R0,[R0, #+0]
        STRB     R0,[R4, #+156]
//  370 	disp_sprayer_type();
          CFI FunCall disp_sprayer_type
        BL       disp_sprayer_type
//  371 
//  372 	disp_extru_speed();
          CFI FunCall disp_extru_speed
        BL       disp_extru_speed
//  373 	disp_extru_step();
        ADD      SP,SP,#+20
...
disp_extru_step:
        PUSH     {R4,LR}
          ...
          CFI R4 Frame(CFA, -8)
          CFI CFA R13+8
//  380 	if(gCfgItems.extruStep == 1)
        LDR.N    R4,??DataTable29
        LDRSB    R0,[R4, #+171]
        CMP      R0,#+1
        BNE.N    ??disp_extru_step_0
//  381 		BUTTON_SetBmpFileName(buttonStep.btnHandle, "bmp_step1_mm.bin",1);
        MOVS     R2,#+1
...
//  382 	else if(gCfgItems.extruStep == 5)
??disp_extru_step_0:
        LDRSB    R0,[R4, #+171]
        CMP      R0,#+5
        BNE.N    ??disp_extru_step_2
//  383 		BUTTON_SetBmpFileName(buttonStep.btnHandle, "bmp_step5_mm.bin",1);
        MOVS     R2,#+1
        ...
        BL       BUTTON_SetBmpFileName
        B.N      ??disp_extru_step_1
//  384 	else if(gCfgItems.extruStep == 10)
??disp_extru_step_2:
        LDRSB    R0,[R4, #+171]
        CMP      R0,#+10
        BNE.N    ??disp_extru_step_1
//  385 		BUTTON_SetBmpFileName(buttonStep.btnHandle, "bmp_step10_mm.bin",1);
        MOVS     R2,#+1
...
//  388 	{
//  389 		if(gCfgItems.extruStep == 1)
        LDRSB    R0,[R4, #+171]
        CMP      R0,#+1
        BNE.N    ??disp_extru_step_4
//  390 			BUTTON_SetText(buttonStep.btnHandle,extrude_menu.step_1mm);	
        ...
        B.W      BUTTON_SetText
          ...
          CFI R14 Frame(CFA, -4)
          CFI CFA R13+8
//  391 		else if(gCfgItems.extruStep == 5)
??disp_extru_step_4:
        LDRSB    R0,[R4, #+171]
        CMP      R0,#+5
        BNE.N    ??disp_extru_step_5
//  392 			BUTTON_SetText(buttonStep.btnHandle,extrude_menu.step_5mm);
        LDR.N    R0,??DataTable29_15
        LDR      R1,[R0, #+24]
        LDR.N    R0,??DataTable29_8
        LDRSH    R0,[R0, #+0]
        ...
        B.W      BUTTON_SetText
          ...
          CFI R14 Frame(CFA, -4)
          CFI CFA R13+8
//  393 		else if(gCfgItems.extruStep == 10)
??disp_extru_step_5:
        LDRSB    R0,[R4, #+171]
        CMP      R0,#+10
        BNE.N    ??disp_extru_step_3
//  394 			BUTTON_SetText(buttonStep.btnHandle,extrude_menu.step_10mm);		
        LDR.N    R0,??DataTable29_15
        LDR      R1,[R0, #+28]
        LDR.N    R0,??DataTable29_8
        LDRSH    R0,[R0, #+0]
...
disp_extru_speed:
        PUSH     {R3-R5,LR}
          ...
          CFI CFA R13+16
//  402 
//  403 	if(gCfgItems.extruSpeed == 20)
...
//  404 		BUTTON_SetBmpFileName(buttonSpeed.btnHandle, "bmp_speed_high.bin",1);
        MOVS     R2,#+1
        ADR.W    R1,`?<Constant "bmp_speed_high.bin">`
          CFI FunCall BUTTON_SetBmpFileName
        BL       BUTTON_SetBmpFileName
        B.N      ??disp_extru_speed_1
//  405 	else if(gCfgItems.extruSpeed == 1)
??disp_extru_speed_0:
        LDRSB    R1,[R5, #+172]
        CMP      R1,#+1
        BNE.N    ??disp_extru_speed_2
//  406 		BUTTON_SetBmpFileName(buttonSpeed.btnHandle, "bmp_speed_slow.bin",1);
        MOVS     R2,#+1
        ...
        B.N      ??disp_extru_speed_1
//  407 	else
//  408 		BUTTON_SetBmpFileName(buttonSpeed.btnHandle, "bmp_speed_normal.bin",1);
??disp_extru_speed_2:
        MOVS     R2,#+1
...
//  411 	{
//  412 		if(gCfgItems.extruSpeed == 20)
        LDRSH    R0,[R4, #+24]
        LDR.N    R1,??DataTable29_15
        LDRSB    R2,[R5, #+172]
        CMP      R2,#+20
        BNE.N    ??disp_extru_speed_4
//  413 			BUTTON_SetText(buttonSpeed.btnHandle,extrude_menu.high);
        LDR      R1,[R1, #+40]
        POP      {R2,R4,R5,LR}
          CFI R4 SameValue
          CFI R5 SameValue
        ...
        B.W      BUTTON_SetText
          ...
          CFI R14 Frame(CFA, -4)
          CFI CFA R13+16
//  414 		else if(gCfgItems.extruSpeed == 1)	
??disp_extru_speed_4:
        LDRSB    R2,[R5, #+172]
        CMP      R2,#+1
        BNE.N    ??disp_extru_speed_5
//  415 			BUTTON_SetText(buttonSpeed.btnHandle,extrude_menu.low);
        LDR      R1,[R1, #+32]
        POP      {R2,R4,R5,LR}
          CFI R4 SameValue
          CFI R5 SameValue
        ...
        B.W      BUTTON_SetText
          ...
          CFI CFA R13+16
//  416 		else
//  417 			BUTTON_SetText(buttonSpeed.btnHandle,extrude_menu.normal);	
??disp_extru_speed_5:
        LDR      R1,[R1, #+36]
        POP      {R2,R4,R5,LR}
          CFI R4 SameValue
...
disp_sprayer_type:
        PUSH     {R3-R5,LR}
          ...
          CFI R4 Frame(CFA, -12)
          CFI CFA R13+16
//  427 	if(gCfgItems.curSprayerChoose == 0)
...
//  428 	{
//  429 		BUTTON_SetBmpFileName(buttonSprayType.btnHandle, "bmp_extru1.bin",1);	
        MOVS     R2,#+1
...
//  430 	}
//  431 	else if(gCfgItems.curSprayerChoose == 1)
??disp_sprayer_type_0:
        LDRSB    R0,[R5, #+156]
        CMP      R0,#+1
        BNE.N    ??disp_sprayer_type_1
//  432 	{
//  433 		BUTTON_SetBmpFileName(buttonSprayType.btnHandle, "bmp_extru2.bin",1);
        MOVS     R2,#+1
        ...
        BL       BUTTON_SetBmpFileName
//  434 	}
//  435 	BUTTON_SetBitmapEx(buttonSprayType.btnHandle, 0, &bmp_struct, BMP_PIC_X, BMP_PIC_Y);
??disp_sprayer_type_1:
        ...
        LDRSH    R0,[R4, #+56]
          CFI FunCall BUTTON_SetBitmapEx
        BL       BUTTON_SetBitmapEx
//  436 	if(gCfgItems.multiple_language != 0)
        LDRB     R0,[R5, #+447]
        CMP      R0,#+0
        BEQ.N    ??disp_sprayer_type_2
//  437 	{
//  438 		if(gCfgItems.curSprayerChoose == 0)
        LDRSB    R0,[R5, #+156]
        CMP      R0,#+0
        BNE.N    ??disp_sprayer_type_3
//  439 			BUTTON_SetText(buttonSprayType.btnHandle,extrude_menu.ext1);
        LDR.N    R0,??DataTable29_15
        LDR      R1,[R0, #+12]
        LDRSH    R0,[R4, #+56]
        POP      {R2,R4,R5,LR}
        ...
        B.W      BUTTON_SetText
          ...
          CFI R14 Frame(CFA, -4)
          CFI CFA R13+16
//  440 		else if(gCfgItems.curSprayerChoose == 1)
??disp_sprayer_type_3:
        LDRSB    R0,[R5, #+156]
        CMP      R0,#+1
        BNE.N    ??disp_sprayer_type_2
//  441 			BUTTON_SetText(buttonSprayType.btnHandle,extrude_menu.ext2); 
        LDR.N    R0,??DataTable29_15
        LDR      R1,[R0, #+16]
        LDRSH    R0,[R4, #+56]
        POP      {R2,R4,R5,LR}
...
//  449 	char buf1[10] = {0};
        ...
        STM      R0!,{R1-R3}
//  450 	
//  451 	TEXT_SetTextColor(textPrintTemp, gCfgItems.state_text_color);
        LDR.N    R4,??DataTable29_7
        LDR.N    R5,??DataTable29
        LDR      R1,[R5, #+16]
        LDRSH    R0,[R4, #+2]
...
//  452 	TEXT_SetBkColor(textPrintTemp, gCfgItems.state_background_color);
        LDR      R1,[R5, #+12]
        LDRSH    R0,[R4, #+2]
          CFI FunCall TEXT_SetBkColor
        BL       TEXT_SetBkColor
//  453 #if 0
//  454 	if(gCfgItems.curSprayerChoose<1)
//  455 	{
//  456 		sprintf(buf1, extrude_menu.temp_value, (int)gCfgItems.curSprayerTemp[gCfgItems.curSprayerChoose]);
//  457 		sprintf(buf,extrude_menu.temper_text);
//  458 		strcat(buf,buf1);
//  459 	}
//  460 	else
//  461 	{
//  462 		sprintf(buf1, extrude_menu.temp_value, (int)gCfgItems.curSprayerTemp[gCfgItems.curSprayerChoose]);
//  463 		sprintf(buf,extrude_menu.temper_text);
//  464 		strcat(buf,buf1);		
//  465 	}
//  466 #endif
//  467 	sprintf(buf1, extrude_menu.temp_value, (int)thermalManager.current_temperature[gCfgItems.curSprayerChoose]);
        ...
        ADD      R0,SP,#+0
          CFI FunCall sprintf
        BL       sprintf
//  468 	sprintf(buf,extrude_menu.temper_text);
        LDR      R1,[R6, #+64]
        ADD      R0,SP,#+12
          CFI FunCall sprintf
        BL       sprintf
//  469 	strcat(buf,buf1);
        ...
        BL       strcat
//  470 
//  471 	TEXT_SetText(textPrintTemp, buf);
        ADD      R1,SP,#+12
        LDRSH    R0,[R4, #+2]
...
//  477 	char buf1[10] = {0};
        ...
        STM      R0!,{R1-R3}
//  478 
//  479 	TEXT_SetTextColor(textExtruAmount, gCfgItems.state_text_color);
        LDR.N    R4,??DataTable29_7
        ...
        LDRSH    R0,[R4, #+4]
          CFI FunCall TEXT_SetTextColor
        BL       TEXT_SetTextColor
//  480 	TEXT_SetBkColor(textExtruAmount, gCfgItems.state_background_color);	
        LDR      R1,[R6, #+12]
        LDRSH    R0,[R4, #+4]
          CFI FunCall TEXT_SetBkColor
        BL       TEXT_SetBkColor
//  481 
//  482 	if(extructAmount < 999 && extructAmount > -99)
        LDR      R2,[R4, #+80]
...
//  483 	{
//  484 		sprintf(buf1, extrude_menu.count_value_mm, extructAmount);
        LDR      R1,[R5, #+48]
        ADD      R0,SP,#+0
          CFI FunCall sprintf
        BL       sprintf
//  485 		if(gCfgItems.curSprayerChoose<1)
        LDRSB    R0,[R6, #+156]
        CMP      R0,#+1
        BGE.N    ??disp_extru_amount_1
//  486 		{
//  487 			sprintf(buf,extrude_menu.ext1);
        LDR      R1,[R5, #+12]
        ADD      R0,SP,#+12
          CFI FunCall sprintf
        BL       sprintf
...
//  489 		else
//  490 		{
//  491 			sprintf(buf,extrude_menu.ext2);		
??disp_extru_amount_1:
        LDR      R1,[R5, #+16]
        ADD      R0,SP,#+12
          CFI FunCall sprintf
...
//  493 		strcat(buf,buf1);
//  494 	}	
//  495 	else if(extructAmount < 9999 && extructAmount > -999)
??disp_extru_amount_0:
        ADDW     R0,R2,#+998
        MOVW     R1,#+10997
        CMP      R0,R1
...
//  496 	{
//  497 		sprintf(buf1, extrude_menu.count_value_cm, extructAmount/10);
        MOVS     R0,#+10
        SDIV     R2,R2,R0
        LDR      R1,[R5, #+52]
        ADD      R0,SP,#+0
          CFI FunCall sprintf
        BL       sprintf
//  498 		if(gCfgItems.curSprayerChoose<1)
        LDRSB    R0,[R6, #+156]
        CMP      R0,#+1
        BGE.N    ??disp_extru_amount_4
//  499 		{
//  500 			sprintf(buf,extrude_menu.ext1);
        LDR      R1,[R5, #+12]
        ADD      R0,SP,#+12
          CFI FunCall sprintf
        BL       sprintf
...
//  502 		else
//  503 		{
//  504 			sprintf(buf,extrude_menu.ext2);		
??disp_extru_amount_4:
        LDR      R1,[R5, #+16]
        ADD      R0,SP,#+12
          CFI FunCall sprintf
...
//  508 	else
//  509 	{
//  510 		sprintf(buf1, extrude_menu.count_value_m, extructAmount/1000);
??disp_extru_amount_3:
        MOV      R0,#+1000
        SDIV     R2,R2,R0
        LDR      R1,[R5, #+56]
        ADD      R0,SP,#+0
          CFI FunCall sprintf
        BL       sprintf
//  511 		if(gCfgItems.curSprayerChoose<1)
        LDRSB    R0,[R6, #+156]
        CMP      R0,#+1
        BGE.N    ??disp_extru_amount_5
//  512 		{
//  513 			sprintf(buf,extrude_menu.ext1);
        LDR      R1,[R5, #+12]
        ADD      R0,SP,#+12
          CFI FunCall sprintf
        BL       sprintf
...
//  515 		else
//  516 		{
//  517 			sprintf(buf,extrude_menu.ext2);		
??disp_extru_amount_5:
        LDR      R1,[R5, #+16]
        ADD      R0,SP,#+12
          CFI FunCall sprintf
...
//  520 	}
//  521 	
//  522 	TEXT_SetText(textExtruAmount, buf);
        ADD      R1,SP,#+12
        LDRSH    R0,[R4, #+4]
          CFI FunCall TEXT_SetText
        BL       TEXT_SetText
...
Clear_extrusion:
        PUSH     {R4,LR}
          ...
          CFI R4 Frame(CFA, -8)
          CFI CFA R13+8
//  528 	GUI_SetBkColor(gCfgItems.background_color);
        LDR.N    R0,??DataTable29
        LDR      R0,[R0, #+4]
          CFI FunCall GUI_SetBkColor
        BL       GUI_SetBkColor
//  529 	if(WM_IsWindow(hExtrusionWnd))
        LDR.N    R4,??DataTable29_7
        LDRSH    R0,[R4, #+0]
...
//  530 	{
//  531 		WM_DeleteWindow(hExtrusionWnd);
        LDRSH    R0,[R4, #+0]
        POP      {R4,LR}
          CFI R4 SameValue
          CFI R14 SameValue
