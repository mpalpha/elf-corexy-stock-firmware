...
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\WM\WM_ValidateWindow.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\WM\WM_ValidateWindow.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\EWARM\mksRobin2/List\WM_ValidateWindow.s
//
///////////////////////////////////////////////////////////////////////////////
...
//   13 *
//   14 ----------------------------------------------------------------------
//   15 File        : WM_ValidateWindow.c
//   16 Purpose     : Implementation of WM_ValidateWindow
//   17 ----------------------------------------------------------------------
//   18 */
//   19 
...
//   30 /*********************************************************************
//   31 *
//   32 *       WM_ValidateWindow
//   33 */

        SECTION `.text`:CODE:NOROOT(2)
          CFI Block cfiBlock0 Using cfiCommon0
          CFI Function WM_ValidateWindow
        THUMB
//   34 void WM_ValidateWindow(WM_HWIN hWin) {
//   35   WM_Obj* pWin;
//   36   WM_LOCK();
//   37   if (hWin) {
WM_ValidateWindow:
        CMP      R0,#+0
        BNE.N    ??WM_ValidateWindow_0
        BX       LR
//   38     pWin = WM_HANDLE2PTR(hWin);
??WM_ValidateWindow_0:
        PUSH     {R7,LR}
          CFI R14 Frame(CFA, -4)
          CFI CFA R13+8
        ...
        BL       GUI_ALLOC_h2p
//   39     if (pWin->Status & WM_SF_INVALID) {
        LDRH     R1,[R0, #+28]
        LSLS     R2,R1,#+26
        BPL.N    ??WM_ValidateWindow_1
//   40       pWin->Status &= ~WM_SF_INVALID;
        MOVW     R2,#+65503
        ANDS     R1,R2,R1
        STRH     R1,[R0, #+28]
//   41       WM__NumInvalidWindows--;
        LDR.N    R0,??WM_ValidateWindow_2
        LDRH     R1,[R0, #+0]
        SUBS     R1,R1,#+1
        STRH     R1,[R0, #+0]
//   42     }
...
//   46 
//   47 #else
//   48   void WM_ValidateWindow_C(void) {} /* avoid empty object files */
