...
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_ºŒ∫Ã»˝Œ¨\mksRobin_Nano_code\Drivers\STM32F1xx_HAL_Driver\Src\stm32f1xx_hal_cortex.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_ºŒ∫Ã»˝Œ¨\mksRobin_Nano_code\Drivers\STM32F1xx_HAL_Driver\Src\stm32f1xx_hal_cortex.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_ºŒ∫Ã»˝Œ¨\mksRobin_Nano_code\EWARM\mksRobin2/List\stm32f1xx_hal_cortex.s
//
///////////////////////////////////////////////////////////////////////////////
...
NVIC_SetPriorityGrouping:
        ...
        AND      R0,R0,#0x7
        ORR      R0,R2,R0, LSL #+8
        LDR.N    R2,??DataTable12_1  ;; 0x5fa0000
        ORRS     R0,R2,R0
        STR      R0,[R1, #+0]
        BX       LR               ;; return
...
NVIC_EnableIRQ:
        ...
        LSLS     R1,R1,R2
        LSRS     R0,R0,#+5
        LDR.N    R2,??DataTable12_2  ;; 0xe000e100
        STR      R1,[R2, R0, LSL #+2]
        BX       LR               ;; return
...
NVIC_DisableIRQ:
        ...
        LSLS     R1,R1,R2
        LSRS     R0,R0,#+5
        LDR.N    R2,??DataTable12_3  ;; 0xe000e180
        STR      R1,[R2, R0, LSL #+2]
        BX       LR               ;; return
...
NVIC_GetPendingIRQ:
        LSRS     R1,R0,#+5
        LDR.N    R2,??DataTable12_4  ;; 0xe000e200
        LDR      R1,[R2, R1, LSL #+2]
        AND      R0,R0,#0x1F
        LSR      R0,R1,R0
        AND      R0,R0,#0x1
...
NVIC_ClearPendingIRQ:
        ...
        LSLS     R1,R1,R2
        LSRS     R0,R0,#+5
        LDR.N    R2,??DataTable12_5  ;; 0xe000e280
        STR      R1,[R2, R0, LSL #+2]
        BX       LR               ;; return
...
NVIC_GetActive:
        LSRS     R1,R0,#+5
        LDR.N    R2,??DataTable12_6  ;; 0xe000e300
        LDR      R1,[R2, R1, LSL #+2]
        AND      R0,R0,#0x1F
        LSR      R0,R1,R0
        AND      R0,R0,#0x1
...
NVIC_SetPriority:
        ...
        BX       LR
??NVIC_SetPriority_0:
        LDR.N    R2,??DataTable12_8  ;; 0xe000e400
        STRB     R1,[R0, R2]
        BX       LR               ;; return
...
NVIC_SystemReset:
        ...
        LDR      R1,[R0, #+0]
        AND      R1,R1,#0x700
        LDR.N    R2,??DataTable12_9  ;; 0x5fa0004
        ORRS     R1,R2,R1
        STR      R1,[R0, #+0]
        DSB      
??NVIC_SystemReset_0:
