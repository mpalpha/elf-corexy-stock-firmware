...
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\MENU_Attach.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\MENU_Attach.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\EWARM\mksRobin2/List\MENU_Attach.s
//
///////////////////////////////////////////////////////////////////////////////
...
//   34 */
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI Function MENU_Attach
        THUMB
//   35 void MENU_Attach(MENU_Handle hObj, WM_HWIN hDestWin, int x, int y, int xSize, int ySize, int Flags) {
MENU_Attach:
        PUSH     {R4-R8,LR}
          CFI R14 Frame(CFA, -4)
          CFI R8 Frame(CFA, -8)
...
??MENU_Attach_1:
        STR      R0,[R8, #+100]
        LDR      R0,[SP, #+28]
//   43       pObj->Height = ((ySize > 0) ? ySize : 0);
        CMP      R0,#+1
        BGE.N    ??MENU_Attach_2
        MOVS     R0,#+0
??MENU_Attach_2:
        STR      R0,[R8, #+104]
//   44       WM_AttachWindowAt(hObj, hDestWin, x, y);
        MOV      R3,R7
        MOV      R2,R6
        MOV      R1,R5
        MOV      R0,R4
