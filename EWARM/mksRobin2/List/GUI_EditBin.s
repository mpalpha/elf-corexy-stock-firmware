...
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\GUI_EditBin.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\GUI_EditBin.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\EWARM\mksRobin2/List\GUI_EditBin.s
//
///////////////////////////////////////////////////////////////////////////////
...
//   35 */
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI Function GUI_EditBin
        THUMB
//   36 U32 GUI_EditBin(U32 Value, U32 Min, U32 Max, int Len, int xsize) {
GUI_EditBin:
        PUSH     {R4-R11,LR}
          CFI R14 Frame(CFA, -4)
          CFI R11 Frame(CFA, -8)
...
//   49   pObj = EDIT_H2P(hEdit);
        ...
        BL       GUI_ALLOC_h2p
        MOV      R9,R0
//   50   EDIT_SetBinMode(hEdit, Value, Min, Max);
        MOV      R3,R6
        MOV      R2,R5
        MOV      R1,R4
        MOV      R0,R7
          CFI FunCall EDIT_SetBinMode
        BL       EDIT_SetBinMode
...
//   63 
//   64 void GUI_EditBin_C(void);
//   65 void GUI_EditBin_C(void){}
//   66 
//   67 #endif
// 
