///////////////////////////////////////////////////////////////////////////////
//
// IAR ANSI C/C++ Compiler V7.10.1.6676/W32 for ARM       25/Feb/2020  18:23:08
// Copyright 1999-2014 IAR Systems AB.
//
//    Cpu mode     =  thumb
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Third_Party\FatFs\src\option\mycc936.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Third_Party\FatFs\src\option\mycc936.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\EWARM\mksRobin2/List\mycc936.s
//
///////////////////////////////////////////////////////////////////////////////
...
//   10 
//   11 //×Ö¿â
//   12 //#define FONTINFOADDR	0x600000//6MÒÔºóµØÖ·Îª×Ö¿â
...
//   35 	if (src < 0x80)c = src;//ASCII,Ö±½Ó²»ÓÃ×ª»».
        CMP      R4,#+128
        BLT.N    ??ff_convert_0
//   36 	else 
//   37 	{ 
...
//   50 		{
//   51 			i = li + (hi - li) / 2;	
//   52 			//SPI_FLASH_BufferRead((u8*)&t,ftinfo.ugbkaddr+i*4+gbk2uni_offset,4);//¶Á³ö4¸ö×Ö½Ú  
//   53            
//   54 			SPI_FLASH_BufferRead((u8*)&t,UNIGBK_FLASH_ADDR+i*4+gbk2uni_offset,4);//¶Á³ö4¸ö×Ö½Ú  
//   55 			if (src == t[0]) break;
//   56 			if (src > t[0])li = i;  
//   57 			else hi = i;    
??ff_convert_3:
