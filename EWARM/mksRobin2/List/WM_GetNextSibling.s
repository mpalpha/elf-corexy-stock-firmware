...
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\WM\WM_GetNextSibling.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\WM\WM_GetNextSibling.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\EWARM\mksRobin2/List\WM_GetNextSibling.s
//
///////////////////////////////////////////////////////////////////////////////
...
//   30 /*********************************************************************
//   31 *
//   32 *       WM_GetNextSibling
//   33 */

        SECTION `.text`:CODE:NOROOT(1)
          CFI Block cfiBlock0 Using cfiCommon0
          CFI Function WM_GetNextSibling
        THUMB
//   34 WM_HWIN WM_GetNextSibling(WM_HWIN hWin) {
//   35   WM_LOCK();
//   36   if (hWin) {
WM_GetNextSibling:
        CMP      R0,#+0
        BNE.N    ??WM_GetNextSibling_0
        BX       LR
//   37     hWin = WM_H2P(hWin)->hNext;
??WM_GetNextSibling_0:
        PUSH     {R7,LR}
          CFI R14 Frame(CFA, -4)
          CFI CFA R13+8
...
//   44   void WM_GetNextSibling_C(void) {}
