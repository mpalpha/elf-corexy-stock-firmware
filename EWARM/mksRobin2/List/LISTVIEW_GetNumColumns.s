...
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\LISTVIEW_GetNumColumns.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\LISTVIEW_GetNumColumns.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\EWARM\mksRobin2/List\LISTVIEW_GetNumColumns.s
//
///////////////////////////////////////////////////////////////////////////////
...
//   13 *
//   14 ----------------------------------------------------------------------
//   15 File        : LISTVIEW_GetNumColumns.c
//   16 Purpose     : Implementation of LISTVIEW_GetNumColumns
//   17 ---------------------------END-OF-HEADER------------------------------
//   18 */
//   19 
...
//   30 /*********************************************************************
//   31 *
//   32 *       LISTVIEW_GetNumColumns
//   33 */

        SECTION `.text`:CODE:NOROOT(1)
          CFI Block cfiBlock0 Using cfiCommon0
          CFI Function LISTVIEW_GetNumColumns
        THUMB
//   34 unsigned LISTVIEW_GetNumColumns(LISTVIEW_Handle hObj) {
LISTVIEW_GetNumColumns:
        PUSH     {R7,LR}
          CFI R14 Frame(CFA, -4)
          CFI CFA R13+8
        MOV      R1,R0
//   35   unsigned NumColumns = 0;
        MOVS     R0,#+0
//   36   if (hObj) {
        CMP      R1,#+0
        BEQ.N    ??LISTVIEW_GetNumColumns_0
...
//   39     pObj = LISTVIEW_H2P(hObj);
        ...
        BL       GUI_ALLOC_h2p
//   40     NumColumns = GUI_ARRAY_GetNumItems(&pObj->AlignArray);
        ADDS     R0,R0,#+46
        POP      {R1,LR}
          CFI R14 SameValue
          CFI CFA R13+0
...
//   41     WM_UNLOCK();
//   42   }
//   43   return NumColumns;
??LISTVIEW_GetNumColumns_0:
        POP      {R1,PC}          ;; return
...
//   47   void LISTVIEW_GetNumColumns_C(void);
//   48   void LISTVIEW_GetNumColumns_C(void) {}
//   49 #endif
// 
