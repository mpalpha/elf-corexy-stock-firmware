...
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\RADIO_SetTextColor.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\RADIO_SetTextColor.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\EWARM\mksRobin2/List\RADIO_SetTextColor.s
//
///////////////////////////////////////////////////////////////////////////////
...
//   13 *
//   14 ----------------------------------------------------------------------
//   15 File        : RADIO_SetTextColor.c
//   16 Purpose     : Implementation of RADIO_SetTextColor
//   17 ---------------------------END-OF-HEADER------------------------------
//   18 */
//   19 
...
//   30 /*********************************************************************
//   31 *
//   32 *       RADIO_SetTextColor
//   33 */

        SECTION `.text`:CODE:NOROOT(1)
          CFI Block cfiBlock0 Using cfiCommon0
          CFI Function RADIO_SetTextColor
        THUMB
//   34 void RADIO_SetTextColor(RADIO_Handle hObj, GUI_COLOR Color) {
RADIO_SetTextColor:
        PUSH     {R3-R5,LR}
          CFI R14 Frame(CFA, -4)
          CFI R5 Frame(CFA, -8)
...
//   35   if (hObj) {
        CMP      R4,#+0
        BEQ.N    ??RADIO_SetTextColor_0
//   36     RADIO_Obj* pObj;
//   37     WM_LOCK();
//   38     pObj = RADIO_H2P(hObj);
          CFI FunCall GUI_ALLOC_h2p
        BL       GUI_ALLOC_h2p
//   39     if (Color != pObj->TextColor) {
        LDR      R1,[R0, #+72]
        CMP      R5,R1
        BEQ.N    ??RADIO_SetTextColor_0
//   40       pObj->TextColor = Color;
        STR      R5,[R0, #+72]
...
//   50 
//   51 void RADIO_SetTextColor_c(void);
//   52 void RADIO_SetTextColor_c(void) {}
//   53 
