...
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\WM\WM__GetFirstSibling.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\WM\WM__GetFirstSibling.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\EWARM\mksRobin2/List\WM__GetFirstSibling.s
//
///////////////////////////////////////////////////////////////////////////////
...
//   13 *
//   14 ----------------------------------------------------------------------
//   15 File        : WM__GetFirstSibling.c
//   16 Purpose     : Implementation of WM__GetFirstSibling
//   17 ----------------------------------------------------------------------
//   18 */
//   19 
...
//   33 
//   34   Return value: Handle of parent, 0 if none
//   35 */

        SECTION `.text`:CODE:NOROOT(1)
          CFI Block cfiBlock0 Using cfiCommon0
          CFI Function WM__GetFirstSibling
        THUMB
//   36 WM_HWIN WM__GetFirstSibling(WM_HWIN hWin) {
WM__GetFirstSibling:
        PUSH     {R7,LR}
          CFI R14 Frame(CFA, -4)
          CFI CFA R13+8
//   37   hWin = WM_GetParent(hWin);
          CFI FunCall WM_GetParent
        BL       WM_GetParent
//   38   return (hWin) ? WM_HANDLE2PTR(hWin)->hFirstChild : 0;
        CMP      R0,#+0
        BEQ.N    ??WM__GetFirstSibling_0
          CFI FunCall GUI_ALLOC_h2p
        BL       GUI_ALLOC_h2p
        LDRSH    R0,[R0, #+24]
        POP      {R1,PC}
??WM__GetFirstSibling_0:
        MOVS     R0,#+0
        POP      {R1,PC}          ;; return
...
//   40 
//   41 #else
//   42   void WM__GetFirstSibling_C(void) {} /* avoid empty object files */
//   43 #endif
//   44 
//   45 /*************************** End of file ****************************/
// 
