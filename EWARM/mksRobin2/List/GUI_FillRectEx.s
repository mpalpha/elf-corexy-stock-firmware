...
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Core\GUI_FillRectEx.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Core\GUI_FillRectEx.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\EWARM\mksRobin2/List\GUI_FillRectEx.s
//
///////////////////////////////////////////////////////////////////////////////
...
//   13 *
//   14 ----------------------------------------------------------------------
//   15 File        : GUI_FillRectEx.c
//   16 Purpose     : Implementation of GUI_FillRectEx
//   17 ---------------------------END-OF-HEADER------------------------------
//   18 */
//   19 
//   20 
...
//   32 */
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI Function GUI_FillRectEx
        THUMB
//   33 void GUI_FillRectEx(const GUI_RECT* pRect) {
//   34   GUI_FillRect(pRect->x0, pRect->y0, pRect->x1, pRect->y1);
GUI_FillRectEx:
        LDRSH    R3,[R0, #+6]
        LDRSH    R2,[R0, #+4]
        LDRSH    R1,[R0, #+2]
