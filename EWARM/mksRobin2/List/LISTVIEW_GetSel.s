...
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\LISTVIEW_GetSel.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\LISTVIEW_GetSel.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\EWARM\mksRobin2/List\LISTVIEW_GetSel.s
//
///////////////////////////////////////////////////////////////////////////////
...
//   13 *
//   14 ----------------------------------------------------------------------
//   15 File        : LISTVIEW_GetSel.c
//   16 Purpose     : Implementation of LISTVIEW_GetSel
//   17 ---------------------------END-OF-HEADER------------------------------
//   18 */
//   19 
...
//   33 */
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI Function LISTVIEW_GetSel
        THUMB
//   34 int LISTVIEW_GetSel(LISTVIEW_Handle hObj) {
LISTVIEW_GetSel:
        MOV      R1,R0
//   35   int r = -1;
        MOV      R0,#-1
...
//   47   void LISTVIEW_GetSel_C(void);
//   48   void LISTVIEW_GetSel_C(void) {}
//   49 #endif
// 
