...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_ºŒ∫Ã»˝Œ¨\mksRobin_Nano_code\EWARM\mksRobin2/List\SCROLLBAR_Defaults.s
//
///////////////////////////////////////////////////////////////////////////////
        ...
        EXTERN SCROLLBAR__DefaultWidth
        EXTERN SCROLLBAR__aDefaultBkColor
        EXTERN SCROLLBAR__aDefaultColor

        PUBLIC SCROLLBAR_GetDefaultBkColor
        PUBLIC SCROLLBAR_GetDefaultColor
        PUBLIC SCROLLBAR_GetDefaultWidth
        PUBLIC SCROLLBAR_SetDefaultBkColor
        PUBLIC SCROLLBAR_SetDefaultColor
        PUBLIC SCROLLBAR_SetDefaultWidth
...
//   27 */
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI Function SCROLLBAR_GetDefaultWidth
          CFI NoCalls
        THUMB
...
//   33 */
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI Function SCROLLBAR_GetDefaultBkColor
          CFI NoCalls
        THUMB
...
SCROLLBAR_GetDefaultBkColor:
        CMP      R0,#+2
        BCS.N    ??SCROLLBAR_GetDefaultBkColor_0
...
//   44 */
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI Function SCROLLBAR_GetDefaultColor
          CFI NoCalls
        THUMB
...
SCROLLBAR_GetDefaultColor:
        CMP      R0,#+2
        BCS.N    ??SCROLLBAR_GetDefaultColor_0
...
//   55 */
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI Function SCROLLBAR_SetDefaultWidth
          CFI NoCalls
        THUMB
...
//   65 */
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI Function SCROLLBAR_SetDefaultBkColor
          CFI NoCalls
        THUMB
...
SCROLLBAR_SetDefaultBkColor:
        CMP      R1,#+2
        BCS.N    ??SCROLLBAR_SetDefaultBkColor_0
//   69     SCROLLBAR__aDefaultBkColor[Index] = Color;
        LDR.N    R2,??DataTable5_1
        STR      R0,[R2, R1, LSL #+2]
//   70   }
//   71   return OldColor; 
??SCROLLBAR_SetDefaultBkColor_0:
        MOVS     R0,#+0
        BX       LR               ;; return
...
//   77 */
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI Function SCROLLBAR_SetDefaultColor
          CFI NoCalls
        THUMB
...
SCROLLBAR_SetDefaultColor:
        CMP      R1,#+2
        BCS.N    ??SCROLLBAR_SetDefaultColor_0
//   81     SCROLLBAR__aDefaultColor[Index] = Color;
        LDR.N    R2,??DataTable5_2
        STR      R0,[R2, R1, LSL #+2]
//   82   }
//   83   return OldColor; 
??SCROLLBAR_SetDefaultColor_0:
        MOVS     R0,#+0
        BX       LR               ;; return
...
??DataTable5:
        ...
        DATA
??DataTable5_1:
        DC32     SCROLLBAR__aDefaultBkColor

        SECTION `.text`:CODE:NOROOT(2)
        SECTION_TYPE SHT_PROGBITS, 0
        DATA
??DataTable5_2:
        DC32     SCROLLBAR__aDefaultColor
