...
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\RADIO_SetImage.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\RADIO_SetImage.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\EWARM\mksRobin2/List\RADIO_SetImage.s
//
///////////////////////////////////////////////////////////////////////////////
...
//   34 */
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI Function RADIO_SetImage
        THUMB
//   35 void RADIO_SetImage(RADIO_Handle hObj, const GUI_BITMAP * pBitmap, unsigned int Index) {
RADIO_SetImage:
        PUSH     {R4-R6,LR}
          CFI R14 Frame(CFA, -4)
          CFI R6 Frame(CFA, -8)
...
//   36   if (hObj) {
        CMP      R4,#+0
        BEQ.N    ??RADIO_SetImage_0
//   37     RADIO_Obj * pObj;
//   38     GUI_LOCK();
//   39     pObj = RADIO_H2P(hObj);
          CFI FunCall GUI_ALLOC_h2p
        BL       GUI_ALLOC_h2p
//   40     switch (Index) {
        CMP      R6,#+0
        BEQ.N    ??RADIO_SetImage_1
        CMP      R6,#+2
        BEQ.N    ??RADIO_SetImage_2
        BCS.N    ??RADIO_SetImage_3
//   41     case RADIO_BI_INACTIV:
//   42     case RADIO_BI_ACTIV:
//   43       pObj->apBmRadio[Index] = pBitmap;
??RADIO_SetImage_1:
        ADD      R0,R0,R6, LSL #+2
        STR      R5,[R0, #+40]
//   44       break;
        B.N      ??RADIO_SetImage_3
//   45     case RADIO_BI_CHECK:
//   46       pObj->pBmCheck = pBitmap;
??RADIO_SetImage_2:
        STR      R5,[R0, #+48]
//   47       break;
//   48     }
//   49     WM_InvalidateWindow(hObj);
??RADIO_SetImage_3:
        MOV      R0,R4
        POP      {R4-R6,LR}
          CFI R4 SameValue
...
//   55   void RADIO_SetImage_C(void);
//   56   void RADIO_SetImage_C(void) {}
//   57 #endif
//   58 
//   59 /************************* end of file ******************************/
// 
