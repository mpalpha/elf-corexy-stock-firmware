...
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\LISTBOX_SetOwnerDraw.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\LISTBOX_SetOwnerDraw.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\EWARM\mksRobin2/List\LISTBOX_SetOwnerDraw.s
//
///////////////////////////////////////////////////////////////////////////////
...
//   13 *
//   14 ----------------------------------------------------------------------
//   15 File        : LISTBOX_SetOwnerDraw.c
...
//   30 /*********************************************************************
//   31 *
//   32 *       LISTBOX_SetOwnerDraw
//   33 */

        SECTION `.text`:CODE:NOROOT(1)
          CFI Block cfiBlock0 Using cfiCommon0
          CFI Function LISTBOX_SetOwnerDraw
        THUMB
//   34 void LISTBOX_SetOwnerDraw(LISTBOX_Handle hObj, WIDGET_DRAW_ITEM_FUNC * pfDrawItem) {
...
//   36   if (hObj) {
        CMP      R4,#+0
        BEQ.N    ??LISTBOX_SetOwnerDraw_0
//   37     WM_LOCK();
//   38     pObj = LISTBOX_H2P(hObj);
          CFI FunCall GUI_ALLOC_h2p
        BL       GUI_ALLOC_h2p
//   39     ASSERT_IS_VALID_PTR(pObj);
//   40     pObj->pfDrawItem = pfDrawItem;
        STR      R5,[R0, #+44]
//   41     LISTBOX_InvalidateItem(hObj, LISTBOX_ALL_ITEMS);
        MOV      R1,#-1
        MOV      R0,R4
        POP      {R2,R4,R5,LR}
          CFI R4 SameValue
...
//   47   void LISTBOX_SetOwnerDraw_C(void) {}
//   48 #endif
//   49 
//   50 /*************************** End of file ****************************/
//   51 
