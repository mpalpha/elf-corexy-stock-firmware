...
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\LISTVIEW_SetLBorder.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\LISTVIEW_SetLBorder.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\EWARM\mksRobin2/List\LISTVIEW_SetLBorder.s
//
///////////////////////////////////////////////////////////////////////////////
...
//   13 *
//   14 ----------------------------------------------------------------------
//   15 File        : LISTVIEW_SetLBorder.c
//   16 Purpose     : Implementation of LISTVIEW_SetLBorder
//   17 ---------------------------END-OF-HEADER------------------------------
//   18 */
//   19 
...
//   30 /*********************************************************************
//   31 *
//   32 *       LISTVIEW_SetLBorder
//   33 */

        SECTION `.text`:CODE:NOROOT(1)
          CFI Block cfiBlock0 Using cfiCommon0
          CFI Function LISTVIEW_SetLBorder
        THUMB
//   34 void LISTVIEW_SetLBorder(LISTVIEW_Handle hObj, unsigned BorderSize) {
LISTVIEW_SetLBorder:
        PUSH     {R3-R5,LR}
          CFI R14 Frame(CFA, -4)
          CFI R5 Frame(CFA, -8)
...
//   35   if (hObj) {
        CMP      R4,#+0
        BEQ.N    ??LISTVIEW_SetLBorder_0
//   36     LISTVIEW_Obj* pObj;
//   37     WM_LOCK();
//   38     pObj = LISTVIEW_H2P(hObj);
          CFI FunCall GUI_ALLOC_h2p
        BL       GUI_ALLOC_h2p
//   39     if (pObj->LBorder != BorderSize) {
        LDR      R1,[R0, #+96]
        CMP      R1,R5
        BEQ.N    ??LISTVIEW_SetLBorder_0
//   40       pObj->LBorder = BorderSize;
        STR      R5,[R0, #+96]
...
//   48   void LISTVIEW_SetLBorder_C(void);
//   49   void LISTVIEW_SetLBorder_C(void) {}
//   50 #endif
// 
