///////////////////////////////////////////////////////////////////////////////
//
// IAR ANSI C/C++ Compiler V7.10.1.6676/W32 for ARM       25/Feb/2020  18:22:31
// Copyright 1999-2014 IAR Systems AB.
//
//    Cpu mode     =  thumb
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Third_Party\FatFs\src\diskio.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Third_Party\FatFs\src\diskio.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\EWARM\mksRobin2/List\diskio.s
//
///////////////////////////////////////////////////////////////////////////////
...
//  189 	
//  190 	u8 errorstatus;
//  191 	u8 retry=0x1f;		//Ð´ÈëÊ§°ÜµÄÊ±ºò,ÖØÊÔ´ÎÊý
//  192 
//  193 	switch (pdrv) {
        CMP      R0,#+1
        BNE.N    ??disk_write_0
...
//  197 
//  198 	case MMC :
//  199 			errorstatus = SD_WriteDisk((u8*)buff, sector, count);	//Ð´Èë´ÅÅÌ
//  200 			//×ª»»Ó¦´ðÖµÎªFatFsÖµ	
