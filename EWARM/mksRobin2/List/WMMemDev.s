...
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\WM\WMMemDev.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\WM\WMMemDev.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\EWARM\mksRobin2/List\WMMemDev.s
//
///////////////////////////////////////////////////////////////////////////////
        ...
        PUBLIC WM_DisableMemdev
        PUBLIC WM_EnableMemdev
...
//   14 ----------------------------------------------------------------------
//   15 File        : WMMemDev.C
//   16 Purpose     : Windows manager add on, support for memory devices
//   17 ----------------------------------------------------------------------
//   18 */
//   19 
...
//   34 */
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI Function WM_EnableMemdev
          CFI NoCalls
        THUMB
//   35 void WM_EnableMemdev (WM_HWIN hWin) {
//   36   GUI_USE_PARA(hWin);
//   37   #if GUI_SUPPORT_MEMDEV
//   38     if (hWin) {
//   39       WM_Obj * pWin;
//   40       WM_LOCK();
//   41       pWin = WM_HANDLE2PTR(hWin);  
//   42       pWin->Status |= (WM_SF_MEMDEV);
//   43       WM_UNLOCK();
//   44     }
//   45   #else
//   46     GUI_DEBUG_WARN("WM_EnableMemdev: No effect because disabled in GUIConf.h (GUI_SUPPORT_MEMDEV == 0)");
//   47   #endif
//   48 }
WM_EnableMemdev:
        BX       LR               ;; return
...
//   53 */
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI Function WM_DisableMemdev
          CFI NoCalls
        THUMB
//   54 void WM_DisableMemdev(WM_HWIN hWin) {
//   55   GUI_USE_PARA(hWin);
//   56   #if GUI_SUPPORT_MEMDEV
//   57     if (hWin) {
//   58       WM_Obj * pWin;  
//   59       WM_LOCK();
//   60       pWin = WM_HANDLE2PTR(hWin);  
//   61       pWin->Status &= ~(WM_SF_MEMDEV | WM_SF_MEMDEV_ON_REDRAW);
//   62       WM_UNLOCK();
//   63     }
//   64   #else
//   65     GUI_DEBUG_WARN("WM_EnableMemdev: No effect because disabled in GUIConf.h (GUI_SUPPORT_MEMDEV == 0)");
//   66   #endif
//   67 }
WM_DisableMemdev:
        BX       LR               ;; return
...
//   68 
//   69 #else
//   70   void WM_MemDev(void) {} /* avoid empty object files */
//   71 #endif /* GUI_WIN_SUPPORT */
//   72 
//   73 /*************************** End of file ****************************/
// 
