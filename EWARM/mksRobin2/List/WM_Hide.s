...
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\WM\WM_Hide.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\WM\WM_Hide.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\EWARM\mksRobin2/List\WM_Hide.s
//
///////////////////////////////////////////////////////////////////////////////
        ...
        EXTERN WM__InvalidateAreaBelow

        PUBLIC WM_HideWindow
...
//   35 */
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI Function WM_HideWindow
        THUMB
//   36 void WM_HideWindow(WM_HWIN hWin) {
WM_HideWindow:
        PUSH     {R4,LR}
          CFI R14 Frame(CFA, -4)
          CFI R4 Frame(CFA, -8)
        ...
        MOVS     R4,R0
//   37   if (hWin) {
        BEQ.N    ??WM_HideWindow_0
//   38     WM_Obj *pWin;
//   39     WM_LOCK();
//   40     pWin = WM_HANDLE2PTR(hWin);  
          CFI FunCall GUI_ALLOC_h2p
        BL       GUI_ALLOC_h2p
//   41     /* First check if this is necessary at all */
//   42     if (pWin->Status & WM_SF_ISVIS) {
        LDRH     R1,[R0, #+28]
        LSLS     R2,R1,#+30
        BPL.N    ??WM_HideWindow_0
//   43       /* Clear Visibility flag */
//   44       pWin->Status &= ~WM_SF_ISVIS;
        MOVW     R2,#+65533
        ANDS     R1,R2,R1
        STRH     R1,[R0, #+28]
//   45       /* Mark content as invalid */
//   46       WM__InvalidateAreaBelow(&WM_HANDLE2PTR(hWin)->Rect, hWin);
        MOV      R0,R4
          CFI FunCall GUI_ALLOC_h2p
        BL       GUI_ALLOC_h2p
        MOV      R1,R4
        ...
        B.W      WM__InvalidateAreaBelow
          CFI R4 Frame(CFA, -8)
          CFI R14 Frame(CFA, -4)
          CFI CFA R13+8
//   47       #if WM_SUPPORT_NOTIFY_VIS_CHANGED
...
//   54 
//   55 #else
//   56   void WM_Hide(void) {} /* avoid empty object files */
