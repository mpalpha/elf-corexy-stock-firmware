...
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Core\GUI_TOUCH_StoreState.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Core\GUI_TOUCH_StoreState.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\EWARM\mksRobin2/List\GUI_TOUCH_StoreState.s
//
///////////////////////////////////////////////////////////////////////////////
        ...
        EXTERN GUI_TOUCH_StoreStateEx

        PUBLIC GUI_TOUCH_StoreState
...
//   13 *
//   14 ----------------------------------------------------------------------
//   15 File        : GUITOUCH_StoreState.C
//   16 Purpose     : Implementation of GUITOUCH_StoreState
//   17 ----------------------------------------------------------------------
//   18 */
//   19 
...
//   28 /*********************************************************************
//   29 *
//   30 *       GUI_TOUCH_StoreState
//   31 *
//   32 * NOTE:
//   33 *   This is the older version. Prefer GUI_TOUCH_StoreStateEx in new code
//   34 */

        SECTION `.text`:CODE:NOROOT(2)
          CFI Block cfiBlock0 Using cfiCommon0
          CFI Function GUI_TOUCH_StoreState
        THUMB
//   35 void GUI_TOUCH_StoreState(int x, int y) {
//   36   static GUI_PID_STATE _State;  /* static so we retain coordinates when touch is released */
//   37   if ((x >= 0) && (y >= 0)) {
GUI_TOUCH_StoreState:
        CMP      R0,#+0
        BMI.N    ??GUI_TOUCH_StoreState_0
        CMP      R1,#+0
        BMI.N    ??GUI_TOUCH_StoreState_0
//   38     _State.Pressed = 1;
        LDR.N    R2,??GUI_TOUCH_StoreState_1
        MOVS     R3,#+1
        STRB     R3,[R2, #+8]
//   39     _State.x = x;
        STR      R0,[R2, #+0]
//   40     _State.y = y;
        STR      R1,[R2, #+4]
        B.N      ??GUI_TOUCH_StoreState_2
//   41   } else {
//   42     _State.Pressed = 0;
??GUI_TOUCH_StoreState_0:
        MOVS     R0,#+0
        LDR.N    R1,??GUI_TOUCH_StoreState_1
        STRB     R0,[R1, #+8]
//   43   }
//   44   GUI_TOUCH_StoreStateEx(&_State);
??GUI_TOUCH_StoreState_2:
        LDR.N    R0,??GUI_TOUCH_StoreState_1
          CFI FunCall GUI_TOUCH_StoreStateEx
        B.W      GUI_TOUCH_StoreStateEx
        DATA
