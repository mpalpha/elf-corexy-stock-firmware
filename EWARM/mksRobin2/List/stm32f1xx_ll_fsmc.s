...
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_ºŒ∫Ã»˝Œ¨\mksRobin_Nano_code\Drivers\STM32F1xx_HAL_Driver\Src\stm32f1xx_ll_fsmc.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_ºŒ∫Ã»˝Œ¨\mksRobin_Nano_code\Drivers\STM32F1xx_HAL_Driver\Src\stm32f1xx_ll_fsmc.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_ºŒ∫Ã»˝Œ¨\mksRobin_Nano_code\EWARM\mksRobin2/List\stm32f1xx_ll_fsmc.s
//
///////////////////////////////////////////////////////////////////////////////
...
//  244   if (Init->MemoryType == FSMC_MEMORY_TYPE_NOR)
        ...
        LDR      R12,[R1, #+8]
        LDR      R1,[R1, #+0]
        LDR.W    R10,??DataTable3  ;; 0xfff70081
        CMP      R12,#+8
        LDR      R11,[R0, R1, LSL #+2]
        AND      R10,R10,R11
        LDR      R11,[SP, #+0]
...
//  545   if (Init->NandBank == FSMC_NAND_BANK2)
        ...
        LDR      R6,[R1, #+8]
        LDR      R7,[R1, #+4]
        LDR.W    R12,??DataTable3_2  ;; 0xfff00181
        LDR      R1,[R1, #+0]
        CMP      R1,#+16
...
FSMC_PCCARD_Init:
        LDR      R2,[R0, #+0]
        LDR.N    R3,??DataTable3_3  ;; 0xfffe01c5
        ANDS     R2,R3,R2
        LDR      R3,[R1, #+0]
        ORRS     R2,R3,R2
        LDR      R3,[R1, #+4]
