...
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\DROPDOWN_SetTextHeight.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\DROPDOWN_SetTextHeight.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\EWARM\mksRobin2/List\DROPDOWN_SetTextHeight.s
//
///////////////////////////////////////////////////////////////////////////////
        ...
        EXTERN DROPDOWN__AdjustHeight
        EXTERN GUI_ALLOC_h2p
        EXTERN WM_InvalidateWindow

        PUBLIC DROPDOWN_SetTextHeight
...
//   13 *
//   14 ----------------------------------------------------------------------
//   15 File        : DROPDOWN_SetTextHeight.c
...
//   31 /*********************************************************************
//   32 *
//   33 *       DROPDOWN_SetTextHeight
//   34 */

        SECTION `.text`:CODE:NOROOT(1)
          CFI Block cfiBlock0 Using cfiCommon0
          CFI Function DROPDOWN_SetTextHeight
        THUMB
...
//   37   if (hObj) {
        CMP      R4,#+0
        BEQ.N    ??DROPDOWN_SetTextHeight_0
//   38     WM_LOCK();
...
//   48   void DROPDOWN_SetTextHeight_C(void);
//   49   void DROPDOWN_SetTextHeight_C(void) {}
//   50 #endif
// 
