...
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\WM\WM_GetFirstChild.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\WM\WM_GetFirstChild.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\EWARM\mksRobin2/List\WM_GetFirstChild.s
//
///////////////////////////////////////////////////////////////////////////////
...
//   33 */
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI Function WM_GetFirstChild
        THUMB
//   34 WM_HWIN WM_GetFirstChild(WM_HWIN hWin) {
//   35   if (hWin) {
WM_GetFirstChild:
        CMP      R0,#+0
        BNE.N    ??WM_GetFirstChild_0
        BX       LR
//   36     WM_LOCK();
//   37     hWin = WM_H2P(hWin)->hFirstChild;
??WM_GetFirstChild_0:
        PUSH     {R7,LR}
          CFI R14 Frame(CFA, -4)
          CFI CFA R13+8
...
//   44   void WM_GetFirstChild_C(void) {}
