...
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_ºŒ∫Ã»˝Œ¨\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Core\GUI_ALLOC_AllocInit.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_ºŒ∫Ã»˝Œ¨\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Core\GUI_ALLOC_AllocInit.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_ºŒ∫Ã»˝Œ¨\mksRobin_Nano_code\EWARM\mksRobin2/List\GUI_ALLOC_AllocInit.s
//
///////////////////////////////////////////////////////////////////////////////
...
//   40 */
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI Function GUI_ALLOC_AllocInit
        THUMB
...
//   51     if (pInitData) {
        CMP      R4,#+0
        MOV      R2,R5
        BEQ.N    ??GUI_ALLOC_AllocInit_2
//   52       memcpy(pMem, pInitData, Size);
        MOV      R1,R4
          CFI FunCall memcpy
        BL       memcpy
        B.N      ??GUI_ALLOC_AllocInit_1
//   53     } else {
