///////////////////////////////////////////////////////////////////////////////
//
// IAR ANSI C/C++ Compiler V7.10.1.6676/W32 for ARM       25/Feb/2020  17:00:56
// Copyright 1999-2014 IAR Systems AB.
//
//    Cpu mode     =  thumb
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\LISTVIEW_SetRowHeight.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\LISTVIEW_SetRowHeight.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\EWARM\mksRobin2/List\LISTVIEW_SetRowHeight.s
//
///////////////////////////////////////////////////////////////////////////////
...
//   13 *
//   14 ----------------------------------------------------------------------
//   15 File        : LISTVIEW_SetRowHeight.c
//   16 Purpose     : Implementation of LISTVIEW_SetRowHeight
//   17 ---------------------------END-OF-HEADER------------------------------
//   18 */
//   19 
...
//   30 /*********************************************************************
//   31 *
//   32 *       LISTVIEW_SetRowHeight
//   33 */

        SECTION `.text`:CODE:NOROOT(1)
          CFI Block cfiBlock0 Using cfiCommon0
          CFI Function LISTVIEW_SetRowHeight
        THUMB
//   34 unsigned LISTVIEW_SetRowHeight(LISTVIEW_Handle hObj, unsigned RowHeight) {
...
//   41     if (RowHeight != r) {
        CMP      R5,R6
        BEQ.N    ??LISTVIEW_SetRowHeight_0
//   42       pObj->RowDistY = RowHeight;
        STR      R5,[R7, #+92]
//   43       LISTVIEW__UpdateScrollParas(hObj, pObj);
        MOV      R1,R7
        MOV      R0,R4
          CFI FunCall LISTVIEW__UpdateScrollParas
        BL       LISTVIEW__UpdateScrollParas
//   44       LISTVIEW__InvalidateInsideArea(hObj, pObj);
        MOV      R1,R7
        MOV      R0,R4
...
//   52   void LISTVIEW_SetRowHeight_C(void);
//   53   void LISTVIEW_SetRowHeight_C(void) {}
//   54 #endif
// 
