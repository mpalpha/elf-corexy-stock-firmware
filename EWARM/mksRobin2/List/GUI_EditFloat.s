///////////////////////////////////////////////////////////////////////////////
//
// IAR ANSI C/C++ Compiler V7.10.1.6676/W32 for ARM       25/Feb/2020  16:59:44
// Copyright 1999-2014 IAR Systems AB.
//
//    Cpu mode     =  thumb
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\GUI_EditFloat.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\GUI_EditFloat.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\EWARM\mksRobin2/List\GUI_EditFloat.s
//
///////////////////////////////////////////////////////////////////////////////
...
//   50   EDIT_SetFloatMode(hEdit, Value, Min, Max, Shift, Flags);
        ...
        MOV      R1,R4
        MOV      R0,R8
          CFI FunCall EDIT_SetFloatMode
        BL       EDIT_SetFloatMode
//   51   do {
//   52     Key = GUI_WaitKey();
??GUI_EditFloat_1:
...
??GUI_EditFloat_2:
        CMP      R4,#+27
        BEQ.N    ??GUI_EditFloat_3
        CMP      R4,#+13
        BEQ.N    ??GUI_EditFloat_3
        CMP      R4,#+0
        BNE.N    ??GUI_EditFloat_1
...
//   64 }
        ...
        END
//   65 
//   66 #else /* avoid empty object files */
//   67 
//   68 void GUI_EditFloat_C(void);
//   69 void GUI_EditFloat_C(void){}
//   70 
//   71 #endif
// 
