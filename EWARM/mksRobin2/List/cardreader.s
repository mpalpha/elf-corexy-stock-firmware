...
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_ºŒ∫Ã»˝Œ¨\mksRobin_Nano_code\Middlewares\Third_Party\Marlin\cardreader.cpp
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_ºŒ∫Ã»˝Œ¨\mksRobin_Nano_code\Middlewares\Third_Party\Marlin\cardreader.cpp
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_ºŒ∫Ã»˝Œ¨\mksRobin_Nano_code\EWARM\mksRobin2/List\cardreader.s
//
///////////////////////////////////////////////////////////////////////////////
...
//   81   #endif
//   82 #if unused //
//   83   if (SD_DET_IP != SD_DETECT_INVERTED)  //?TSD?°ß,?®¨2a¶Ã?U?®¨°Í?1®∞??
//   84   {
...
//   97   } 
//   98   
//   99   if((Appli_state == APPLICATION_DISCONNECT) &&(usbOK == true))     //?®¨2a¶Ã?U?®¨???a°Í?D???
//  100   {
//  101     //unmount();
...
//  119 	  //if(filesys == FILE_SYS_SD)        //U?®¨??®ÆD1®∞??
//  120 	  {
...
//  147 #if unused
//  148 	  //if (SD_DET_IP != SD_DETECT_INVERTED)  //?TSD?°ß,?®¨2a¶Ã?U?®¨°Í?1®∞??
//  149 		  {
...
//  161 		    }
//  162 		  } 
//  163 	  	  if((Appli_state == APPLICATION_DISCONNECT) &&(usbOK == true))     //?®¨2a¶Ã?U?®¨???a°Í?D???
//  164 		  {
//  165 		    //unmount();
...
//  493     sdmode = 1;
//  494     FALA_5V_CTRL = FALA_ON;    // °‰®∞?a°§°ß®§-¶Ã?®®Y
//  495 #endif    
//  496 }
...
//  910 #else//robin robin_mini robin_nano÷ª”–SDø®∑Ω Ω
