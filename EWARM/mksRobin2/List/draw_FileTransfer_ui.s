///////////////////////////////////////////////////////////////////////////////
//
// IAR ANSI C/C++ Compiler V7.10.1.6676/W32 for ARM       25/Feb/2020  18:22:46
// Copyright 1999-2014 IAR Systems AB.
//
//    Cpu mode     =  thumb
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\User\ui\draw_FileTransfer_ui.cpp
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\User\ui\draw_FileTransfer_ui.cpp
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\EWARM\mksRobin2/List\draw_FileTransfer_ui.s
//
///////////////////////////////////////////////////////////////////////////////
...
//  104 		{
//  105 			GUI_DispStringAt("ÎÄ¼þ´«ÊäÊ§°Ü!", 80, titleHeight  + 75);
        MOVS     R2,#+111
        MOVS     R1,#+80
...
//  109 		{
//  110 			GUI_DispStringAt("ÎÄ¼þ´«Êä³É¹¦!", 80, titleHeight  + 75);
        MOVS     R2,#+111
        MOVS     R1,#+80
...
??draw_dialog_filetransfer_6:
        ...
        BNE.N    ??draw_dialog_filetransfer_3
//  113 		{	
//  114 			GUI_DispStringAt("Çë¼ì²éÊÇ·ñ²åÈë´æ´¢Éè±¸!", 40, titleHeight  + 75);
        MOVS     R2,#+111
        MOVS     R1,#+40
...
//  133 	else
//  134 	{
//  135 		BUTTON_SetText(buttonReturn.btnHandle, "·µ»Ø\n");
...
//  215 		else
//  216 		{
//  217 			TEXT_SetText(FileTransferText,"½ÓÊÕÎÄ¼þÖÐ");
??draw_filetansfer_2:
...
//  236 			{
//  237 				TEXT_SetText(FileTransferText,"ÎÄ¼þ½âÑ¹ÖÐ");
...
//  239 			else
//  240 			{
//  241 				TEXT_SetText(FileTransferText,"ÎÄ¼þ½ÓÊÕÖÐ");
??draw_filetansfer_6:
