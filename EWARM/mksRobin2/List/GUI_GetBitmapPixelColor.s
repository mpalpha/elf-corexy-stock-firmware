...
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Core\GUI_GetBitmapPixelColor.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Core\GUI_GetBitmapPixelColor.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\EWARM\mksRobin2/List\GUI_GetBitmapPixelColor.s
//
///////////////////////////////////////////////////////////////////////////////
        ...
        PUBLIC GUI_GetBitmapPixelColor
...
//   13 *
//   14 ----------------------------------------------------------------------
//   15 File        : GUI_GetBitmapPixelColor.c
//   16 Purpose     : Gets the color from one pixel of a bitmap
//   17 ---------------------------END-OF-HEADER------------------------------
//   18 */
//   19 
...
//   28 /*********************************************************************
//   29 *
//   30 *       GUI_GetBitmapPixelColor
//   31 */

        SECTION `.text`:CODE:NOROOT(1)
          CFI Block cfiBlock0 Using cfiCommon0
          CFI Function GUI_GetBitmapPixelColor
        THUMB
...
//   34   if (pBMP->pPal->HasTrans && (Index == 0)) {
        ...
        LDRSB    R2,[R1, #+4]
        CMP      R2,#+0
        BEQ.N    ??GUI_GetBitmapPixelColor_0
        CMP      R0,#+0
        BNE.N    ??GUI_GetBitmapPixelColor_0
