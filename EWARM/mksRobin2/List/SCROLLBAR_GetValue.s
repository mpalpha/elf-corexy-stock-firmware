...
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\SCROLLBAR_GetValue.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\SCROLLBAR_GetValue.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\EWARM\mksRobin2/List\SCROLLBAR_GetValue.s
//
///////////////////////////////////////////////////////////////////////////////
...
//   25 /*********************************************************************
//   26 *
//   27 *       SCROLLBAR_GetValue
//   28 */

        SECTION `.text`:CODE:NOROOT(1)
          CFI Block cfiBlock0 Using cfiCommon0
          CFI Function SCROLLBAR_GetValue
        THUMB
//   29 int SCROLLBAR_GetValue(SCROLLBAR_Handle hObj) {
SCROLLBAR_GetValue:
        MOV      R1,R0
//   30   int r = 0;
        MOVS     R0,#+0
//   31   SCROLLBAR_Obj* pObj;
//   32   if (hObj) {
        CMP      R1,#+0
        BNE.N    ??SCROLLBAR_GetValue_0
        BX       LR
//   33     WM_LOCK();
//   34     pObj = SCROLLBAR_H2P(hObj);
??SCROLLBAR_GetValue_0:
        PUSH     {R7,LR}
          CFI R14 Frame(CFA, -4)
          CFI CFA R13+8
        MOV      R0,R1
...
//   41 
//   42 #else
//   43   void SCROLLBAR_GetValue_c(void) {}    /* Avoid empty object files */
