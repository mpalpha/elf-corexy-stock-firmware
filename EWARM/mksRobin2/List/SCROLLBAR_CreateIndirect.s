...
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\SCROLLBAR_CreateIndirect.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\SCROLLBAR_CreateIndirect.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\EWARM\mksRobin2/List\SCROLLBAR_CreateIndirect.s
//
///////////////////////////////////////////////////////////////////////////////
        ...
        PUBLIC SCROLLBAR_CreateIndirect
...
//   30 /*********************************************************************
//   31 *
//   32 *       SCROLLBAR_CreateIndirect
//   33 */

        SECTION `.text`:CODE:NOROOT(1)
          CFI Block cfiBlock0 Using cfiCommon0
          CFI Function SCROLLBAR_CreateIndirect
        THUMB
//   34 SCROLLBAR_Handle SCROLLBAR_CreateIndirect(const GUI_WIDGET_CREATE_INFO* pCreateInfo, WM_HWIN hWinParent, int x0, int y0, WM_CALLBACK* cb) {
SCROLLBAR_CreateIndirect:
        ...
        MOV      R4,R2
        MOV      R5,R3
//   35   SCROLLBAR_Handle  hThis;
//   36   GUI_USE_PARA(cb);
//   37   hThis = SCROLLBAR_CreateEx(pCreateInfo->x0 + x0, pCreateInfo->y0 + y0, pCreateInfo->xSize, pCreateInfo->ySize,
...
//   43   void SCROLLBAR_CreateIndirect_C(void) {}
//   44 #endif
// 
