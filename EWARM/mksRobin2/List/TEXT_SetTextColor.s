...
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\TEXT_SetTextColor.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\TEXT_SetTextColor.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\EWARM\mksRobin2/List\TEXT_SetTextColor.s
//
///////////////////////////////////////////////////////////////////////////////
...
//   13 *
//   14 ----------------------------------------------------------------------
//   15 File        : TEXT_SetTextColor.c
//   16 Purpose     : Implementation of TEXT_SetTextColor
//   17 ---------------------------END-OF-HEADER------------------------------
//   18 */
//   19 
//   20 #include "TEXT.h"
...
//   32 /*********************************************************************
//   33 *
//   34 *       TEXT_SetTextColor
//   35 */

        SECTION `.text`:CODE:NOROOT(1)
          CFI Block cfiBlock0 Using cfiCommon0
          CFI Function TEXT_SetTextColor
        THUMB
...
//   37   if (hObj) {
        CMP      R4,#+0
        BEQ.N    ??TEXT_SetTextColor_0
//   38     TEXT_Obj* pObj;
//   39     WM_LOCK();
//   40     pObj = TEXT_H2P(hObj);
          CFI FunCall GUI_ALLOC_h2p
        BL       GUI_ALLOC_h2p
//   41     pObj->TextColor = Color;
        STR      R5,[R0, #+52]
...
//   49 
//   50 void TEXT_SetTextColor_c(void);
//   51 void TEXT_SetTextColor_c(void){}
//   52 
