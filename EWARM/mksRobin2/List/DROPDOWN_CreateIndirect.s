...
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\DROPDOWN_CreateIndirect.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\DROPDOWN_CreateIndirect.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\EWARM\mksRobin2/List\DROPDOWN_CreateIndirect.s
//
///////////////////////////////////////////////////////////////////////////////
        ...
        EXTERN DROPDOWN_CreateEx

        PUBLIC DROPDOWN_CreateIndirect
...
//   13 *
//   14 ----------------------------------------------------------------------
//   15 File        : DROPDOWN_CreateIndirect.c
...
//   31 /*********************************************************************
//   32 *
//   33 *       DROPDOWN_CreateIndirect
//   34 */

        SECTION `.text`:CODE:NOROOT(1)
          CFI Block cfiBlock0 Using cfiCommon0
          CFI Function DROPDOWN_CreateIndirect
        THUMB
//   35 DROPDOWN_Handle DROPDOWN_CreateIndirect(const GUI_WIDGET_CREATE_INFO* pCreateInfo,
//   36                                         WM_HWIN hWinParent, int x0, int y0, WM_CALLBACK* cb) {
DROPDOWN_CreateIndirect:
        ...
        MOV      R4,R2
        MOV      R5,R3
//   37   DROPDOWN_Handle  hThis;
//   38   GUI_USE_PARA(cb);
//   39   hThis = DROPDOWN_CreateEx(pCreateInfo->x0 + x0, pCreateInfo->y0 + y0,
//   40                             pCreateInfo->xSize, pCreateInfo->ySize,
//   41                             hWinParent, 0, pCreateInfo->Flags, pCreateInfo->Id);
//   42   return hThis;
        LDRSH    R2,[R0, #+8]
        STR      R2,[SP, #+12]
        LDRH     R2,[R0, #+18]
        ...
        LDRSH    R0,[R0, #+10]
        ADDS     R0,R4,R0
          CFI FunCall DROPDOWN_CreateEx
        BL       DROPDOWN_CreateEx
        ADD      SP,SP,#+20
          CFI CFA R13+12
        POP      {R4,R5,PC}       ;; return
...
//   46   void DROPDOWN_CreateIndirect_C(void) {}
//   47 #endif
// 
