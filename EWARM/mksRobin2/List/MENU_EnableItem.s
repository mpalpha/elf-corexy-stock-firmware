...
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\MENU_EnableItem.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\MENU_EnableItem.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\EWARM\mksRobin2/List\MENU_EnableItem.s
//
///////////////////////////////////////////////////////////////////////////////
...
//   34 */
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI Function MENU_EnableItem
        THUMB
//   35 void MENU_EnableItem(MENU_Handle hObj, U16 ItemId) {
//   36   if (hObj) {
MENU_EnableItem:
        CMP      R0,#+0
        BNE.N    ??MENU_EnableItem_0
        BX       LR
//   37     int Index;
//   38     WM_LOCK();
...
//   51   void MENU_EnableItem_C(void) {}
//   52 #endif
//   53 
//   54 /*************************** End of file ****************************/
// 
