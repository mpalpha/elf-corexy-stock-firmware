...
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\TEXT_CreateIndirect.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\TEXT_CreateIndirect.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\EWARM\mksRobin2/List\TEXT_CreateIndirect.s
//
///////////////////////////////////////////////////////////////////////////////
...
//   30 /*********************************************************************
//   31 *
//   32 *       TEXT_CreateIndirect
//   33 */

        SECTION `.text`:CODE:NOROOT(1)
          CFI Block cfiBlock0 Using cfiCommon0
          CFI Function TEXT_CreateIndirect
        THUMB
//   34 TEXT_Handle TEXT_CreateIndirect(const GUI_WIDGET_CREATE_INFO* pCreateInfo, WM_HWIN hWinParent, int x0, int y0, WM_CALLBACK* cb) {
TEXT_CreateIndirect:
        PUSH     {R4,R5,LR}
          CFI R14 Frame(CFA, -4)
          CFI R5 Frame(CFA, -8)
        ...
        MOV      R4,R2
        MOV      R5,R3
//   35   TEXT_Handle  hThis;
//   36   GUI_USE_PARA(cb);
//   37   hThis = TEXT_CreateEx(pCreateInfo->x0 + x0, pCreateInfo->y0 + y0, pCreateInfo->xSize, pCreateInfo->ySize,
//   38                         hWinParent, WM_CF_SHOW, pCreateInfo->Flags, pCreateInfo->Id, pCreateInfo->pName);
//   39   return hThis;
        LDR      R2,[R0, #+4]
        STR      R2,[SP, #+16]
        LDRSH    R2,[R0, #+8]
...
//   43   void TEXT_CreateIndirect_C(void) {}
//   44 #endif
// 
