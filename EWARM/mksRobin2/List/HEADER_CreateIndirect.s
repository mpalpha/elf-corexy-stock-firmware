///////////////////////////////////////////////////////////////////////////////
//
// IAR ANSI C/C++ Compiler V7.10.1.6676/W32 for ARM       25/Feb/2020  17:00:03
// Copyright 1999-2014 IAR Systems AB.
//
//    Cpu mode     =  thumb
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\HEADER_CreateIndirect.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\HEADER_CreateIndirect.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\EWARM\mksRobin2/List\HEADER_CreateIndirect.s
//
///////////////////////////////////////////////////////////////////////////////
...
//   13 *
//   14 ----------------------------------------------------------------------
//   15 File        : HEADER_CreateIndirect.c
...
//   30 /*********************************************************************
//   31 *
//   32 *       HEADER_CreateIndirect
//   33 */

        SECTION `.text`:CODE:NOROOT(1)
          CFI Block cfiBlock0 Using cfiCommon0
          CFI Function HEADER_CreateIndirect
        THUMB
//   34 HEADER_Handle HEADER_CreateIndirect(const GUI_WIDGET_CREATE_INFO* pCreateInfo, WM_HWIN hWinParent, int x0, int y0, WM_CALLBACK* cb) {
HEADER_CreateIndirect:
        ...
        MOV      R4,R2
        MOV      R5,R3
//   35   HEADER_Handle  hThis;
//   36   GUI_USE_PARA(cb);
//   37   hThis = HEADER_CreateEx(pCreateInfo->x0 + x0, pCreateInfo->y0 + y0, pCreateInfo->xSize, pCreateInfo->ySize,
//   38                           hWinParent, pCreateInfo->Flags, 0, pCreateInfo->Id);
//   39   return hThis;
        LDRSH    R2,[R0, #+8]
        STR      R2,[SP, #+12]
        MOVS     R2,#+0
...
//   43   void HEADER_CreateIndirect_C(void) {}
//   44 #endif
// 
