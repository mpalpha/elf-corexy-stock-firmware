///////////////////////////////////////////////////////////////////////////////
//
// IAR ANSI C/C++ Compiler V7.10.1.6676/W32 for ARM       25/Feb/2020  18:23:23
// Copyright 1999-2014 IAR Systems AB.
//
//    Cpu mode     =  thumb
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_ºŒ∫Ã»˝Œ¨\mksRobin_Nano_code\Drivers\STM32F1xx_HAL_Driver\Src\stm32f1xx_hal_adc_ex.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_ºŒ∫Ã»˝Œ¨\mksRobin_Nano_code\Drivers\STM32F1xx_HAL_Driver\Src\stm32f1xx_hal_adc_ex.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_ºŒ∫Ã»˝Œ¨\mksRobin_Nano_code\EWARM\mksRobin2/List\stm32f1xx_hal_adc_ex.s
//
///////////////////////////////////////////////////////////////////////////////
...
//  164   if (tmp_hal_status == HAL_OK)
        BNE.N    ??HAL_ADCEx_Calibration_Start_1
//  165   {
//  166     /* Set ADC state */
...
//  176                        * ADC_PRECALIBRATION_DELAY_ADCCLOCKCYCLES        );
        ...
        LSLS     R0,R0,#+1
        STR      R0,[SP, #+0]
        B.N      ??HAL_ADCEx_Calibration_Start_2
//  177 
...
??HAL_ADCEx_Calibration_Start_2:
        LDR      R0,[SP, #+0]
        CMP      R0,#+0
        BNE.N    ??HAL_ADCEx_Calibration_Start_3
//  182     
...
??HAL_ADCEx_Calibration_Start_4:
        ...
        LDR      R1,[R0, #+8]
        LSLS     R1,R1,#+28
        BPL.N    ??HAL_ADCEx_Calibration_Start_5
//  193     {
//  194       if((HAL_GetTick() - tickstart) > ADC_CALIBRATION_TIMEOUT)
        ...
        SUBS     R0,R0,R6
        CMP      R0,#+11
        BCC.N    ??HAL_ADCEx_Calibration_Start_4
//  195       {
...
??HAL_ADCEx_Calibration_Start_6:
        ...
        LDR      R0,[R0, #+8]
        LSLS     R0,R0,#+29
        BPL.N    ??HAL_ADCEx_Calibration_Start_7
//  216     {
...
//  271                       HAL_ADC_STATE_INJ_BUSY);
        LDR      R1,[R4, #+40]
        LDR.W    R2,??DataTable8_1  ;; 0xffffdffe
        ANDS     R1,R2,R1
        ORR      R1,R1,#0x1000
        STR      R1,[R4, #+40]
//  272     
...
//  275     if (ADC_NONMULTIMODE_OR_MULTIMODEMASTER(hadc))
        LDR.W    R1,??DataTable8_2  ;; 0x40012800
        LDR      R2,[R4, #+0]
        CMP      R2,R1
        BNE.N    ??HAL_ADCEx_InjectedStart_2
        LDR.W    R2,??DataTable8_3  ;; 0x40012404
        LDR      R2,[R2, #+0]
        AND      R2,R2,#0xF0000
        SUBS     R2,R2,#+1
        SBCS     R2,R2,R2
...
//  312     if (HAL_IS_BIT_CLR(hadc->Instance->CR1, ADC_CR1_JAUTO))
        ...
        LDR      R3,[R2, #+4]
        LSLS     R3,R3,#+21
        BMI.N    ??HAL_ADCEx_InjectedStart_7
//  313     {
...
//  315           ADC_NONMULTIMODE_OR_MULTIMODEMASTER(hadc)  )
        ...
        SBCS     R1,R1,R1
        LSRS     R1,R1,#+31
        B.N      ??HAL_ADCEx_InjectedStart_10
??HAL_ADCEx_InjectedStart_9:
        MOVS     R1,#+1
??HAL_ADCEx_InjectedStart_10:
        CMP      R1,#+0
        BEQ.N    ??HAL_ADCEx_InjectedStart_8
//  316       {
...
//  373     if (tmp_hal_status == HAL_OK)
        CMP      R0,#+0
        BNE.N    ??HAL_ADCEx_InjectedStop_2
//  374     {
//  375       /* Set ADC state */
...
??HAL_ADCEx_InjectedPollForConversion_10:
        ...
        SUBS     R0,R0,R6
        CMP      R5,R0
        BCS.N    ??HAL_ADCEx_InjectedPollForConversion_11
...
//  582     if (HAL_IS_BIT_CLR(hadc->Instance->CR1, ADC_CR1_JAUTO))
        ...
        LDR      R3,[R2, #+4]
        LSLS     R3,R3,#+21
        BMI.N    ??HAL_ADCEx_InjectedStart_IT_7
//  583     {
...
//  585           ADC_NONMULTIMODE_OR_MULTIMODEMASTER(hadc)  )
        ...
        SBCS     R1,R1,R1
        LSRS     R1,R1,#+31
        B.N      ??HAL_ADCEx_InjectedStart_IT_10
??HAL_ADCEx_InjectedStart_IT_9:
        MOVS     R1,#+1
??HAL_ADCEx_InjectedStart_IT_10:
        CMP      R1,#+0
        BEQ.N    ??HAL_ADCEx_InjectedStart_IT_8
//  586       {
...
//  643     if (tmp_hal_status == HAL_OK)
        CMP      R0,#+0
        BNE.N    ??HAL_ADCEx_InjectedStop_IT_2
//  644     {
...
//  735                       HAL_ADC_STATE_REG_BUSY);
        LDR      R0,[R4, #+40]
        LDR.W    R1,??DataTable8_9  ;; 0xffeffdfe
        ANDS     R0,R1,R0
        ORR      R0,R0,#0x100
        STR      R0,[R4, #+40]
//  736       
...
//  853       if (tmp_hal_status != HAL_OK)
        ...
        BL       ADC_ConversionStop_Disable
        CMP      R0,#+0
        BEQ.N    ??HAL_ADCEx_MultiModeStop_DMA_3
//  854       {
...
//  877     if (tmp_hal_status == HAL_OK)
        CMP      R0,#+0
        LDR      R1,[R4, #+40]
        BNE.N    ??HAL_ADCEx_MultiModeStop_DMA_4
//  878     {
...
// 1070   if (hadc->Init.ScanConvMode == ADC_SCAN_DISABLE)
        ...
        LDR      R3,[R0, #+8]
        CMP      R3,#+0
        BNE.N    ??HAL_ADCEx_InjectedConfigChannel_2
// 1071   {
// 1072     if (sConfigInjected->InjectedRank == ADC_INJECTED_RANK_1)
        CMP      R6,#+1
        BNE.N    ??HAL_ADCEx_InjectedConfigChannel_3
// 1073     {
...
// 1083                                   0x01)                            );
        ...
        ORR      R3,R3,R5, LSL #+15
        STR      R3,[R4, #+56]
        B.N      ??HAL_ADCEx_InjectedConfigChannel_4
// 1084     }
...
??HAL_ADCEx_InjectedConfigChannel_4:
        ...
        LDR      R4,[R3, #+8]
        LSLS     R4,R4,#+31
        BMI.N    ??HAL_ADCEx_InjectedConfigChannel_6
// 1140   {    
...
// 1144                ADC_CFGR_JEXTSEL(hadc, sConfigInjected->ExternalTrigInjecConv) );
        LDR      R4,[R3, #+8]
        LDR      R5,[R2, #+28]
        LDR.N    R6,??DataTable8_15  ;; 0x40013c00
        CMP      R3,R6
...
??HAL_ADCEx_InjectedConfigChannel_7:
        LDR.N    R6,??DataTable8_16  ;; 0xffff8ffe
        ANDS     R4,R6,R4
        ORRS     R4,R5,R4
        STR      R4,[R3, #+8]
// 1145   }
...
??HAL_ADCEx_InjectedConfigChannel_8:
        LDR      R3,[R2, #+20]
        CMP      R3,#+1
        BNE.N    ??HAL_ADCEx_InjectedConfigChannel_10
// 1172     {
...
// 1175         SET_BIT(hadc->Instance->CR1, ADC_CR1_JDISCEN);
        ...
        ORR      R4,R4,#0x1000
        STR      R4,[R3, #+4]
        B.N      ??HAL_ADCEx_InjectedConfigChannel_10
// 1176       } 
// 1177       else
// 1178       {
...
??HAL_ADCEx_InjectedConfigChannel_10:
        ...
        MOVS     R6,#+7
        CMP      R5,#+10
        BCC.N    ??HAL_ADCEx_InjectedConfigChannel_12
// 1190   {
...
// 1193                ADC_SMPR1(sConfigInjected->InjectedSamplingTime, sConfigInjected->InjectedChannel) );
        ...
        ORRS     R4,R4,R6
        STR      R4,[R3, #+12]
        B.N      ??HAL_ADCEx_InjectedConfigChannel_13
// 1194   }
...
??HAL_ADCEx_InjectedConfigChannel_15:
        ...
        CMP      R3,#+3
        BEQ.N    ??HAL_ADCEx_InjectedConfigChannel_18
        BCC.N    ??HAL_ADCEx_InjectedConfigChannel_19
        B.N      ??HAL_ADCEx_InjectedConfigChannel_17
// 1213   {
// 1214     case 1:
...
??HAL_ADCEx_InjectedConfigChannel_20:
        LDR      R3,[R2, #+0]
        CMP      R3,#+16
        BEQ.N    ??HAL_ADCEx_InjectedConfigChannel_21
        CMP      R3,#+17
...
??HAL_ADCEx_InjectedConfigChannel_21:
        ...
        CMP      R3,R4
        BNE.N    ??HAL_ADCEx_InjectedConfigChannel_23
// 1249     {
// 1250       if (READ_BIT(hadc->Instance->CR2, ADC_CR2_TSVREFE) == RESET)
        LDR      R4,[R3, #+8]
        LSLS     R4,R4,#+8
        BMI.N    ??HAL_ADCEx_InjectedConfigChannel_22
// 1251       {
...
// 1258           wait_loop_index = (ADC_TEMPSENSOR_DELAY_US * (SystemCoreClock / 1000000));
        LDR.N    R2,??DataTable8
        LDR      R2,[R2, #+0]
        LDR.N    R3,??DataTable8_18  ;; 0xf4240
        UDIV     R2,R2,R3
        ADD      R3,R2,R2, LSL #+2
        LSLS     R2,R3,#+1
        STR      R2,[SP, #+0]
...
??HAL_ADCEx_InjectedConfigChannel_24:
        LDR      R2,[SP, #+0]
        CMP      R2,#+0
        BEQ.N    ??HAL_ADCEx_InjectedConfigChannel_22
// 1260           {
...
// 1324       (IS_ADC_MULTIMODE_MASTER_INSTANCE(hadc->Instance))   )
        ...
        LDR      R4,[R3, #+8]
        LSLS     R4,R4,#+31
        BMI.N    ??HAL_ADCEx_MultiModeConfigChannel_2
        ...
        LDR.N    R4,??DataTable8_17  ;; 0x40012400
        CMP      R3,R4
        BNE.N    ??HAL_ADCEx_MultiModeConfigChannel_2
// 1325   {
...
// 1328                multimode->Mode     );
        ...
        ORRS     R2,R2,R4
        STR      R2,[R3, #+4]
        B.N      ??HAL_ADCEx_MultiModeConfigChannel_3
// 1329   }
...
??HAL_ADCEx_MultiModeConfigChannel_2:
        LDR      R1,[R0, #+40]
        ORR      R1,R1,#0x20
        STR      R1,[R0, #+40]
// 1336     
...
??HAL_ADCEx_MultiModeConfigChannel_3:
        MOVS     R2,#+0
        STRB     R2,[R0, #+36]
// 1343   
