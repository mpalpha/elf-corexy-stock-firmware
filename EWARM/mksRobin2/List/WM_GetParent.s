...
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\WM\WM_GetParent.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\WM\WM_GetParent.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\EWARM\mksRobin2/List\WM_GetParent.s
//
///////////////////////////////////////////////////////////////////////////////
...
//   33 */
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI Function WM_GetParent
        THUMB
//   34 WM_HWIN WM_GetParent(WM_HWIN hWin) {
//   35   if (hWin) {
WM_GetParent:
        CMP      R0,#+0
        BNE.N    ??WM_GetParent_0
        BX       LR
//   36     WM_LOCK();
