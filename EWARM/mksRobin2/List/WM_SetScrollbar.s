...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_ºŒ∫Ã»˝Œ¨\mksRobin_Nano_code\EWARM\mksRobin2/List\WM_SetScrollbar.s
//
///////////////////////////////////////////////////////////////////////////////
        ...
        EXTERN SCROLLBAR_CreateAttached
        EXTERN WM_DeleteWindow
        EXTERN WM_GetDialogItem
        EXTERN WM_HideWindow

        PUBLIC WM_SetScrollbarH
        PUBLIC WM_SetScrollbarV
        PUBLIC WM__SetScrollbarH
        PUBLIC WM__SetScrollbarV
...
//   41   if (OnOff) {
        CMP      R5,#+0
        BEQ.N    ??_SetScrollbar_0
//   42     if (!hBar) {
        CMP      R7,#+0
        BNE.N    ??_SetScrollbar_1
//   43       SCROLLBAR_CreateAttached(hWin, Flags);
        MOV      R1,R6
        MOV      R0,R4
          CFI FunCall SCROLLBAR_CreateAttached
        BL       SCROLLBAR_CreateAttached
        B.N      ??_SetScrollbar_1
//   44     }
//   45   } else {
...
//   65 */
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI Function WM__SetScrollbarV
        THUMB
...
//   74 */
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI Function WM__SetScrollbarH
        THUMB
...
//   83 */
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI Function WM_SetScrollbarH
          CFI FunCall WM__SetScrollbarH
        THUMB
...
//   96 */
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI Function WM_SetScrollbarV
          CFI FunCall WM__SetScrollbarV
        THUMB
