///////////////////////////////////////////////////////////////////////////////
//
// IAR ANSI C/C++ Compiler V7.10.1.6676/W32 for ARM       25/Feb/2020  16:59:47
// Copyright 1999-2014 IAR Systems AB.
//
//    Cpu mode     =  thumb
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Core\GUI_GetYSizeOfFont.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Core\GUI_GetYSizeOfFont.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\EWARM\mksRobin2/List\GUI_GetYSizeOfFont.s
//
///////////////////////////////////////////////////////////////////////////////
        ...
        PUBLIC GUI_GetYDistOfFont
        PUBLIC GUI_GetYSizeOfFont
...
//   28 /*********************************************************************
//   29 *
//   30 *       GUI_GetYSizeOfFont
//   31 */

        SECTION `.text`:CODE:NOROOT(1)
          CFI Block cfiBlock0 Using cfiCommon0
          CFI Function GUI_GetYSizeOfFont
          CFI NoCalls
        THUMB
//   32 int GUI_GetYSizeOfFont(const GUI_FONT GUI_UNI_PTR * pFont) {
//   33   return pFont->YSize * pFont->YMag;
GUI_GetYSizeOfFont:
        LDRB     R1,[R0, #+20]
        LDRSB    R0,[R0, #+23]
        MULS     R0,R0,R1
...
//   36 /*********************************************************************
//   37 *
//   38 *       GUI_GetYDistOfFont
//   39 */

        SECTION `.text`:CODE:NOROOT(1)
          CFI Block cfiBlock1 Using cfiCommon0
          CFI Function GUI_GetYDistOfFont
          CFI NoCalls
        THUMB
//   40 int GUI_GetYDistOfFont(const GUI_FONT GUI_UNI_PTR * pFont) {
//   41   return pFont->YDist * pFont->YMag;
GUI_GetYDistOfFont:
        LDRB     R1,[R0, #+21]
        LDRSB    R0,[R0, #+23]
        MULS     R0,R0,R1
