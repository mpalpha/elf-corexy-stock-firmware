...
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\RADIO_CreateIndirect.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\RADIO_CreateIndirect.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\EWARM\mksRobin2/List\RADIO_CreateIndirect.s
//
///////////////////////////////////////////////////////////////////////////////
...
//   31 /*********************************************************************
//   32 *
//   33 *       RADIO_CreateIndirect
//   34 */

        SECTION `.text`:CODE:NOROOT(1)
          CFI Block cfiBlock0 Using cfiCommon0
          CFI Function RADIO_CreateIndirect
        THUMB
//   35 RADIO_Handle RADIO_CreateIndirect(const GUI_WIDGET_CREATE_INFO* pCreateInfo, WM_HWIN hWinParent, int x0, int y0, WM_CALLBACK* cb) {
RADIO_CreateIndirect:
        ...
        MOV      R4,R2
        MOV      R5,R3
//   36   RADIO_Handle  hThis;
//   37   int NumItems = (pCreateInfo->Para)       & 0xFF;
//   38   int Spacing  = (pCreateInfo->Para >>  8) & 0xFF;
//   39   GUI_USE_PARA(cb);
//   40   hThis = RADIO_CreateEx(pCreateInfo->x0 + x0, pCreateInfo->y0 + y0, pCreateInfo->xSize, pCreateInfo->ySize,
//   41                          hWinParent, pCreateInfo->Flags, 0, pCreateInfo->Id, NumItems, Spacing);
//   42   return hThis;
        LDR      R2,[R0, #+20]
        UBFX     R3,R2,#+8,#+8
        STR      R3,[SP, #+20]
...
//   46   void RADIO_CreateIndirect_C(void) {}
//   47 #endif
//   48 
//   49 /************************* end of file ******************************/
// 
