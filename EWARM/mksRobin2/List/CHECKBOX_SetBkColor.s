...
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\CHECKBOX_SetBkColor.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\CHECKBOX_SetBkColor.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\EWARM\mksRobin2/List\CHECKBOX_SetBkColor.s
//
///////////////////////////////////////////////////////////////////////////////
        ...
        EXTERN WM_SetTransState

        PUBLIC CHECKBOX_SetBkColor
...
//   13 *
//   14 ----------------------------------------------------------------------
//   15 File        : CHECKBOX_SetBkColor.c
//   16 Purpose     : Implementation of CHECKBOX_SetBkColor
//   17 ---------------------------END-OF-HEADER------------------------------
//   18 */
//   19 
...
//   30 /*********************************************************************
//   31 *
//   32 *       CHECKBOX_SetBkColor
//   33 */

        SECTION `.text`:CODE:NOROOT(1)
          CFI Block cfiBlock0 Using cfiCommon0
          CFI Function CHECKBOX_SetBkColor
        THUMB
//   34 void CHECKBOX_SetBkColor(CHECKBOX_Handle hObj, GUI_COLOR Color) {
CHECKBOX_SetBkColor:
        PUSH     {R3-R5,LR}
          CFI R14 Frame(CFA, -4)
          CFI R5 Frame(CFA, -8)
...
//   35   if (hObj) {
        CMP      R4,#+0
        BEQ.N    ??CHECKBOX_SetBkColor_0
//   36     CHECKBOX_Obj* pObj;
//   37     WM_LOCK();
//   38     pObj = CHECKBOX_H2P(hObj);
          CFI FunCall GUI_ALLOC_h2p
        BL       GUI_ALLOC_h2p
//   39     if (Color != pObj->Props.BkColor) {
        LDR      R1,[R0, #+52]
        CMP      R5,R1
        BEQ.N    ??CHECKBOX_SetBkColor_0
//   40       pObj->Props.BkColor = Color;
        STR      R5,[R0, #+52]
//   41       #if WM_SUPPORT_TRANSPARENCY
//   42         if (Color <= 0xFFFFFF) {
        CMP      R5,#+16777216
        BCS.N    ??CHECKBOX_SetBkColor_1
//   43           WM_SetTransState(hObj, 0);
        MOVS     R1,#+0
        MOV      R0,R4
          CFI FunCall WM_SetTransState
        BL       WM_SetTransState
        B.N      ??CHECKBOX_SetBkColor_2
//   44         } else {
//   45           WM_SetTransState(hObj, WM_CF_HASTRANS);
...
//   46         }
//   47       #endif
//   48       WM_InvalidateWindow(hObj);
??CHECKBOX_SetBkColor_2:
        MOV      R0,R4
        POP      {R1,R4,R5,LR}
          CFI R4 SameValue
          CFI R5 SameValue
...
//   55   void CHECKBOX_SetBkColor_C(void);
//   56   void CHECKBOX_SetBkColor_C(void) {}
//   57 #endif
// 
