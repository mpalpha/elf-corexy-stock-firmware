...
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Core\GUI_ClearRectEx.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Core\GUI_ClearRectEx.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\EWARM\mksRobin2/List\GUI_ClearRectEx.s
//
///////////////////////////////////////////////////////////////////////////////
...
//   31 */
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI Function GUI_ClearRectEx
        THUMB
//   32 void GUI_ClearRectEx(const GUI_RECT* pRect) {
//   33   GUI_ClearRect(pRect->x0, pRect->y0, pRect->x1, pRect->y1);
GUI_ClearRectEx:
        LDRSH    R3,[R0, #+6]
        LDRSH    R2,[R0, #+4]
        LDRSH    R1,[R0, #+2]
