...
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\MENU_DisableItem.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\MENU_DisableItem.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\EWARM\mksRobin2/List\MENU_DisableItem.s
//
///////////////////////////////////////////////////////////////////////////////
        ...
        EXTERN MENU__InvalidateItem
        EXTERN MENU__SetItemFlags

        PUBLIC MENU_DisableItem
...
//   34 */
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI Function MENU_DisableItem
        THUMB
//   35 void MENU_DisableItem(MENU_Handle hObj, U16 ItemId) {
//   36   if (hObj) {
MENU_DisableItem:
        CMP      R0,#+0
        BNE.N    ??MENU_DisableItem_0
        BX       LR
//   37     int Index;
//   38     WM_LOCK();
...
//   42       pObj = MENU_H2P(hObj);
        ...
        BL       GUI_ALLOC_h2p
        MOV      R5,R0
//   43       MENU__SetItemFlags(pObj, Index, MENU_IF_DISABLED, MENU_IF_DISABLED);
        MOVS     R3,#+1
        MOV      R2,R3
        MOV      R1,R4
          CFI FunCall MENU__SetItemFlags
        BL       MENU__SetItemFlags
...
//   51   void MENU_DisableItem_C(void) {}
//   52 #endif
//   53 
//   54 /*************************** End of file ****************************/
// 
