...
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\GUI_DRAW_STREAMED.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\GUI_DRAW_STREAMED.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\EWARM\mksRobin2/List\GUI_DRAW_STREAMED.s
//
///////////////////////////////////////////////////////////////////////////////
        ...
        EXTERN GUI_DrawStreamedBitmap

        PUBLIC GUI_DRAW_STREAMED_Create
...
//   37   GUI_DrawStreamedBitmap((const GUI_BITMAP_STREAM *)pObj->Data.pData, x + pObj->xOff, y + pObj->yOff);
_Draw:
        LDRSH    R3,[R0, #+10]
        ADDS     R2,R3,R2
        LDRSH    R3,[R0, #+8]
        ADDS     R1,R3,R1
        LDR      R0,[R0, #+4]
          CFI FunCall GUI_DrawStreamedBitmap
        B.W      GUI_DrawStreamedBitmap
...
//   45   return ((const GUI_BITMAP_STREAM *)pObj->Data.pData)->XSize;
_GetXSize:
        LDR      R0,[R0, #+4]
        LDRH     R0,[R0, #+4]
        BX       LR               ;; return
...
//   53   return ((const GUI_BITMAP_STREAM *)pObj->Data.pData)->YSize;
_GetYSize:
        LDR      R0,[R0, #+4]
        LDRH     R0,[R0, #+6]
        BX       LR               ;; return
...
//   74 /*********************************************************************
//   75 *
//   76 *       GUI_DRAW_STREAMED_Create
//   77 */

        SECTION `.text`:CODE:NOROOT(1)
          CFI Block cfiBlock3 Using cfiCommon0
          CFI Function GUI_DRAW_STREAMED_Create
        THUMB
//   78 WM_HMEM GUI_DRAW_STREAMED_Create(const GUI_BITMAP_STREAM * pBitmap, int x, int y) {
...
//   80   hMem = GUI_ALLOC_AllocZero(sizeof(GUI_DRAW));
        ...
        MOVS     R7,R0
//   81   if (hMem) {
        BEQ.N    ??GUI_DRAW_STREAMED_Create_0
//   82     GUI_DRAW* pObj;
//   83     WM_LOCK();
...
//   96   void GUI_DRAW_STREAMED_C(void) {}
//   97 #endif
// 
