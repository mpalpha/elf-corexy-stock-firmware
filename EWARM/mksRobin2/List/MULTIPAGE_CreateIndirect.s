...
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\MULTIPAGE_CreateIndirect.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\MULTIPAGE_CreateIndirect.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\EWARM\mksRobin2/List\MULTIPAGE_CreateIndirect.s
//
///////////////////////////////////////////////////////////////////////////////
        ...
        EXTERN MULTIPAGE_CreateEx

        PUBLIC MULTIPAGE_CreateIndirect
...
//   13 *
//   14 ----------------------------------------------------------------------
//   15 File        : MULTIPAGE_CreateIndirect.c
...
//   30 /*********************************************************************
//   31 *
//   32 *       MULTIPAGE_CreateIndirect
//   33 */

        SECTION `.text`:CODE:NOROOT(1)
          CFI Block cfiBlock0 Using cfiCommon0
          CFI Function MULTIPAGE_CreateIndirect
        THUMB
//   34 MULTIPAGE_Handle MULTIPAGE_CreateIndirect(const GUI_WIDGET_CREATE_INFO* pCreateInfo,
//   35                                           WM_HWIN hWinParent, int x0, int y0, WM_CALLBACK* cb) {
MULTIPAGE_CreateIndirect:
        ...
        MOV      R4,R2
        MOV      R5,R3
//   36   MULTIPAGE_Handle  hThis;
//   37   GUI_USE_PARA(cb);
//   38   hThis = MULTIPAGE_CreateEx(pCreateInfo->x0 + x0, pCreateInfo->y0 + y0, pCreateInfo->xSize, pCreateInfo->ySize,
...
//   40   return hThis;
        ...
        LDRSH    R0,[R0, #+10]
        ADDS     R0,R4,R0
          CFI FunCall MULTIPAGE_CreateEx
        BL       MULTIPAGE_CreateEx
        ADD      SP,SP,#+20
          CFI CFA R13+12
        POP      {R4,R5,PC}       ;; return
...
//   44   void MULTIPAGE_CreateIndirect_C(void) {}
//   45 #endif
// 
