...
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\DROPDOWN_SetTextAlign.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\DROPDOWN_SetTextAlign.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\EWARM\mksRobin2/List\DROPDOWN_SetTextAlign.s
//
///////////////////////////////////////////////////////////////////////////////
...
//   13 *
//   14 ----------------------------------------------------------------------
//   15 File        : DROPDOWN_SetTextAlign.c
...
//   31 /*********************************************************************
//   32 *
//   33 *       DROPDOWN_SetTextAlign
//   34 */

        SECTION `.text`:CODE:NOROOT(1)
          CFI Block cfiBlock0 Using cfiCommon0
          CFI Function DROPDOWN_SetTextAlign
        THUMB
//   35 void DROPDOWN_SetTextAlign(DROPDOWN_Handle hObj, int Align) {
...
//   37   if (hObj) {
        CMP      R4,#+0
        BEQ.N    ??DROPDOWN_SetTextAlign_0
//   38     WM_LOCK();
//   39     pObj = DROPDOWN_H2P(hObj);
          CFI FunCall GUI_ALLOC_h2p
        BL       GUI_ALLOC_h2p
//   40     pObj->Props.Align = Align;
        STRH     R5,[R0, #+94]
...
//   47   void DROPDOWN_SetTextAlign_C(void);
//   48   void DROPDOWN_SetTextAlign_C(void) {}
//   49 #endif
// 
