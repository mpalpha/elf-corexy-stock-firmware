...
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\CHECKBOX_SetText.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\CHECKBOX_SetText.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\EWARM\mksRobin2/List\CHECKBOX_SetText.s
//
///////////////////////////////////////////////////////////////////////////////
...
//   13 *
//   14 ----------------------------------------------------------------------
//   15 File        : CHECKBOX_SetText.c
//   16 Purpose     : Implementation of CHECKBOX_SetText
//   17 ---------------------------END-OF-HEADER------------------------------
//   18 */
//   19 
...
//   33 */
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI Function CHECKBOX_SetText
        THUMB
//   34 void CHECKBOX_SetText(CHECKBOX_Handle hObj, const char * s) {
CHECKBOX_SetText:
        PUSH     {R3-R5,LR}
          CFI R14 Frame(CFA, -4)
          CFI R5 Frame(CFA, -8)
...
//   38     pObj = CHECKBOX_H2P(hObj);
        ...
        BL       GUI_ALLOC_h2p
//   39     if (GUI__SetText(&pObj->hpText, s)) {
        MOV      R1,R5
        ADDS     R0,R0,#+82
...
//   47   void CHECKBOX_SetText_C(void);
//   48   void CHECKBOX_SetText_C(void) {}
//   49 #endif
// 
