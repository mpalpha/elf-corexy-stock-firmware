///////////////////////////////////////////////////////////////////////////////
//
// IAR ANSI C/C++ Compiler V7.10.1.6676/W32 for ARM       25/Feb/2020  18:22:58
// Copyright 1999-2014 IAR Systems AB.
//
//    Cpu mode     =  thumb
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_ºŒ∫Ã»˝Œ¨\mksRobin_Nano_code\Middlewares\Third_Party\Marlin\endstops.cpp
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_ºŒ∫Ã»˝Œ¨\mksRobin_Nano_code\Middlewares\Third_Party\Marlin\endstops.cpp
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_ºŒ∫Ã»˝Œ¨\mksRobin_Nano_code\EWARM\mksRobin2/List\endstops.s
//
///////////////////////////////////////////////////////////////////////////////
...
//  242   if(mksCfg.use_xmin_plug){
        LDR.W    R4,??DataTable28_4
        ADR.W    R5,`?<Constant "open">`
        ADR.W    R11,`?<Constant "TRIGGERED">`
        LDR.W    R6,??DataTable28_5
        LDR.W    R7,??DataTable28_6
        LDR.W    R8,??DataTable28_3
        LDRB     R0,[R8, #+128]
        CMP      R0,#+0
        BEQ.N    ??M119_0
//  243     ES_REPORT(X_MIN);
...
??update_6:
        ...
        CMP      R0,#+1
        BNE.N    ??update_14
        LDR.N    R7,??DataTable28_5
        LDR.W    R8,??DataTable28_6
        LDRH     R1,[R8, #+26]
        LDR      R0,[R7, #+52]
          CFI FunCall HAL_GPIO_ReadPin
        BL       HAL_GPIO_ReadPin
...
// 
// 3 172 bytes of CODE  memory (+ 150 bytes shared)
