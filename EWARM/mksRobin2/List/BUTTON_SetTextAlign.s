...
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\BUTTON_SetTextAlign.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\BUTTON_SetTextAlign.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\EWARM\mksRobin2/List\BUTTON_SetTextAlign.s
//
///////////////////////////////////////////////////////////////////////////////
...
//   13 *
//   14 ----------------------------------------------------------------------
//   15 File        : BUTTON_SetTextAlign.c
//   16 Purpose     : Implementation of BUTTON_SetTextAlign
//   17 ---------------------------END-OF-HEADER------------------------------
//   18 */
//   19 
...
//   30 /*********************************************************************
//   31 *
//   32 *       BUTTON_SetTextAlign
//   33 */

        SECTION `.text`:CODE:NOROOT(1)
          CFI Block cfiBlock0 Using cfiCommon0
          CFI Function BUTTON_SetTextAlign
        THUMB
...
//   35   if (hObj) {
        CMP      R4,#+0
        BEQ.N    ??BUTTON_SetTextAlign_0
//   36     BUTTON_Obj* pObj;
//   37     WM_LOCK();
//   38     pObj = BUTTON_H2P(hObj);
          CFI FunCall GUI_ALLOC_h2p
        BL       GUI_ALLOC_h2p
//   39     BUTTON_ASSERT_IS_VALID_PTR(pObj);
//   40     pObj->Props.Align = Align;
        STRH     R5,[R0, #+68]
//   41     BUTTON_Invalidate(hObj);
        MOV      R0,R4
        POP      {R1,R4,R5,LR}
          CFI R4 SameValue
          CFI R5 SameValue
...
//   47   void BUTTON_SetTextAlign_C(void);
//   48   void BUTTON_SetTextAlign_C(void) {}
//   49 #endif
// 
