...
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\MENU_SetItem.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\MENU_SetItem.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\EWARM\mksRobin2/List\MENU_SetItem.s
//
///////////////////////////////////////////////////////////////////////////////
...
//   34 */
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI Function MENU_SetItem
        THUMB
//   35 void MENU_SetItem(MENU_Handle hObj, U16 ItemId, const MENU_ITEM_DATA* pItemData) {
MENU_SetItem:
        PUSH     {R0,R4-R6,LR}
          CFI R14 Frame(CFA, -4)
          CFI R6 Frame(CFA, -8)
...
//   42       pObj = MENU_H2P(hObj);
        ...
        BL       GUI_ALLOC_h2p
        MOV      R6,R0
//   43       if (MENU__SetItem(hObj, pObj, Index, pItemData) != 0) {
        MOV      R3,R4
        MOV      R2,R5
        MOV      R1,R6
        LDRSH    R0,[SP, #+4]
