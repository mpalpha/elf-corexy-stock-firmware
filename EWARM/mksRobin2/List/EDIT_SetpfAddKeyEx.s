...
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\EDIT_SetpfAddKeyEx.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\EDIT_SetpfAddKeyEx.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\EWARM\mksRobin2/List\EDIT_SetpfAddKeyEx.s
//
///////////////////////////////////////////////////////////////////////////////
...
//   31 /*********************************************************************
//   32 *
//   33 *       EDIT_SetpfAddKeyEx
//   34 */

        SECTION `.text`:CODE:NOROOT(1)
          CFI Block cfiBlock0 Using cfiCommon0
          CFI Function EDIT_SetpfAddKeyEx
        THUMB
//   35 void EDIT_SetpfAddKeyEx(EDIT_Handle hObj, tEDIT_AddKeyEx * pfAddKeyEx) {
EDIT_SetpfAddKeyEx:
        PUSH     {R4,LR}
          CFI R14 Frame(CFA, -4)
          CFI R4 Frame(CFA, -8)
...
//   36   if (hObj) {
        CMP      R0,#+0
        BEQ.N    ??EDIT_SetpfAddKeyEx_0
//   37     EDIT_Obj* pObj;
//   38     WM_LOCK();
//   39     pObj = EDIT_H2P(hObj);
          CFI FunCall GUI_ALLOC_h2p
        BL       GUI_ALLOC_h2p
//   40     pObj->pfAddKeyEx = pfAddKeyEx;
        STR      R4,[R0, #+76]
//   41     WM_UNLOCK();
//   42   }
//   43 }
??EDIT_SetpfAddKeyEx_0:
        POP      {R4,PC}          ;; return
...
//   46 
//   47 void EDIT_SetpfAddKeyEx_C(void);
//   48 void EDIT_SetpfAddKeyEx_C(void) {}
//   49 
