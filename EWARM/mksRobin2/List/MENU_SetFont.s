...
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\MENU_SetFont.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\MENU_SetFont.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\EWARM\mksRobin2/List\MENU_SetFont.s
//
///////////////////////////////////////////////////////////////////////////////
        ...
        EXTERN MENU__RecalcTextWidthOfItems
        EXTERN MENU__ResizeMenu
...
//   34 */
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI Function MENU_SetFont
        THUMB
//   35 void MENU_SetFont(MENU_Handle hObj, const GUI_FONT GUI_UNI_PTR * pFont) {
MENU_SetFont:
        PUSH     {R4-R6,LR}
          CFI R14 Frame(CFA, -4)
          CFI R6 Frame(CFA, -8)
...
//   40     if (pObj) {
        BEQ.N    ??MENU_SetFont_0
//   41       if (pFont != pObj->Props.pFont) {
        LDR      R0,[R6, #+84]
        CMP      R5,R0
        BEQ.N    ??MENU_SetFont_0
//   42         pObj->Props.pFont = pFont;
        STR      R5,[R6, #+84]
//   43         MENU__RecalcTextWidthOfItems(pObj);
        MOV      R0,R6
          CFI FunCall MENU__RecalcTextWidthOfItems
        BL       MENU__RecalcTextWidthOfItems
