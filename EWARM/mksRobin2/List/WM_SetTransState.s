...
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\WM\WM_SetTransState.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\WM\WM_SetTransState.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\EWARM\mksRobin2/List\WM_SetTransState.s
//
///////////////////////////////////////////////////////////////////////////////
...
??WM_SetTransState_2:
        ...
        AND      R1,R0,#0x800
        LSLS     R2,R6,#+20
        BPL.N    ??WM_SetTransState_3
//   42       if (!(pWin->Status & WM_CF_CONST_OUTLINE)) {
        CMP      R1,#+0
        BNE.N    ??WM_SetTransState_0
