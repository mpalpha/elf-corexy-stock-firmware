...
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\WM\WM_GetDialogItem.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\WM\WM_GetDialogItem.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\EWARM\mksRobin2/List\WM_GetDialogItem.s
//
///////////////////////////////////////////////////////////////////////////////
...
??_GetDialogItem_0:
        CMP      R6,#+0
        BEQ.N    ??_GetDialogItem_2
        MOV      R0,R6
          CFI FunCall WM_GetId
        BL       WM_GetId
        CMP      R0,R4
        BNE.N    ??_GetDialogItem_3
        MOV      R0,R6
        POP      {R4-R6,PC}
??_GetDialogItem_3:
        MOV      R1,R4
        MOV      R0,R6
          CFI FunCall _GetDialogItem
        BL       _GetDialogItem
        MOVS     R5,R0
        BEQ.N    ??_GetDialogItem_1
//   52   }
//   53   return r;
??_GetDialogItem_2:
        MOV      R0,R5
