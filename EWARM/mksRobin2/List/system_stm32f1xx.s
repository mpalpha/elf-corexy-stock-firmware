///////////////////////////////////////////////////////////////////////////////
//
// IAR ANSI C/C++ Compiler V7.10.1.6676/W32 for ARM       25/Feb/2020  18:23:36
// Copyright 1999-2014 IAR Systems AB.
//
//    Cpu mode     =  thumb
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_ºŒ∫Ã»˝Œ¨\mksRobin_Nano_code\Drivers\CMSIS\Device\ST\STM32F1xx\Source\Templates\system_stm32f1xx.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_ºŒ∫Ã»˝Œ¨\mksRobin_Nano_code\Drivers\CMSIS\Device\ST\STM32F1xx\Source\Templates\system_stm32f1xx.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_ºŒ∫Ã»˝Œ¨\mksRobin_Nano_code\EWARM\mksRobin2/List\system_stm32f1xx.s
//
///////////////////////////////////////////////////////////////////////////////
...
SystemInit:
        LDR.N    R0,??DataTable3  ;; 0x40021000
        LDR      R1,[R0, #+0]
        ORR      R1,R1,#0x1
        STR      R1,[R0, #+0]
//  180 
...
//  183   RCC->CFGR &= (uint32_t)0xF8FF0000;
        LDR      R1,[R0, #+4]
        LDR.N    R2,??DataTable3_1  ;; 0xf8ff0000
        ANDS     R1,R2,R1
        STR      R1,[R0, #+4]
//  184 #else
...
//  189   RCC->CR &= (uint32_t)0xFEF6FFFF;
        LDR      R1,[R0, #+0]
        LDR.N    R2,??DataTable3_2  ;; 0xfef6ffff
        ANDS     R1,R2,R1
        STR      R1,[R0, #+0]
//  190 
...
SystemCoreClockUpdate:
        LDR.N    R0,??DataTable3_4  ;; 0x40021004
        LDR      R1,[R0, #+0]
        AND      R2,R1,#0xC
//  279   
//  280   switch (tmp)
...
//  300         SystemCoreClock = (HSI_VALUE >> 1) * pllmull;
        LDR.N    R3,??DataTable3_6  ;; 0x3d0900
        MULS     R2,R3,R2
        STR      R2,[R1, #+0]
...
??SystemCoreClockUpdate_3:
        LDR.N    R3,??DataTable3_7  ;; 0x7a1200
        MULS     R2,R3,R2
        STR      R2,[R1, #+0]
        B.N      ??SystemCoreClockUpdate_2
//  317         }
...
??SystemCoreClockUpdate_0:
        LDR.N    R2,??DataTable3_7  ;; 0x7a1200
        STR      R2,[R1, #+0]
//  363       break;
//  364   }
//  365   
