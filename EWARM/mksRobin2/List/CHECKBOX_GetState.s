...
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\CHECKBOX_GetState.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\CHECKBOX_GetState.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\EWARM\mksRobin2/List\CHECKBOX_GetState.s
//
///////////////////////////////////////////////////////////////////////////////
...
//   13 *
//   14 ----------------------------------------------------------------------
//   15 File        : CHECKBOX_GetState.c
//   16 Purpose     : Implementation of CHECKBOX_GetState
//   17 ---------------------------END-OF-HEADER------------------------------
//   18 */
//   19 
...
//   30 /*********************************************************************
//   31 *
//   32 *       CHECKBOX_GetState
//   33 */

        SECTION `.text`:CODE:NOROOT(1)
          CFI Block cfiBlock0 Using cfiCommon0
          CFI Function CHECKBOX_GetState
        THUMB
//   34 int CHECKBOX_GetState(CHECKBOX_Handle hObj) {
CHECKBOX_GetState:
        MOV      R1,R0
//   35   int Result = 0;
        MOVS     R0,#+0
...
//   37   if (hObj) {
        CMP      R1,#+0
        BNE.N    ??CHECKBOX_GetState_0
        BX       LR
//   38     WM_LOCK();
//   39     pObj = CHECKBOX_H2P(hObj);
??CHECKBOX_GetState_0:
        PUSH     {R7,LR}
          CFI R14 Frame(CFA, -4)
          CFI CFA R13+8
...
//   47   void CHECKBOX_GetState_C(void);
//   48   void CHECKBOX_GetState_C(void) {}
//   49 #endif
// 
