///////////////////////////////////////////////////////////////////////////////
//
// IAR ANSI C/C++ Compiler V7.10.1.6676/W32 for ARM       25/Feb/2020  17:01:14
// Copyright 1999-2014 IAR Systems AB.
//
//    Cpu mode     =  thumb
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\WM\WM__GetPrevSibling.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\WM\WM__GetPrevSibling.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\EWARM\mksRobin2/List\WM__GetPrevSibling.s
//
///////////////////////////////////////////////////////////////////////////////
...
//   13 *
//   14 ----------------------------------------------------------------------
//   15 File        : WM__GetPrevSibling.c
//   16 Purpose     : Implementation of WM__GetPrevSibling
//   17 ----------------------------------------------------------------------
//   18 */
//   19 
...
//   29 /*********************************************************************
//   30 *
//   31 *       WM__GetPrevSibling
//   32 
//   33   Return value: Handle of previous sibling (if any), otherwise 0
//   34 */

        SECTION `.text`:CODE:NOROOT(1)
          CFI Block cfiBlock0 Using cfiCommon0
          CFI Function WM__GetPrevSibling
        THUMB
//   35 WM_HWIN WM__GetPrevSibling(WM_HWIN hWin) {
WM__GetPrevSibling:
        PUSH     {R3-R5,LR}
          CFI R14 Frame(CFA, -4)
          CFI R5 Frame(CFA, -8)
...
//   36   WM_HWIN hi;
//   37   WM_Obj* pi;
//   38   for (hi = WM__GetFirstSibling(hWin); hi; hi = pi->hNext) {
          CFI FunCall WM__GetFirstSibling
        BL       WM__GetFirstSibling
        MOV      R5,R0
        B.N      ??WM__GetPrevSibling_0
??WM__GetPrevSibling_1:
        MOV      R5,R0
??WM__GetPrevSibling_0:
        CMP      R5,#+0
        BEQ.N    ??WM__GetPrevSibling_2
//   39     if (hi == hWin) {
        CMP      R5,R4
        BNE.N    ??WM__GetPrevSibling_3
//   40       hi = 0;                 /* There is no previous sibling. Return 0 */
        MOVS     R5,#+0
//   41       break;
        B.N      ??WM__GetPrevSibling_2
//   42     }
//   43     pi = WM_H2P(hi);
??WM__GetPrevSibling_3:
        MOV      R0,R5
...
//   44     if (pi->hNext == hWin) {
        LDRSH    R0,[R0, #+26]
        CMP      R0,R4
        BNE.N    ??WM__GetPrevSibling_1
//   45       break;                  /* We found the previous one ! */
//   46     }
//   47   }
//   48   return hi;
??WM__GetPrevSibling_2:
        MOV      R0,R5
...
//   50 
//   51 #else
//   52   void WM__GetPrevSibling_C(void) {} /* avoid empty object files */
//   53 #endif
//   54 
//   55 /*************************** End of file ****************************/
// 
