...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_ºŒ∫Ã»˝Œ¨\mksRobin_Nano_code\EWARM\mksRobin2/List\EDITFloat.s
//
///////////////////////////////////////////////////////////////////////////////
...
//   45     _Value = floor(Scale * Value + 0.5);
        MOVS     R4,#+0
        LDR.N    R5,??DataTable2_1  ;; 0x3fe00000
        MOV      R1,R10
...
//   83     EDIT_SetValue(hObj, (I32)(Value + (Value >= 0 ? 0.5 : -0.5)));
        ...
        BL       __aeabi_cfrcmple
        MOV      R4,R1
        BHI.N    ??EDIT_SetFloatValue_1
        LDR.N    R5,??DataTable2_1  ;; 0x3fe00000
        B.N      ??EDIT_SetFloatValue_2
??EDIT_SetFloatValue_1:
        LDR.N    R5,??DataTable2_2  ;; 0xbfe00000
