...
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\WM\WM_Broadcast.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\WM\WM_Broadcast.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\EWARM\mksRobin2/List\WM_Broadcast.s
//
///////////////////////////////////////////////////////////////////////////////
...
//   30 /*********************************************************************
//   31 *
//   32 *       WM_BroadcastMessage
//   33 */

        SECTION `.text`:CODE:NOROOT(2)
          CFI Block cfiBlock0 Using cfiCommon0
          CFI Function WM_BroadcastMessage
        THUMB
//   34 int WM_BroadcastMessage( WM_MESSAGE* pMsg) {
WM_BroadcastMessage:
        PUSH     {R3-R5,LR}
          CFI R14 Frame(CFA, -4)
          CFI R5 Frame(CFA, -8)
...
//   35   WM_HWIN hWin;
//   36   WM_LOCK();
//   37   for (hWin = WM__FirstWin; hWin; ) {
        LDR.N    R0,??WM_BroadcastMessage_0
        LDRSH    R5,[R0, #+0]
        B.N      ??WM_BroadcastMessage_1
//   38     WM_SendMessage(hWin, pMsg);
??WM_BroadcastMessage_2:
        MOV      R1,R4
        MOV      R0,R5
          CFI FunCall WM_SendMessage
        BL       WM_SendMessage
//   39     hWin = WM_H2P(hWin)->hNextLin;
        MOV      R0,R5
...
//   44 
//   45 #else
//   46   void WM_Broadcast(void) {} /* avoid empty object files */
