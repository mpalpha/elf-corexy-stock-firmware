///////////////////////////////////////////////////////////////////////////////
//
// IAR ANSI C/C++ Compiler V7.10.1.6676/W32 for ARM       25/Feb/2020  18:23:13
// Copyright 1999-2014 IAR Systems AB.
//
//    Cpu mode     =  thumb
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\User\ui\QRENCODE\qrencode.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\User\ui\QRENCODE\qrencode.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\EWARM\mksRobin2/List\qrencode.s
//
///////////////////////////////////////////////////////////////////////////////
...
//  634 }
//  635 //¶þÎ¬Âë×ª»»¸ñÊ½
//  636 //string£º¶þÎ¬ÂëµÄ×ª»»×Ö·ûÊý¾Ý
//  637 //version£ºÊ¹ÓÃµÄ°æ±¾
//  638 //level£º¾À´í¼¶±ð
//  639 //hint£º±àÂëÄ£Ê½
//  640 //casesensitive£ºÊÇ·ñÇø·Ö´óÐ¡Ð´
...
//  652 		errno = EINVAL;
        ...
        MOV      R1,#-1
        STR      R1,[R0, #+0]
//  653 		return NULL;//Èç¹û±àÂëÄ£Ê½²»ÊÇ8bit»òÕßÈÕ±¾ºº×ÖÄ£Ê½ ·µ»Ø´íÎó
        MOVS     R0,#+0
        POP      {R4-R6,PC}
//  654 	}
//  655 	if(mqr) {
...
//  656 		input = QRinput_newMQR(version, level);//MQRÊý¾Ý
