...
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Core\GUI__ReduceRect.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Core\GUI__ReduceRect.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\EWARM\mksRobin2/List\GUI__ReduceRect.s
//
///////////////////////////////////////////////////////////////////////////////
...
//   13 *
//   14 ----------------------------------------------------------------------
//   15 File        : GUI__ReduceRect.C
//   16 Purpose     : Implementation of GUI__ReduceRect
//   17 ---------------------------END-OF-HEADER------------------------------
//   18 */
//   19 
...
//   31 */
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI Function GUI__ReduceRect
          CFI NoCalls
        THUMB
//   32 void GUI__ReduceRect(GUI_RECT* pDest, const GUI_RECT *pRect, int Dist) {
//   33   pDest->x0 = pRect->x0 + Dist;
GUI__ReduceRect:
        LDRH     R3,[R1, #+0]
        ADDS     R3,R2,R3
        STRH     R3,[R0, #+0]
//   34   pDest->x1 = pRect->x1 - Dist;
        LDRH     R3,[R1, #+4]
        SUBS     R3,R3,R2
        STRH     R3,[R0, #+4]
//   35   pDest->y0 = pRect->y0 + Dist;
        LDRH     R3,[R1, #+2]
        ADDS     R3,R2,R3
        STRH     R3,[R0, #+2]
//   36   pDest->y1 = pRect->y1 - Dist;
        LDRH     R1,[R1, #+6]
        SUBS     R1,R1,R2
        STRH     R1,[R0, #+6]
//   37 }
