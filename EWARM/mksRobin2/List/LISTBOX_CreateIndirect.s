...
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\LISTBOX_CreateIndirect.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\LISTBOX_CreateIndirect.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\EWARM\mksRobin2/List\LISTBOX_CreateIndirect.s
//
///////////////////////////////////////////////////////////////////////////////
        ...
        EXTERN LISTBOX_CreateEx

        PUBLIC LISTBOX_CreateIndirect
...
//   13 *
//   14 ----------------------------------------------------------------------
//   15 File        : LISTBOX_CreateIndirect.c
...
//   31 /*********************************************************************
//   32 *
//   33 *       LISTBOX_CreateIndirect
//   34 */

        SECTION `.text`:CODE:NOROOT(1)
          CFI Block cfiBlock0 Using cfiCommon0
          CFI Function LISTBOX_CreateIndirect
        THUMB
//   35 LISTBOX_Handle LISTBOX_CreateIndirect(const GUI_WIDGET_CREATE_INFO* pCreateInfo, WM_HWIN hWinParent, int x0, int y0, WM_CALLBACK* cb) {
LISTBOX_CreateIndirect:
        ...
        MOV      R4,R2
        MOV      R5,R3
//   36   LISTBOX_Handle hObj;
//   37   GUI_USE_PARA(cb);
//   38   hObj = LISTBOX_CreateEx(pCreateInfo->x0 + x0, pCreateInfo->y0 + y0, pCreateInfo->xSize, pCreateInfo->ySize,
//   39                           hWinParent, 0, pCreateInfo->Flags, pCreateInfo->Id, 0);
//   40   return hObj;
        MOVS     R2,#+0
        STR      R2,[SP, #+16]
        LDRSH    R2,[R0, #+8]
...
//   44   void LISTBOX_CreateIndirect_C(void) {}
//   45 #endif
// 
