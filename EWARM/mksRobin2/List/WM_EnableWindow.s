...
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\WM\WM_EnableWindow.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\WM\WM_EnableWindow.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\EWARM\mksRobin2/List\WM_EnableWindow.s
//
///////////////////////////////////////////////////////////////////////////////
        ...
        PUBLIC WM_DisableWindow
        PUBLIC WM_EnableWindow
        PUBLIC WM_SetEnableState
...
//   13 *
//   14 ----------------------------------------------------------------------
//   15 File        : WM_EnableWindow.c
//   16 Purpose     : Implementation of WM_EnableWindow, WM_DisableWindow
//   17 ----------------------------------------------------------------------
//   18 */
//   19 
...
//   31 /*********************************************************************
//   32 *
//   33 *       WM_SetEnableState
//   34 */

        SECTION `.text`:CODE:NOROOT(1)
          CFI Block cfiBlock0 Using cfiCommon0
          CFI Function WM_SetEnableState
        THUMB
...
//   41   if (State) {
        CMP      R5,#+0
        BEQ.N    ??WM_SetEnableState_0
//   42     Status &= ~WM_SF_DISABLED;
        MOVW     R3,#+65519
        ANDS     R2,R3,R2
        B.N      ??WM_SetEnableState_1
//   43   } else {
...
//   59 */
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI Function WM_EnableWindow
        THUMB
//   60 void WM_EnableWindow(WM_HWIN hWin) {
//   61   WM_SetEnableState(hWin, 1);
WM_EnableWindow:
        MOVS     R1,#+1
          CFI FunCall WM_SetEnableState
        B.N      WM_SetEnableState
...
//   70 }
        ...
        END
//   71 #else
//   72   void WM_EnableWindow_C(void) {} /* avoid empty object files */
//   73 #endif
//   74 
//   75 /*************************** End of file ****************************/
// 
