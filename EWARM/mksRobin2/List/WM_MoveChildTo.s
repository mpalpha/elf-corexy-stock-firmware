...
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\WM\WM_MoveChildTo.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\WM\WM_MoveChildTo.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\EWARM\mksRobin2/List\WM_MoveChildTo.s
//
///////////////////////////////////////////////////////////////////////////////
        ...
        EXTERN WM_GetParent
        EXTERN WM__MoveWindow

        PUBLIC WM_MoveChildTo
...
//   33 */
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI Function WM_MoveChildTo
        THUMB
//   34 void WM_MoveChildTo(WM_HWIN hWin, int x, int y) {
WM_MoveChildTo:
        PUSH     {R3-R7,LR}
          CFI R14 Frame(CFA, -4)
          CFI R7 Frame(CFA, -8)
...
//   39     if (hParent) {
        CMP      R0,#+0
        BEQ.N    ??WM_MoveChildTo_0
//   40       WM_Obj * pParent, * pWin;
//   41       pParent = WM_HANDLE2PTR(hParent);
          CFI FunCall GUI_ALLOC_h2p
        BL       GUI_ALLOC_h2p
        MOV      R5,R0
//   42       pWin    = WM_HANDLE2PTR(hWin);
        MOV      R0,R4
          CFI FunCall GUI_ALLOC_h2p
        BL       GUI_ALLOC_h2p
//   43       x -= pWin->Rect.x0 - pParent->Rect.x0;
//   44       y -= pWin->Rect.y0 - pParent->Rect.y0;
//   45       WM__MoveWindow(hWin, x, y);
        LDRSH    R1,[R0, #+2]
        SUBS     R1,R7,R1
        LDRSH    R2,[R5, #+2]
        ADDS     R2,R2,R1
...
//   50 
//   51 #else
//   52   void WM_MoveChildTo_c(void) {} /* avoid empty object files */
