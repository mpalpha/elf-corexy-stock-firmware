...
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\LISTVIEW_SetFont.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\LISTVIEW_SetFont.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\EWARM\mksRobin2/List\LISTVIEW_SetFont.s
//
///////////////////////////////////////////////////////////////////////////////
...
//   13 *
//   14 ----------------------------------------------------------------------
//   15 File        : LISTVIEW_SetFont.c
//   16 Purpose     : Implementation of LISTVIEW_SetFont
//   17 ---------------------------END-OF-HEADER------------------------------
//   18 */
//   19 
...
//   33 */
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI Function LISTVIEW_SetFont
        THUMB
//   34 void LISTVIEW_SetFont(LISTVIEW_Handle hObj, const GUI_FONT GUI_UNI_PTR * pFont) {
LISTVIEW_SetFont:
        PUSH     {R4-R6,LR}
          CFI R14 Frame(CFA, -4)
          CFI R6 Frame(CFA, -8)
...
//   38     pObj = LISTVIEW_H2P(hObj);
        ...
        BL       GUI_ALLOC_h2p
        MOV      R6,R0
//   39     if (pFont != pObj->Props.pFont) {
        LDR      R0,[R6, #+80]
        CMP      R5,R0
        BEQ.N    ??LISTVIEW_SetFont_0
//   40       pObj->Props.pFont = pFont;
        STR      R5,[R6, #+80]
//   41       LISTVIEW__UpdateScrollParas(hObj, pObj);
        MOV      R1,R6
        MOV      R0,R4
...
//   49   void LISTVIEW_SetFont_C(void);
//   50   void LISTVIEW_SetFont_C(void) {}
//   51 #endif
// 
