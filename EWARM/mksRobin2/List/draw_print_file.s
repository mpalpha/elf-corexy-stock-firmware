///////////////////////////////////////////////////////////////////////////////
//
// IAR ANSI C/C++ Compiler V7.10.1.6676/W32 for ARM       25/Feb/2020  18:22:52
// Copyright 1999-2014 IAR Systems AB.
//
//    Cpu mode     =  thumb
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_ºŒ∫Ã»˝Œ¨\mksRobin_Nano_code\User\ui\draw_print_file.cpp
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_ºŒ∫Ã»˝Œ¨\mksRobin_Nano_code\User\ui\draw_print_file.cpp
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_ºŒ∫Ã»˝Œ¨\mksRobin_Nano_code\EWARM\mksRobin2/List\draw_print_file.s
//
///////////////////////////////////////////////////////////////////////////////
...
//  358 	{		
//  359 		GUI_DispStringAt("’˝‘⁄›d»Î......", 300, 200);
//  360 	}	
//  361 	else
//  362 	{		
//  363 		GUI_DispStringAt("’˝‘⁄‘ÿ»Î......", 300, 200);
//  364 	}
//  365 #endif	
//  366 	
//  367 	hPrintFileWnd = 0;
...
//  455 		GUI_DispStringAt("’˝‘⁄›d»Î......", 300, 200);
//  456 	}
//  457 	else
//  458 	{
//  459 		GUI_DispStringAt(creat_title_text(), X_ADD, X_INTERVAL);
//  460 		GUI_DispStringAt("’˝‘⁄‘ÿ»Î......", 300, 200);
//  461 	}
//  462 #endif
...
//  540 		//BUTTON_SetText(buttonF[0], "Êó†Êñá‰ª?);
//  541 		
...
//  555 			{
//  556 				GUI_DispStringAt("üoŒƒº˛! ", 350, 200);
//  557 				GUI_DispStringAt("’à≤Â»ÎSDø® / U±P!", 310, 250);
//  558 			}
//  559 			else
//  560 			{
//  561 				GUI_DispStringAt("ŒﬁŒƒº˛ !", 350, 200);
//  562 				GUI_DispStringAt("«Î≤Â»ÎSDø® / U≈Ã!", 310, 250);
//  563 			}
//  564 			#endif
...
//  576 			{
//  577 				GUI_DispStringAt("üoŒƒº˛! ", 300, 200);
//  578 			}
//  579 			else
//  580 			{
//  581 				GUI_DispStringAt("ŒﬁŒƒº˛ ! ",300, 200);
//  582 			}
//  583 			#endif
