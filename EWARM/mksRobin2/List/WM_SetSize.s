...
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\WM\WM_SetSize.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\WM\WM_SetSize.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\EWARM\mksRobin2/List\WM_SetSize.s
//
///////////////////////////////////////////////////////////////////////////////
...
//   35 */
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI Function WM_SetSize
        THUMB
//   36 void WM_SetSize(WM_HWIN hWin, int xSize, int ySize) {
WM_SetSize:
        PUSH     {R4-R6,LR}
          CFI R14 Frame(CFA, -4)
          CFI R6 Frame(CFA, -8)
...
//   41     pWin = WM_H2P(hWin);
        ...
        BL       GUI_ALLOC_h2p
//   42     dx = xSize - (pWin->Rect.x1 - pWin->Rect.x0 + 1);
//   43     dy = ySize - (pWin->Rect.y1 - pWin->Rect.y0 + 1);
//   44     WM_ResizeWindow(hWin, dx, dy);
        LDRSH    R1,[R0, #+6]
        SUBS     R1,R6,R1
        LDRSH    R2,[R0, #+2]
        ADDS     R1,R2,R1
...
//   48 
//   49 #else
//   50   void WM_SetSize_C(void) {} /* avoid empty object files */
//   51 #endif
//   52 
//   53 /*************************** End of file ****************************/
// 
