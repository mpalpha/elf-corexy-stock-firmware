...
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\LISTVIEW_SetGridVis.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\LISTVIEW_SetGridVis.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\EWARM\mksRobin2/List\LISTVIEW_SetGridVis.s
//
///////////////////////////////////////////////////////////////////////////////
...
//   13 *
//   14 ----------------------------------------------------------------------
//   15 File        : LISTVIEW_SetGridVis.c
//   16 Purpose     : Implementation of LISTVIEW_SetGridVis
//   17 ---------------------------END-OF-HEADER------------------------------
//   18 */
//   19 
...
//   30 /*********************************************************************
//   31 *
//   32 *       LISTVIEW_SetGridVis
//   33 */

        SECTION `.text`:CODE:NOROOT(1)
          CFI Block cfiBlock0 Using cfiCommon0
          CFI Function LISTVIEW_SetGridVis
        THUMB
//   34 int LISTVIEW_SetGridVis(LISTVIEW_Handle hObj, int Show) {
LISTVIEW_SetGridVis:
        PUSH     {R3-R7,LR}
          CFI R14 Frame(CFA, -4)
          CFI R7 Frame(CFA, -8)
...
//   39     pObj     = LISTVIEW_H2P(hObj);
        ...
        BL       GUI_ALLOC_h2p
        MOV      R7,R0
//   40     ShowGrid = pObj->ShowGrid;
        LDR      R6,[R7, #+88]
//   41     if (Show != ShowGrid) {
        CMP      R5,R6
        BEQ.N    ??LISTVIEW_SetGridVis_0
//   42       pObj->ShowGrid = Show;
        STR      R5,[R7, #+88]
...
//   52   void LISTVIEW_SetGridVis_C(void);
//   53   void LISTVIEW_SetGridVis_C(void) {}
//   54 #endif
// 
