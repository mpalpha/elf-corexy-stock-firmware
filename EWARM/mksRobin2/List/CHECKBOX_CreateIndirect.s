...
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\CHECKBOX_CreateIndirect.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\CHECKBOX_CreateIndirect.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\EWARM\mksRobin2/List\CHECKBOX_CreateIndirect.s
//
///////////////////////////////////////////////////////////////////////////////
        ...
        EXTERN CHECKBOX_CreateEx

        PUBLIC CHECKBOX_CreateIndirect
...
//   13 *
//   14 ----------------------------------------------------------------------
//   15 File        : CHECKBOX_CreateIndirect.c
...
//   31 /*********************************************************************
//   32 *
//   33 *       CHECKBOX_CreateIndirect
//   34 */

        SECTION `.text`:CODE:NOROOT(1)
          CFI Block cfiBlock0 Using cfiCommon0
          CFI Function CHECKBOX_CreateIndirect
        THUMB
//   35 CHECKBOX_Handle CHECKBOX_CreateIndirect(const GUI_WIDGET_CREATE_INFO* pCreateInfo, WM_HWIN hWinParent, int x0, int y0, WM_CALLBACK* cb) {
CHECKBOX_CreateIndirect:
        ...
        MOV      R4,R2
        MOV      R5,R3
//   36   CHECKBOX_Handle  hThis;
//   37   GUI_USE_PARA(cb);
//   38   hThis = CHECKBOX_CreateEx(pCreateInfo->x0 + x0, pCreateInfo->y0 + y0, pCreateInfo->xSize, pCreateInfo->ySize,
//   39                             hWinParent, 0, pCreateInfo->Flags, pCreateInfo->Id);
//   40   return hThis;
        LDRSH    R2,[R0, #+8]
        STR      R2,[SP, #+12]
        LDRH     R2,[R0, #+18]
        ...
        LDRSH    R0,[R0, #+10]
        ADDS     R0,R4,R0
          CFI FunCall CHECKBOX_CreateEx
        BL       CHECKBOX_CreateEx
        ADD      SP,SP,#+20
          CFI CFA R13+12
        POP      {R4,R5,PC}       ;; return
...
//   42 
//   43 #else
//   44   void CHECKBOX_CreateIndirect_C(void) {}
//   45 #endif  /* #if GUI_WINSUPPORT */
//   46 
//   47 
//   48 
// 
