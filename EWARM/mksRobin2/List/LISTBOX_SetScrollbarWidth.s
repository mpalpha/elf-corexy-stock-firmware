...
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\LISTBOX_SetScrollbarWidth.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\LISTBOX_SetScrollbarWidth.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\EWARM\mksRobin2/List\LISTBOX_SetScrollbarWidth.s
//
///////////////////////////////////////////////////////////////////////////////
        ...
        EXTERN LISTBOX__SetScrollbarWidth
        EXTERN WM_InvalidateWindow

        PUBLIC LISTBOX_SetScrollbarWidth
...
//   13 *
//   14 ----------------------------------------------------------------------
//   15 File        : LISTBOX_SetScrollbarWidth.c
...
//   30 /*********************************************************************
//   31 *
//   32 *       LISTBOX_SetScrollbarWidth
//   33 */

        SECTION `.text`:CODE:NOROOT(1)
          CFI Block cfiBlock0 Using cfiCommon0
          CFI Function LISTBOX_SetScrollbarWidth
        THUMB
//   34 void LISTBOX_SetScrollbarWidth(LISTBOX_Handle hObj, unsigned Width) {
...
//   36   if (hObj) {
        CMP      R4,#+0
        BEQ.N    ??LISTBOX_SetScrollbarWidth_0
//   37     WM_LOCK();
//   38     pObj = LISTBOX_H2P(hObj);
          CFI FunCall GUI_ALLOC_h2p
        BL       GUI_ALLOC_h2p
//   39     ASSERT_IS_VALID_PTR(pObj);
//   40     if (Width != (unsigned)pObj->ScrollbarWidth) {
        LDRB     R1,[R0, #+117]
        CMP      R5,R1
        BEQ.N    ??LISTBOX_SetScrollbarWidth_0
//   41       pObj->ScrollbarWidth = Width;
        STRB     R5,[R0, #+117]
//   42       LISTBOX__SetScrollbarWidth(hObj, pObj);
        MOV      R1,R0
        MOV      R0,R4
          CFI FunCall LISTBOX__SetScrollbarWidth
        BL       LISTBOX__SetScrollbarWidth
//   43       LISTBOX_Invalidate(hObj);
        MOV      R0,R4
        POP      {R1,R4,R5,LR}
          CFI R4 SameValue
          CFI R5 SameValue
...
//   50   void LISTBOX_SetScrollbarWidth_C(void) {}
//   51 #endif
//   52 
//   53 /*************************** End of file ****************************/
// 
