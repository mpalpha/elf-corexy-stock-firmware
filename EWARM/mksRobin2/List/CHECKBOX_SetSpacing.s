...
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\CHECKBOX_SetSpacing.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\CHECKBOX_SetSpacing.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\EWARM\mksRobin2/List\CHECKBOX_SetSpacing.s
//
///////////////////////////////////////////////////////////////////////////////
...
//   13 *
//   14 ----------------------------------------------------------------------
//   15 File        : CHECKBOX_SetSpacing.c
//   16 Purpose     : Implementation of CHECKBOX_SetSpacing
//   17 ---------------------------END-OF-HEADER------------------------------
//   18 */
//   19 
...
//   30 /*********************************************************************
//   31 *
//   32 *       CHECKBOX_SetSpacing
//   33 */

        SECTION `.text`:CODE:NOROOT(1)
          CFI Block cfiBlock0 Using cfiCommon0
          CFI Function CHECKBOX_SetSpacing
        THUMB
//   34 void CHECKBOX_SetSpacing(CHECKBOX_Handle hObj, unsigned Spacing) {
CHECKBOX_SetSpacing:
        PUSH     {R3-R5,LR}
          CFI R14 Frame(CFA, -4)
          CFI R5 Frame(CFA, -8)
...
//   36   if (hObj) {
        CMP      R4,#+0
        BEQ.N    ??CHECKBOX_SetSpacing_0
//   37     WM_LOCK();
//   38     pObj = CHECKBOX_H2P(hObj);
          CFI FunCall GUI_ALLOC_h2p
        BL       GUI_ALLOC_h2p
//   39     if ((unsigned)pObj->Props.Spacing != Spacing) {
        LDRB     R1,[R0, #+62]
        CMP      R1,R5
        BEQ.N    ??CHECKBOX_SetSpacing_0
//   40       pObj->Props.Spacing = Spacing;
        STRB     R5,[R0, #+62]
//   41       WM_Invalidate(hObj);
        MOV      R0,R4
        POP      {R1,R4,R5,LR}
          CFI R4 SameValue
          CFI R5 SameValue
...
//   48   void CHECKBOX_SetSpacing_C(void);
//   49   void CHECKBOX_SetSpacing_C(void) {}
//   50 #endif
// 
