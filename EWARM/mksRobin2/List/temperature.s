///////////////////////////////////////////////////////////////////////////////
//
// IAR ANSI C/C++ Compiler V7.10.1.6676/W32 for ARM       25/Feb/2020  18:23:37
// Copyright 1999-2014 IAR Systems AB.
//
//    Cpu mode     =  thumb
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_ºŒ∫Ã»˝Œ¨\mksRobin_Nano_code\Middlewares\Third_Party\Marlin\temperature.cpp
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_ºŒ∫Ã»˝Œ¨\mksRobin_Nano_code\Middlewares\Third_Party\Marlin\temperature.cpp
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_ºŒ∫Ã»˝Œ¨\mksRobin_Nano_code\EWARM\mksRobin2/List\temperature.s
//
///////////////////////////////////////////////////////////////////////////////
...
//  734         pid_output = BANG_MAX;
        LDR.W    R0,??DataTable69  ;; 0x437f0000
...
//  741         ) {
??get_pid_output_1:
        LDR.W    R1,??DataTable68_8  ;; 0xc2200000
          CFI FunCall __aeabi_cfcmple
        BL       __aeabi_cfcmple
...
//  773         if (pid_output > PID_MAX) {
        LDR.W    R1,??DataTable68_9  ;; 0x437f0001
          CFI FunCall __aeabi_cfrcmple
        BL       __aeabi_cfrcmple
...
??manage_heater_4:
        ...
        B.N      ??manage_heater_7
??manage_heater_6:
        LDR.W    R4,??DataTable71  ;; 0xa3d70a4
        LDR.W    R5,??DataTable71_1  ;; 0xc070dfd7
??manage_heater_7:
        LDR      R0,[R6, #+56]
          CFI FunCall __aeabi_f2d
        BL       __aeabi_f2d
...
??manage_heater_17:
        LDR      R4,[R6, #+64]
        LDR.W    R7,??DataTable72_2  ;; 0x40a00000
        LDRB     R0,[R5, #+5]
        CMP      R0,#+0
...
??init_10:
        ...
        MOV      R0,R6
          CFI FunCall _ZN11Temperature14analog2tempBedEi
        BL       _ZN11Temperature14analog2tempBedEi
        LDR.W    R1,??DataTable72_2  ;; 0x40a00000
          CFI FunCall __aeabi_cfcmple
        BL       __aeabi_cfcmple
        BCC.N    ??init_11
...
// 1598     DISABLE_HEATER(0);
        ...
        MOV      R0,R1
          CFI FunCall _ZN11Temperature15setTargetHotendEfh
        BL       _ZN11Temperature15setTargetHotendEfh
        LDR.N    R5,??DataTable68_10
        MOVS     R0,#+0
        STRB     R0,[R5, #+0]
        LDR.W    R6,??DataTable72_6
        LDR.W    R7,??DataTable72_5
        LDR.W    R8,??DataTable72_4
        LDRB     R0,[R8, #+19]
        CMP      R0,#+0
...
// 1911         #if HOTENDS > 4
// 1912           ISR_STATICS(4);
// 1913         #endif // HOTENDS > 4
// 1914       #endif // HOTENDS > 3
// 1915     #endif // HOTENDS > 2
// 1916   #endif // HOTENDS > 1
// 1917   #if HAS_HEATER_BED
// 1918     ISR_STATICS(BED);
// 1919   #endif
// 1920 
// 1921   #if ENABLED(FILAMENT_WIDTH_SENSOR)
// 1922     static unsigned long raw_filwidth_value = 0;
// 1923   #endif
// 1924 
// 1925   #if DISABLED(SLOW_PWM_HEATERS)
// 1926     constexpr uint8_t pwm_mask =
// 1927       #if ENABLED(SOFT_PWM_DITHER)
// 1928         _BV(SOFT_PWM_SCALE) - 1
// 1929       #else
// 1930         0
// 1931       #endif
// 1932     ;
// 1933 
// 1934     /**
// 1935      * Standard PWM modulation
// 1936      */
// 1937     if (pwm_count_tmp >= 127) {
        CMP      R5,#+127
        BLT.N    ??TemperatureHandler_1
// 1938       pwm_count_tmp -= 127;
        SUBS     R5,R5,#+127
        UXTB     R5,R5
// 1939       soft_pwm_count_0 = (soft_pwm_count_0 & pwm_mask) + soft_pwm_amount[0];
        LDRB     R0,[R4, #+0]
        STRB     R0,[R4, #+8]
// 1940       //WRITE_HEATER_0(soft_pwm_count_0 > pwm_mask ? HIGH : LOW);
// 1941 	  if(soft_pwm_count_0 > pwm_mask) WRITE_HEATER_0(HIGH);
        CMP      R0,#+0
        ...
        LDR      R0,[R0, #+88]
          CFI FunCall HAL_GPIO_WritePin
        BL       HAL_GPIO_WritePin
// 1942 	  else WRITE_HEATER_0(LOW);      
// 1943       #if HOTENDS > 1
// 1944 	  //sean 19.8.20
// 1945         //soft_pwm_count_1 = (soft_pwm_count_1 & pwm_mask) + soft_pwm_amount[1];
// 1946         //WRITE_HEATER_1(soft_pwm_count_1 > pwm_mask ? HIGH : LOW);
// 1947         #if HOTENDS > 2
// 1948           soft_pwm_count_2 = (soft_pwm_count_2 & pwm_mask) + soft_pwm_amount[2];
// 1949           WRITE_HEATER_2(soft_pwm_count_2 > pwm_mask ? HIGH : LOW);
// 1950           #if HOTENDS > 3
// 1951             soft_pwm_count_3 = (soft_pwm_count_3 & pwm_mask) + soft_pwm_amount[3];
// 1952             WRITE_HEATER_3(soft_pwm_count_3 > pwm_mask ? HIGH : LOW);
// 1953             #if HOTENDS > 4
// 1954               soft_pwm_count_4 = (soft_pwm_count_4 & pwm_mask) + soft_pwm_amount[4];
// 1955               WRITE_HEATER_4(soft_pwm_count_4 > pwm_mask ? HIGH : LOW);
// 1956             #endif // HOTENDS > 4
// 1957           #endif // HOTENDS > 3
// 1958         #endif // HOTENDS > 2
// 1959       #endif // HOTENDS > 1
// 1960 
// 1961       #if HAS_HEATER_BED
// 1962         soft_pwm_count_BED = (soft_pwm_count_BED & pwm_mask) + soft_pwm_amount_bed;
??TemperatureHandler_2:
        LDRB     R0,[R4, #+3]
        STRB     R0,[R4, #+9]
// 1963         //WRITE_HEATER_BED(soft_pwm_count_BED > pwm_mask ? HIGH : LOW);
// 1964 		if(soft_pwm_count_BED > pwm_mask) WRITE_HEATER_BED(HIGH);
        CMP      R0,#+0
...
// 1965 		else WRITE_HEATER_BED(LOW);        
// 1966       #endif
// 1967 
// 1968       #if ENABLED(FAN_SOFT_PWM)
// 1969         #if HAS_FAN0
// 1970           soft_pwm_count_fan[0] = (soft_pwm_count_fan[0] & pwm_mask) + (soft_pwm_amount_fan[0] >> 1);
// 1971           WRITE_FAN(soft_pwm_count_fan[0] > pwm_mask ? HIGH : LOW);
// 1972         #endif
// 1973         #if HAS_FAN1
// 1974           soft_pwm_count_fan[1] = (soft_pwm_count_fan[1] & pwm_mask) + (soft_pwm_amount_fan[1] >> 1);
// 1975           WRITE_FAN1(soft_pwm_count_fan[1] > pwm_mask ? HIGH : LOW);
// 1976         #endif
// 1977         #if HAS_FAN2
// 1978           soft_pwm_count_fan[2] = (soft_pwm_count_fan[2] & pwm_mask) + (soft_pwm_amount_fan[2] >> 1);
// 1979           WRITE_FAN2(soft_pwm_count_fan[2] > pwm_mask ? HIGH : LOW);
// 1980         #endif
// 1981       #endif
// 1982     }
// 1983     else {
// 1984       if (soft_pwm_count_0 <= pwm_count_tmp) WRITE_HEATER_0(LOW);
...
// 1985       #if HOTENDS > 1
// 1986 	  //sean 19.8.20
// 1987         //if (soft_pwm_count_1 <= pwm_count_tmp) WRITE_HEATER_1(LOW);
// 1988         #if HOTENDS > 2
// 1989           if (soft_pwm_count_2 <= pwm_count_tmp) WRITE_HEATER_2(LOW);
// 1990           #if HOTENDS > 3
// 1991             if (soft_pwm_count_3 <= pwm_count_tmp) WRITE_HEATER_3(LOW);
// 1992             #if HOTENDS > 4
// 1993               if (soft_pwm_count_4 <= pwm_count_tmp) WRITE_HEATER_4(LOW);
// 1994             #endif // HOTENDS > 4
// 1995           #endif // HOTENDS > 3
// 1996         #endif // HOTENDS > 2
// 1997       #endif // HOTENDS > 1
// 1998 
// 1999       #if HAS_HEATER_BED
// 2000         if (soft_pwm_count_BED <= pwm_count_tmp) WRITE_HEATER_BED(LOW);
...
// 2001       #endif
// 2002 
// 2003       #if ENABLED(FAN_SOFT_PWM)
// 2004         #if HAS_FAN0
// 2005           if (soft_pwm_count_fan[0] <= pwm_count_tmp) WRITE_FAN(LOW);
// 2006         #endif
// 2007         #if HAS_FAN1
// 2008           if (soft_pwm_count_fan[1] <= pwm_count_tmp) WRITE_FAN1(LOW);
// 2009         #endif
// 2010         #if HAS_FAN2
// 2011           if (soft_pwm_count_fan[2] <= pwm_count_tmp) WRITE_FAN2(LOW);
// 2012         #endif
// 2013       #endif
// 2014     }
// 2015 
// 2016     // SOFT_PWM_SCALE to frequency:
// 2017     //
// 2018     // 0: 16000000/64/256/128 =   7.6294 Hz
// 2019     // 1:                / 64 =  15.2588 Hz
// 2020     // 2:                / 32 =  30.5176 Hz
// 2021     // 3:                / 16 =  61.0352 Hz
// 2022     // 4:                /  8 = 122.0703 Hz
// 2023     // 5:                /  4 = 244.1406 Hz
// 2024     pwm_count = pwm_count_tmp + _BV(SOFT_PWM_SCALE);
??TemperatureHandler_3:
        ADDS     R0,R5,#+1
        STRB     R0,[R4, #+7]
// 2025 
// 2026   #else // SLOW_PWM_HEATERS
// 2027 
// 2028     /**
// 2029      * SLOW PWM HEATERS
// 2030      *
// 2031      * For relay-driven heaters
// 2032      */
// 2033     #ifndef MIN_STATE_TIME
// 2034       #define MIN_STATE_TIME 16 // MIN_STATE_TIME * 65.5 = time in milliseconds
// 2035     #endif
// 2036 
// 2037     // Macros for Slow PWM timer logic
// 2038     #define _SLOW_PWM_ROUTINE(NR, src) \ 
// 2039       soft_pwm_count_ ##NR = src; \ 
// 2040       if (soft_pwm_count_ ##NR > 0) { \ 
// 2041         if (state_timer_heater_ ##NR == 0) { \ 
// 2042           if (state_heater_ ##NR == 0) state_timer_heater_ ##NR = MIN_STATE_TIME; \ 
// 2043           state_heater_ ##NR = 1; \ 
// 2044           WRITE_HEATER_ ##NR(1); \ 
// 2045         } \ 
// 2046       } \ 
// 2047       else { \ 
// 2048         if (state_timer_heater_ ##NR == 0) { \ 
// 2049           if (state_heater_ ##NR == 1) state_timer_heater_ ##NR = MIN_STATE_TIME; \ 
// 2050           state_heater_ ##NR = 0; \ 
// 2051           WRITE_HEATER_ ##NR(0); \ 
// 2052         } \ 
// 2053       }
// 2054     #define SLOW_PWM_ROUTINE(n) _SLOW_PWM_ROUTINE(n, soft_pwm_amount[n])
// 2055 
// 2056     #define PWM_OFF_ROUTINE(NR) \ 
// 2057       if (soft_pwm_count_ ##NR < slow_pwm_count) { \ 
// 2058         if (state_timer_heater_ ##NR == 0) { \ 
// 2059           if (state_heater_ ##NR == 1) state_timer_heater_ ##NR = MIN_STATE_TIME; \ 
// 2060           state_heater_ ##NR = 0; \ 
// 2061           WRITE_HEATER_ ##NR (0); \ 
// 2062         } \ 
// 2063       }
// 2064 
// 2065     if (slow_pwm_count == 0) {
// 2066 
// 2067       SLOW_PWM_ROUTINE(0);
// 2068       #if HOTENDS > 1
// 2069 	  //sean 19.8.20
// 2070         //SLOW_PWM_ROUTINE(1);
// 2071         #if HOTENDS > 2
// 2072           SLOW_PWM_ROUTINE(2);
// 2073           #if HOTENDS > 3
// 2074             SLOW_PWM_ROUTINE(3);
// 2075             #if HOTENDS > 4
// 2076               SLOW_PWM_ROUTINE(4);
// 2077             #endif // HOTENDS > 4
// 2078           #endif // HOTENDS > 3
// 2079         #endif // HOTENDS > 2
// 2080       #endif // HOTENDS > 1
// 2081       #if HAS_HEATER_BED
// 2082         _SLOW_PWM_ROUTINE(BED, soft_pwm_amount_bed); // BED
// 2083       #endif
// 2084 
// 2085     } // slow_pwm_count == 0
// 2086 
// 2087     PWM_OFF_ROUTINE(0);
// 2088     #if HOTENDS > 1
// 2089 	//sean 19.8.20
// 2090       //PWM_OFF_ROUTINE(1);
// 2091       #if HOTENDS > 2
// 2092         PWM_OFF_ROUTINE(2);
// 2093         #if HOTENDS > 3
// 2094           PWM_OFF_ROUTINE(3);
// 2095           #if HOTENDS > 4
// 2096             PWM_OFF_ROUTINE(4);
// 2097           #endif // HOTENDS > 4
// 2098         #endif // HOTENDS > 3
// 2099       #endif // HOTENDS > 2
// 2100     #endif // HOTENDS > 1
// 2101     #if HAS_HEATER_BED
// 2102       PWM_OFF_ROUTINE(BED); // BED
// 2103     #endif
// 2104 
// 2105     #if ENABLED(FAN_SOFT_PWM)
// 2106       if (pwm_count_tmp >= 127) {
// 2107         pwm_count_tmp = 0;
// 2108         #if HAS_FAN0
// 2109           soft_pwm_count_fan[0] = soft_pwm_amount_fan[0] >> 1;
// 2110           WRITE_FAN(soft_pwm_count_fan[0] > 0 ? HIGH : LOW);
// 2111         #endif
// 2112         #if HAS_FAN1
// 2113           soft_pwm_count_fan[1] = soft_pwm_amount_fan[1] >> 1;
// 2114           WRITE_FAN1(soft_pwm_count_fan[1] > 0 ? HIGH : LOW);
// 2115         #endif
// 2116         #if HAS_FAN2
// 2117           soft_pwm_count_fan[2] = soft_pwm_amount_fan[2] >> 1;
// 2118           WRITE_FAN2(soft_pwm_count_fan[2] > 0 ? HIGH : LOW);
// 2119         #endif
// 2120       }
// 2121       #if HAS_FAN0
// 2122         if (soft_pwm_count_fan[0] <= pwm_count_tmp) WRITE_FAN(LOW);
// 2123       #endif
// 2124       #if HAS_FAN1
// 2125         if (soft_pwm_count_fan[1] <= pwm_count_tmp) WRITE_FAN1(LOW);
// 2126       #endif
// 2127       #if HAS_FAN2
// 2128         if (soft_pwm_count_fan[2] <= pwm_count_tmp) WRITE_FAN2(LOW);
// 2129       #endif
// 2130     #endif // FAN_SOFT_PWM
// 2131 
// 2132     // SOFT_PWM_SCALE to frequency:
// 2133     //
// 2134     // 0: 16000000/64/256/128 =   7.6294 Hz
// 2135     // 1:                / 64 =  15.2588 Hz
// 2136     // 2:                / 32 =  30.5176 Hz
// 2137     // 3:                / 16 =  61.0352 Hz
// 2138     // 4:                /  8 = 122.0703 Hz
// 2139     // 5:                /  4 = 244.1406 Hz
// 2140     pwm_count = pwm_count_tmp + _BV(SOFT_PWM_SCALE);
// 2141 
// 2142     // increment slow_pwm_count only every 64th pwm_count,
// 2143     // i.e. yielding a PWM frequency of 16/128 Hz (8s).
// 2144     if (((pwm_count >> SOFT_PWM_SCALE) & 0x3F) == 0) {
// 2145       slow_pwm_count++;
// 2146       slow_pwm_count &= 0x7F;
// 2147 
// 2148       if (state_timer_heater_0 > 0) state_timer_heater_0--;
// 2149       #if HOTENDS > 1
// 2150 	  //sean 19.8.20
// 2151        // if (state_timer_heater_1 > 0) state_timer_heater_1--;
// 2152         #if HOTENDS > 2
// 2153           if (state_timer_heater_2 > 0) state_timer_heater_2--;
// 2154           #if HOTENDS > 3
// 2155             if (state_timer_heater_3 > 0) state_timer_heater_3--;
// 2156             #if HOTENDS > 4
// 2157               if (state_timer_heater_4 > 0) state_timer_heater_4--;
// 2158             #endif // HOTENDS > 4
// 2159           #endif // HOTENDS > 3
// 2160         #endif // HOTENDS > 2
// 2161       #endif // HOTENDS > 1
// 2162       #if HAS_HEATER_BED
// 2163         if (state_timer_heater_BED > 0) state_timer_heater_BED--;
// 2164       #endif
// 2165     } // ((pwm_count >> SOFT_PWM_SCALE) & 0x3F) == 0
// 2166 
// 2167   #endif // SLOW_PWM_HEATERS
// 2168 
// 2169   //
// 2170   // Update lcd buttons 488 times per second
// 2171   //
// 2172   static bool do_buttons;
// 2173   if ((do_buttons ^= true)) lcd_buttons_update();
        LDRB     R0,[R4, #+10]
        EOR      R0,R0,#0x1
        SUBS     R0,R0,#+1
        SBCS     R0,R0,R0
...
// 2174 
// 2175   /**
// 2176    * One sensor is sampled on every other call of the ISR.
// 2177    * Each sensor is read 16 (OVERSAMPLENR) times, taking the average.
// 2178    *
// 2179    * On each Prepare pass, ADC is started for a sensor pin.
// 2180    * On the next pass, the ADC value is read and accumulated.
// 2181    *
// 2182    * This gives each ADC 0.9765ms to charge up.
// 2183    */
// 2184 #if 0
// 2185   #define SET_ADMUX_ADCSRA(pin) ADMUX = _BV(REFS0) | (pin & 0x07); SBI(ADCSRA, ADSC)
// 2186   #ifdef MUX5
// 2187     #define START_ADC(pin) if (pin > 7) ADCSRB = _BV(MUX5); else ADCSRB = 0; SET_ADMUX_ADCSRA(pin)
// 2188   #else
// 2189     #define START_ADC(pin) ADCSRB = 0; SET_ADMUX_ADCSRA(pin)
// 2190   #endif
// 2191 #endif
// 2192   switch (adc_sensor_state) {
...
// 2193 
// 2194     case SensorsReady: {
// 2195       // All sensors have been read. Stay in this state for a few
// 2196       // ISRs to save on calls to temp update/checking code below.
// 2197       constexpr int8_t extra_loops = MIN_ADC_ISR_LOOPS - (int8_t)SensorsReady;
// 2198       static uint8_t delay_count = 0;
// 2199       if (extra_loops > 0) {
// 2200         if (delay_count == 0) delay_count = extra_loops;   // Init this delay
        LDRB     R0,[R4, #+11]
        CMP      R0,#+0
        BNE.N    ??TemperatureHandler_11
        MOVS     R0,#+4
        STRB     R0,[R4, #+11]
// 2201         if (--delay_count)                                 // While delaying...
...
// 2202           adc_sensor_state = (ADCSensorState)(int(SensorsReady) - 1); // retain this state (else, next state will be 0)
        MOVS     R0,#+5
        STRB     R0,[R4, #+6]
        B.N      ??TemperatureHandler_10
// 2203         break;
// 2204       }
// 2205       else
// 2206         adc_sensor_state = (ADCSensorState)0; // Fall-through to start first sensor now
// 2207     }
// 2208 
// 2209     #if HAS_TEMP_0
// 2210       case PrepareTemp_0:
// 2211         //START_ADC(TEMP_0_PIN);
// 2212         break;
// 2213       case MeasureTemp_0:
// 2214 		#if defined(MKS_ROBIN_LITE) || defined(MKS_ROBIN) || defined(MKS_ROBINMINI)|| defined(MKS_ROBIN_NANO)
// 2215 			raw_temp_value[0] += uhADCxConvertedValue[1]>>2;	//TH1
??TemperatureHandler_7:
        LDRH     R0,[R4, #+12]
        LDR.W    R1,??DataTable72_22
        LDRH     R1,[R1, #+2]
        ADD      R0,R0,R1, LSR #+2
        STRH     R0,[R4, #+12]
// 2216 		#elif defined(MKS_ROBINPRO) || defined(MKS_ROBIN2) || defined(MKS_ROBIN2MINI)
// 2217 			raw_temp_value[0] += uhADCxConvertedValue[1];   	//TH1
// 2218 		#endif 
// 2219 
// 2220         break;
        B.N      ??TemperatureHandler_10
// 2221     #endif
// 2222 
// 2223     #if 1//HAS_TEMP_BED
// 2224       case PrepareTemp_BED:
// 2225         //START_ADC(TEMP_BED_PIN);
// 2226         break;
// 2227       case MeasureTemp_BED:
// 2228 			#if defined(MKS_ROBIN_LITE) || defined(MKS_ROBIN) || defined(MKS_ROBINMINI)|| defined(MKS_ROBIN_NANO)
// 2229 				raw_temp_bed_value += uhADCxConvertedValue[0]>>2;	//TB
??TemperatureHandler_9:
        ...
        ADD      R0,R0,R1, LSR #+2
        STRH     R0,[R4, #+36]
// 2230 			#elif defined(MKS_ROBINPRO) || defined(MKS_ROBIN2) || defined(MKS_ROBIN2MINI)
// 2231 				raw_temp_bed_value += uhADCxConvertedValue[0];	//TB
// 2232 			#endif 		
// 2233         break;
        B.N      ??TemperatureHandler_10
// 2234     #endif
// 2235 
// 2236     #if HAS_TEMP_1
// 2237       case PrepareTemp_1:
// 2238         //START_ADC(TEMP_1_PIN);
// 2239         break;
// 2240       case MeasureTemp_1:
// 2241 		#if defined(MKS_ROBIN_LITE) || defined(MKS_ROBIN) || defined(MKS_ROBINMINI)|| defined(MKS_ROBIN_NANO)
// 2242 			
// 2243 			if(gCfgItems.singleNozzle == 1)
...
// 2244 				raw_temp_value[1] += uhADCxConvertedValue[1]>>2;		//TH2
        LDRH     R1,[R1, #+2]
        ADD      R0,R0,R1, LSR #+2
        STRH     R0,[R4, #+14]
        B.N      ??TemperatureHandler_10
// 2245 			else
// 2246 				raw_temp_value[1] += uhADCxConvertedValue[2]>>2;		//TH2
??TemperatureHandler_12:
        LDRH     R1,[R1, #+4]
        ADD      R0,R0,R1, LSR #+2
        STRH     R0,[R4, #+14]
// 2247 		#elif defined(MKS_ROBINPRO) || defined(MKS_ROBIN2) || defined(MKS_ROBIN2MINI)
// 2248 			raw_temp_value[1] += uhADCxConvertedValue[2];   //TH2
// 2249 		#endif 
// 2250 
// 2251         break;
// 2252     #endif
// 2253 
// 2254     #if HAS_TEMP_2
// 2255       case PrepareTemp_2:
// 2256         START_ADC(TEMP_2_PIN);
// 2257         break;
// 2258       case MeasureTemp_2:
// 2259         raw_temp_value[2] += ADC;
// 2260         break;
// 2261     #endif
// 2262 
// 2263     #if HAS_TEMP_3
// 2264       case PrepareTemp_3:
// 2265         START_ADC(TEMP_3_PIN);
// 2266         break;
// 2267       case MeasureTemp_3:
// 2268         raw_temp_value[3] += ADC;
// 2269         break;
// 2270     #endif
// 2271 
// 2272     #if HAS_TEMP_4
// 2273       case PrepareTemp_4:
// 2274         START_ADC(TEMP_4_PIN);
// 2275         break;
// 2276       case MeasureTemp_4:
// 2277         raw_temp_value[4] += ADC;
// 2278         break;
// 2279     #endif
// 2280 
// 2281     #if ENABLED(FILAMENT_WIDTH_SENSOR)
// 2282       case Prepare_FILWIDTH:
// 2283         START_ADC(FILWIDTH_PIN);
// 2284       break;
// 2285       case Measure_FILWIDTH:
// 2286         if (ADC > 102) { // Make sure ADC is reading > 0.5 volts, otherwise don't read.
// 2287           raw_filwidth_value -= (raw_filwidth_value >> 7); // Subtract 1/128th of the raw_filwidth_value
// 2288           raw_filwidth_value += ((unsigned long)ADC << 7); // Add new ADC reading, scaled by 128
// 2289         }
// 2290       break;
// 2291     #endif
// 2292 
// 2293     #if ENABLED(ADC_KEYPAD)
// 2294       case Prepare_ADC_KEY:
// 2295         START_ADC(ADC_KEYPAD_PIN);
// 2296         break;
// 2297       case Measure_ADC_KEY:
// 2298         if (ADCKey_count < 16) {
// 2299           raw_ADCKey_value = ADC;
// 2300           if (raw_ADCKey_value > 900) {
// 2301             //ADC Key release
// 2302             ADCKey_count = 0;
// 2303             current_ADCKey_raw = 0;
// 2304           }
// 2305           else {
// 2306             current_ADCKey_raw += raw_ADCKey_value;
// 2307             ADCKey_count++;
// 2308           }
// 2309         }
// 2310         break;
// 2311     #endif // ADC_KEYPAD
// 2312 
// 2313     case StartupDelay: break;
// 2314 
// 2315   } // switch(adc_sensor_state)
// 2316 
// 2317   if (!adc_sensor_state && ++temp_count >= OVERSAMPLENR) { // 10 * 16 * 1/(16000000/64/256)  = 164ms.
...
// 2319     temp_count = 0;
        ...
        STRB     R0,[R4, #+5]
// 2320 
// 2321     // Update the raw values if they've been read. Else we could be updating them during reading.
// 2322     if (!temp_meas_ready) set_current_temp_raw();
        LDRB     R0,[R4, #+2]
        CMP      R0,#+0
...
// 2323 
// 2324     // Filament Sensor - can be read any time since IIR filtering is used
// 2325     #if ENABLED(FILAMENT_WIDTH_SENSOR)
// 2326       current_raw_filwidth = raw_filwidth_value >> 10;  // Divide to get to 0-16384 range since we used 1/128 IIR filter approach
// 2327     #endif
// 2328 
// 2329     ZERO(raw_temp_value);
??TemperatureHandler_14:
        ...
        ADD      R0,R4,#+12
          CFI FunCall memset
        BL       memset
// 2330     raw_temp_bed_value = 0;
        MOVS     R0,#+0
        STRH     R0,[R4, #+36]
// 2331 
// 2332     #define TEMPDIR(N) ((HEATER_##N##_RAW_LO_TEMP) > (HEATER_##N##_RAW_HI_TEMP) ? -1 : 1)
// 2333 #if 0
// 2334     int constexpr temp_dir[] = {
// 2335       #if ENABLED(HEATER_0_USES_MAX6675)
// 2336          0
// 2337       #else
// 2338         TEMPDIR(0)
// 2339       #endif
...
// 2346             #if HOTENDS > 4
// 2347               , TEMPDIR(4)
// 2348             #endif // HOTENDS > 4
// 2349           #endif // HOTENDS > 3
// 2350         #endif // HOTENDS > 2
// 2351       #endif // HOTENDS > 1
// 2352     };
// 2353 #endif
// 2354 	int  temp_dir[2];
// 2355 	if(TEMP_SENSOR_0 == sensors_MAX31855)
        MOV      R0,#-1
...
// 2357 		temp_dir[0]=0;
        MOVS     R1,#+0
        STR      R1,[SP, #+0]
// 2358 		temp_dir[1]=TEMPDIR(1);       //mks_TC
        STR      R0,[R6, #+4]
        B.N      ??TemperatureHandler_16
// 2359 		}
// 2360 	else
// 2361 		{
// 2362 		temp_dir[0]=TEMPDIR(0);
??TemperatureHandler_15:
        STR      R0,[SP, #+0]
// 2363 		temp_dir[1]=TEMPDIR(1);       //mks_TC
        STR      R0,[R6, #+4]
// 2364 		}
// 2365 	
// 2366 
// 2367       for (uint8_t e = 0; e < COUNT(temp_dir); e++) {
??TemperatureHandler_16:
        MOVS     R7,#+0
        B.N      ??TemperatureHandler_17
// 2368       const int16_t tdir = temp_dir[e], rawtemp = current_temperature_raw[e] * tdir;
// 2369       //const 
// 2370        bool heater_on; //= 0 <
// 2371         /*
// 2372         #if ENABLED(PIDTEMP)
// 2373           soft_pwm_amount[e]
// 2374         #else
// 2375           target_temperature[e]
// 2376         #endif
// 2377       ;
// 2378       */
// 2379       if(PIDTEMP)
// 2380         heater_on = 0 < soft_pwm_amount[e];
// 2381       else
// 2382         heater_on = 0 < target_temperature[e];
??TemperatureHandler_18:
        MOV      R10,#+0
// 2383       
// 2384       //if (rawtemp > maxttemp_raw[e] * tdir && heater_on) max_temp_error(e);
// 2385       if (rawtemp > maxttemp_raw[e] * tdir && loop_start) max_temp_error(e);
??TemperatureHandler_19:
        ADD      R11,R4,R7, LSL #+1
        LDRSH    R0,[R11, #+20]
        MUL      R0,R8,R0
        CMP      R0,R9
        BGE.N    ??TemperatureHandler_20
        LDR.N    R0,??DataTable72_24
        LDRB     R0,[R0, #+0]
        CMP      R0,#+0
        BEQ.N    ??TemperatureHandler_20
        MOV      R0,R7
        SXTB     R0,R0
          CFI FunCall _ZN11Temperature14max_temp_errorEa
        BL       _ZN11Temperature14max_temp_errorEa
// 2386       if (rawtemp < minttemp_raw[e] * tdir && !is_preheating(e) && heater_on) {
??TemperatureHandler_20:
        LDRSH    R0,[R11, #+16]
        MUL      R0,R8,R0
        CMP      R9,R0
        BGE.N    ??TemperatureHandler_21
        CMP      R10,#+0
        BEQ.N    ??TemperatureHandler_21
// 2387         #ifdef MAX_CONSECUTIVE_LOW_TEMPERATURE_ERROR_ALLOWED
// 2388           if (++consecutive_low_temperature_error[e] >= MAX_CONSECUTIVE_LOW_TEMPERATURE_ERROR_ALLOWED)
// 2389         #endif
// 2390             min_temp_error(e);
        MOV      R0,R7
        SXTB     R0,R0
          CFI FunCall _ZN11Temperature14min_temp_errorEa
        BL       _ZN11Temperature14min_temp_errorEa
...
??TemperatureHandler_23:
        LDR      R0,[R0, #+68]
        CMP      R0,#+1
        BLT.N    ??TemperatureHandler_18
        MOV      R10,#+1
        B.N      ??TemperatureHandler_19
// 2392       #ifdef MAX_CONSECUTIVE_LOW_TEMPERATURE_ERROR_ALLOWED
// 2393         else
// 2394           consecutive_low_temperature_error[e] = 0;
// 2395       #endif
// 2396     }
// 2397 
// 2398     #if 1//HAS_TEMP_BED
// 2399       #if HEATER_BED_RAW_LO_TEMP > HEATER_BED_RAW_HI_TEMP
// 2400         #define GEBED <=
// 2401       #else
// 2402         #define GEBED >=
// 2403       #endif
...
// 2405       bool bed_on;// = 0 <
// 2406       /*
// 2407         #if ENABLED(PIDTEMPBED)
// 2408           soft_pwm_amount_bed
// 2409         #else
// 2410           target_temperature_bed
// 2411         #endif
// 2412       ;
// 2413       */
// 2414       if(PIDTEMPBED)
...
// 2415         bed_on = 0 < soft_pwm_amount_bed;
        LDRB     R0,[R4, #+3]
        SUBS     R5,R0,#+1
        SBCS     R5,R5,R5
        MVNS     R5,R5
...
// 2416       else
// 2417         bed_on = 0 < target_temperature_bed;
??TemperatureHandler_24:
        LDRSH    R0,[R4, #+32]
        CMP      R0,#+1
        BLT.N    ??TemperatureHandler_26
        MOVS     R5,#+1
        B.N      ??TemperatureHandler_25
??TemperatureHandler_26:
        MOVS     R5,#+0
// 2418       
// 2419       //if (current_temperature_bed_raw GEBED bed_maxttemp_raw && bed_on) max_temp_error(-1);
// 2420       if (current_temperature_bed_raw GEBED bed_maxttemp_raw && loop_start) max_temp_error(-1);
??TemperatureHandler_25:
        LDRSH    R0,[R4, #+40]
        LDR      R1,[R4, #+76]
        CMP      R0,R1
        BLT.N    ??TemperatureHandler_27
        LDR.N    R0,??DataTable72_24
        LDRB     R0,[R0, #+0]
        CMP      R0,#+0
        ...
        MOV      R0,#-1
          CFI FunCall _ZN11Temperature14max_temp_errorEa
        BL       _ZN11Temperature14max_temp_errorEa
// 2421       if (bed_minttemp_raw GEBED current_temperature_bed_raw && bed_on) min_temp_error(-1);
...
// 2422     #endif
// 2423 
// 2424   } // temp_count >= OVERSAMPLENR
// 2425 
// 2426   // Go to the next state, up to SensorsReady
// 2427   adc_sensor_state = (ADCSensorState)(int(adc_sensor_state) + 1);
??TemperatureHandler_13:
        LDRB     R0,[R4, #+6]
        ADDS     R0,R0,#+1
        STRB     R0,[R4, #+6]
// 2428   if (adc_sensor_state > SensorsReady) adc_sensor_state = (ADCSensorState)0;
        SXTB     R0,R0
        CMP      R0,#+7
        BLT.N    ??TemperatureHandler_28
        MOVS     R0,#+0
        STRB     R0,[R4, #+6]
// 2429 
// 2430   #if ENABLED(BABYSTEPPING)
// 2431     LOOP_XYZ(axis) {
// 2432       const int curTodo = babystepsTodo[axis]; // get rid of volatile for performance
// 2433       if (curTodo) {
// 2434         stepper.babystep((AxisEnum)axis, curTodo > 0);
// 2435         if (curTodo > 0) babystepsTodo[axis]--;
// 2436                     else babystepsTodo[axis]++;
// 2437       }
// 2438     }
// 2439   #endif // BABYSTEPPING
// 2440 
// 2441   #if ENABLED(PINS_DEBUGGING)
// 2442     extern bool endstop_monitor_flag;
// 2443     // run the endstop monitor at 15Hz
// 2444     static uint8_t endstop_monitor_count = 16;  // offset this check from the others
// 2445     if (endstop_monitor_flag) {
// 2446       endstop_monitor_count += _BV(1);  //  15 Hz
// 2447       endstop_monitor_count &= 0x7F;
// 2448       if (!endstop_monitor_count) endstop_monitor();  // report changes in endstop status
// 2449     }
// 2450   #endif
// 2451 
// 2452   #if ENABLED(ENDSTOP_INTERRUPTS_FEATURE)
// 2453 
// 2454     extern volatile uint8_t e_hit;
// 2455 
// 2456     if (e_hit && ENDSTOPS_ENABLED) {
// 2457       endstops.update();  // call endstop update routine
// 2458       e_hit--;
// 2459     }
// 2460   #endif
// 2461 
// 2462   //cli();
// 2463   in_temp_isr = false;
??TemperatureHandler_28:
        MOVS     R0,#+0
        STRB     R0,[R4, #+4]
// 2464   //SBI(TIMSK0, OCIE0B); //re-enable Temperature ISR
// 2465   HAL_TIM_Base_Start_IT(&htim4);
...
max6675_temp:
        ...
        DC32 0
// 2467 
// 2468 #if 1//HAS_TEMP_HOTEND || HAS_TEMP_BED
// 2469 
        ...
        THUMB
// 2470   void print_heater_state(const float &c, const float &t,
// 2471     #if ENABLED(SHOW_TEMP_ADC_VALUES)
// 2472       const float r,
// 2473     #endif
// 2474     const int8_t e=-2
// 2475   ) {
_Z18print_heater_stateRKfS0_a:
        ...
        MOV      R4,R1
        MOV      R7,R2
// 2476     //#if !(HAS_TEMP_BED && HAS_TEMP_HOTEND) && HOTENDS <= 1
// 2477     // UNUSED(e);
// 2478     //#endif
// 2479     if(!(HAS_TEMP_BED))
// 2480     {
// 2481         #if !(HAS_TEMP_HOTEND) && HOTENDS <= 1
// 2482         UNUSED(e);
// 2483         #endif
// 2484     }
// 2485     
// 2486     SERIAL_PROTOCOLCHAR(' ');
        ...
        BL       _ZN10USARTClass5writeEh
// 2487     /*
// 2488     SERIAL_PROTOCOLCHAR(
// 2489       #if HAS_TEMP_BED && HAS_TEMP_HOTEND
// 2490         e == -1 ? 'B' : 'T'
// 2491       #elif HAS_TEMP_HOTEND
// 2492         'T'
// 2493       #else
// 2494         'B'
// 2495       #endif
// 2496       );
// 2497       */
// 2498       #if HAS_TEMP_HOTEND
// 2499           if(HAS_TEMP_BED)
        MOV      R8,R7
        LDR.N    R0,??DataTable72
        LDRB     R0,[R0, #+54]
        CMP      R0,#+0
        BEQ.N    ??print_heater_state_0
// 2500             SERIAL_PROTOCOLCHAR(e == -1 ? 'B' : 'T');
        CMN      R8,#+1
...
// 2504           }
// 2505       #else
// 2506           SERIAL_PROTOCOLCHAR('B');
// 2507       #endif
// 2508     
// 2509     #if HOTENDS > 1
// 2510       if (e >= 0) SERIAL_PROTOCOLCHAR('0' + e);
??print_heater_state_3:
        ...
        BL       _ZN10USARTClass5writeEh
// 2511     #endif
// 2512     SERIAL_PROTOCOLCHAR(':');
??print_heater_state_4:
        MOVS     R1,#+58
        MOV      R0,R5
          CFI FunCall _ZN10USARTClass5writeEh
        BL       _ZN10USARTClass5writeEh
// 2513     SERIAL_PROTOCOL(c);
        MOVS     R0,#+2
        STR      R0,[SP, #+0]
        LDR      R0,[R6, #+0]
          CFI FunCall __aeabi_f2d
...
// 2514     SERIAL_PROTOCOLPAIR(" /" , t);
        LDR      R1,[R4, #+0]
        ADR.N    R0,??DataTable72_1  ;; 0x20, 0x2F, 0x00, 0x00
        POP      {R2-R8,LR}
          CFI R4 SameValue
          CFI R5 SameValue
          CFI R6 SameValue
...
// 2515     #if ENABLED(SHOW_TEMP_ADC_VALUES)
// 2516       SERIAL_PROTOCOLPAIR(" (", r / OVERSAMPLENR);
// 2517       SERIAL_PROTOCOLCHAR(')');
// 2518     #endif
// 2519   }
...
??DataTable70_1:
        DC32     0x44e10000
// 2520 
// 2521   extern uint8_t target_extruder;
// 2522 
        ...
        THUMB
// 2523   void Temperature::print_heaterstates() {
_ZN11Temperature18print_heaterstatesEv:
        PUSH     {R2-R6,LR}
          ...
          CFI R4 Frame(CFA, -16)
          CFI CFA R13+24
// 2524     #if HAS_TEMP_HOTEND
// 2525       print_heater_state(degHotend(target_extruder), degTargetHotend(target_extruder)
// 2526         #if ENABLED(SHOW_TEMP_ADC_VALUES)
// 2527           , rawHotendTemp(target_extruder)
// 2528         #endif
// 2529       );
...
// 2530     #endif
// 2531     //#if HAS_TEMP_BED
// 2532     if(HAS_TEMP_BED)
        LDR.N    R5,??DataTable72
        LDRB     R0,[R5, #+54]
        CMP      R0,#+0
        BEQ.N    ??print_heaterstates_0
// 2533     {
// 2534       print_heater_state(degBed(), degTargetBed()
// 2535         #if ENABLED(SHOW_TEMP_ADC_VALUES)
// 2536           , rawBedTemp()
// 2537         #endif
// 2538         , -1 // BED
// 2539       );
...
// 2541     //#endif
// 2542     #if HOTENDS > 1
// 2543       HOTEND_LOOP() print_heater_state(degHotend(e), degTargetHotend(e)
??print_heaterstates_0:
        MOVS     R6,#+0
        B.N      ??print_heaterstates_1
// 2544         #if ENABLED(SHOW_TEMP_ADC_VALUES)
// 2545           , rawHotendTemp(e)
// 2546         #endif
// 2547         , e
// 2548       );
...
// 2549     #endif
// 2550     SERIAL_PROTOCOLPGM(" @:");
        ADR.N    R0,??DataTable72_3  ;; " @:"
          CFI FunCall _Z14serialprintPGMPKc
        BL       _Z14serialprintPGMPKc
// 2551     SERIAL_PROTOCOL(getHeaterPower(target_extruder));
        LDRB     R0,[R4, #+0]
        ...
        MOV      R0,R4
          CFI FunCall _ZN5Print5printEii
        BL       _ZN5Print5printEii
// 2552     //#if HAS_TEMP_BED
// 2553     if(HAS_TEMP_BED)
        LDRB     R0,[R5, #+54]
        CMP      R0,#+0
        BEQ.N    ??print_heaterstates_3
// 2554     {
// 2555       SERIAL_PROTOCOLPGM(" B@:");
        ADR.W    R0,`?<Constant " B@:">`
          CFI FunCall _Z14serialprintPGMPKc
        BL       _Z14serialprintPGMPKc
// 2556       SERIAL_PROTOCOL(getHeaterPower(-1));
        MOV      R0,#-1
          CFI FunCall _ZN11Temperature14getHeaterPowerEi
        BL       _ZN11Temperature14getHeaterPowerEi
        MOVS     R2,#+10
...
// 2562         SERIAL_PROTOCOLCHAR(':');
        MOVS     R1,#+58
        MOV      R0,R4
          CFI FunCall _ZN10USARTClass5writeEh
        BL       _ZN10USARTClass5writeEh
// 2563         SERIAL_PROTOCOL(getHeaterPower(e));
        MOV      R0,R6
          CFI FunCall _ZN11Temperature14getHeaterPowerEi
        BL       _ZN11Temperature14getHeaterPowerEi
        MOVS     R2,#+10
...
??DataTable71_1:
        DC32     0xc070dfd7
// 2567 
// 2568   #if ENABLED(AUTO_REPORT_TEMPERATURES)
// 2569 

        SECTION `.bss`:DATA:REORDER:NOROOT(2)
// 2570     uint8_t Temperature::auto_report_temp_interval;
_ZN11Temperature25auto_report_temp_intervalE:
        DS8 1
        DS8 3
// 2571     millis_t Temperature::next_temp_report_ms;
...
`?<Constant " @">`:
        ...
        END
// 2572 
// 2573     void Temperature::auto_report_temperatures() {
// 2574       if (auto_report_temp_interval && ELAPSED(millis(), next_temp_report_ms)) {
// 2575         next_temp_report_ms = millis() + 1000UL * auto_report_temp_interval;
// 2576         print_heaterstates();
// 2577         SERIAL_EOL();
// 2578       }
// 2579     }
// 2580 
// 2581   #endif // AUTO_REPORT_TEMPERATURES
// 2582 
// 2583 #endif // HAS_TEMP_HOTEND || HAS_TEMP_BED
// 
//   104 bytes in section .bss
//   160 bytes in section .data
//     4 bytes in section .init_array
//    30 bytes in section .rodata
// 7 478 bytes in section .text
// 
// 7 292 bytes of CODE  memory (+ 190 bytes shared)
