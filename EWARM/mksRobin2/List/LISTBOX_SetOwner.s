...
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\LISTBOX_SetOwner.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\LISTBOX_SetOwner.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\EWARM\mksRobin2/List\LISTBOX_SetOwner.s
//
///////////////////////////////////////////////////////////////////////////////
...
//   13 *
//   14 ----------------------------------------------------------------------
//   15 File        : LISTBOX_SetOwner.c
//   16 Purpose     : Implementation of LISTBOX_SetOwner
//   17 ---------------------------END-OF-HEADER------------------------------
//   18 */
//   19 
...
//   36 */
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI Function LISTBOX_SetOwner
        THUMB
//   37 void LISTBOX_SetOwner(LISTBOX_Handle hObj, WM_HWIN hOwner) {
LISTBOX_SetOwner:
        PUSH     {R3-R5,LR}
          CFI R14 Frame(CFA, -4)
          CFI R5 Frame(CFA, -8)
...
//   38   if (hObj) {
        CMP      R4,#+0
        BEQ.N    ??LISTBOX_SetOwner_0
//   39     LISTBOX_Obj* pObj;
//   40     WM_LOCK();
//   41     pObj = LISTBOX_H2P(hObj);
          CFI FunCall GUI_ALLOC_h2p
        BL       GUI_ALLOC_h2p
//   42     ASSERT_IS_VALID_PTR(pObj);
//   43     pObj->hOwner = hOwner;
        STRH     R5,[R0, #+112]
//   44     LISTBOX__InvalidateInsideArea(hObj);
        MOV      R0,R4
        POP      {R1,R4,R5,LR}
          CFI R4 SameValue
          CFI R5 SameValue
...
//   52   void LISTBOX_SetOwner_C(void) {}
//   53 #endif
// 
