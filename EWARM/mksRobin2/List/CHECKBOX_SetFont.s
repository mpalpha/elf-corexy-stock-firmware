...
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\CHECKBOX_SetFont.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\CHECKBOX_SetFont.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\EWARM\mksRobin2/List\CHECKBOX_SetFont.s
//
///////////////////////////////////////////////////////////////////////////////
...
//   13 *
//   14 ----------------------------------------------------------------------
//   15 File        : CHECKBOX_SetFont.c
//   16 Purpose     : Implementation of CHECKBOX_SetFont
//   17 ---------------------------END-OF-HEADER------------------------------
//   18 */
//   19 
...
//   33 */
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI Function CHECKBOX_SetFont
        THUMB
//   34 void CHECKBOX_SetFont(CHECKBOX_Handle hObj, const GUI_FONT GUI_UNI_PTR * pFont) {
CHECKBOX_SetFont:
        PUSH     {R3-R5,LR}
          CFI R14 Frame(CFA, -4)
          CFI R5 Frame(CFA, -8)
...
//   36   if (hObj) {
        CMP      R4,#+0
        BEQ.N    ??CHECKBOX_SetFont_0
//   37     WM_LOCK();
//   38     pObj = CHECKBOX_H2P(hObj);
          CFI FunCall GUI_ALLOC_h2p
        BL       GUI_ALLOC_h2p
//   39     if (pObj->Props.pFont != pFont) {
        LDR      R1,[R0, #+40]
        CMP      R1,R5
        BEQ.N    ??CHECKBOX_SetFont_0
...
//   48   void CHECKBOX_SetFont_C(void);
//   49   void CHECKBOX_SetFont_C(void) {}
//   50 #endif
// 
