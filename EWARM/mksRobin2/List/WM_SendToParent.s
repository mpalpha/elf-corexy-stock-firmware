...
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\WM\WM_SendToParent.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\WM\WM_SendToParent.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\EWARM\mksRobin2/List\WM_SendToParent.s
//
///////////////////////////////////////////////////////////////////////////////
...
//   40       pMsg->hWinSrc = hChild;
        STRH     R4,[R5, #+6]
//   41       WM_SendMessage(hParent, pMsg);
        MOV      R1,R5
        POP      {R2,R4,R5,LR}
          CFI R4 SameValue
          CFI R5 SameValue
...
//   46 
//   47 #else
//   48   void WM_SendToParent_C(void) {}   /* Avoid empty object files */
