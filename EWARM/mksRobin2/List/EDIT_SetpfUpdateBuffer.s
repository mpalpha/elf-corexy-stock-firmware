...
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\EDIT_SetpfUpdateBuffer.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\EDIT_SetpfUpdateBuffer.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\EWARM\mksRobin2/List\EDIT_SetpfUpdateBuffer.s
//
///////////////////////////////////////////////////////////////////////////////
...
//   13 *
//   14 ----------------------------------------------------------------------
//   15 File        : EDIT_SetpfUpdateBuffer.c
...
//   31 /*********************************************************************
//   32 *
//   33 *       EDIT_SetpfUpdateBuffer
//   34 */

        SECTION `.text`:CODE:NOROOT(1)
          CFI Block cfiBlock0 Using cfiCommon0
          CFI Function EDIT_SetpfUpdateBuffer
        THUMB
//   35 void EDIT_SetpfUpdateBuffer(EDIT_Handle hObj, tEDIT_UpdateBuffer * pfUpdateBuffer) {
...
//   36   if (hObj) {
        CMP      R0,#+0
        BEQ.N    ??EDIT_SetpfUpdateBuffer_0
//   37     EDIT_Obj* pObj;
//   38     WM_LOCK();
//   39     pObj = EDIT_H2P(hObj);
          CFI FunCall GUI_ALLOC_h2p
        BL       GUI_ALLOC_h2p
//   40     pObj->pfUpdateBuffer = pfUpdateBuffer;
        STR      R4,[R0, #+80]
//   41     WM_UNLOCK();
//   42   }
//   43 }
??EDIT_SetpfUpdateBuffer_0:
        POP      {R4,PC}          ;; return
...
//   46 
//   47 void EDIT_SetpfUpdateBuffer_C(void);
//   48 void EDIT_SetpfUpdateBuffer_C(void) {}
//   49 
