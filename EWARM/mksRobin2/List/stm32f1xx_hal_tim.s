///////////////////////////////////////////////////////////////////////////////
//
// IAR ANSI C/C++ Compiler V7.10.1.6676/W32 for ARM       25/Feb/2020  18:23:31
// Copyright 1999-2014 IAR Systems AB.
//
//    Cpu mode     =  thumb
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_ºŒ∫Ã»˝Œ¨\mksRobin_Nano_code\Drivers\STM32F1xx_HAL_Driver\Src\stm32f1xx_hal_tim.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_ºŒ∫Ã»˝Œ¨\mksRobin_Nano_code\Drivers\STM32F1xx_HAL_Driver\Src\stm32f1xx_hal_tim.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_ºŒ∫Ã»˝Œ¨\mksRobin_Nano_code\EWARM\mksRobin2/List\stm32f1xx_hal_tim.s
//
///////////////////////////////////////////////////////////////////////////////
...
//  589   if(IS_TIM_BREAK_INSTANCE(htim->Instance) != RESET)
        LDR      R0,[R4, #+0]
        LDR.W    R1,??DataTable16_1  ;; 0x40012c00
        CMP      R0,R1
        BEQ.N    ??HAL_TIM_OC_Start_0
        LDR.W    R1,??DataTable18  ;; 0x40013400
        CMP      R0,R1
...
// 2084   if(IS_TIM_BREAK_INSTANCE(htim->Instance) != RESET)
        LDR      R0,[R4, #+0]
        LDR.N    R1,??DataTable16_1  ;; 0x40012c00
        CMP      R0,R1
        BEQ.N    ??HAL_TIM_OnePulse_Start_0
        LDR.N    R1,??DataTable18  ;; 0x40013400
        CMP      R0,R1
...
// 2191   if(IS_TIM_BREAK_INSTANCE(htim->Instance) != RESET)
        LDR      R0,[R4, #+0]
        LDR.W    R1,??DataTable21  ;; 0x40012c00
        CMP      R0,R1
...
// 2297   tmpccmr1 |= (sConfig->IC1Filter << 4) | (sConfig->IC2Filter << 12);
        ...
        LDR      R6,[R5, #+24]
        ORR      R3,R3,R6, LSL #+8
        LDR.W    R6,??DataTable21_2  ;; 0xffff0303
        ANDS     R3,R6,R3
        LDR      R6,[R5, #+12]
        ORRS     R3,R6,R3
        LDR      R6,[R5, #+28]
...
// 4559   if (IS_TIM_COUNTER_MODE_SELECT_INSTANCE(TIMx))
        LDR.N    R2,??DataTable28_2  ;; 0x40012c00
        CMP      R0,R2
        BEQ.N    ??TIM_Base_SetConfig_0
        LDR.N    R4,??DataTable28_3  ;; 0x40013400
        CMP      R0,R4
        BEQ.N    ??TIM_Base_SetConfig_0
        CMP      R0,#+1073741824
        BEQ.N    ??TIM_Base_SetConfig_0
        LDR.N    R4,??DataTable28_4  ;; 0x40000400
        CMP      R0,R4
        BEQ.N    ??TIM_Base_SetConfig_0
        LDR.N    R4,??DataTable28_5  ;; 0x40000800
        CMP      R0,R4
        BEQ.N    ??TIM_Base_SetConfig_0
        LDR.N    R4,??DataTable28_6  ;; 0x40000c00
        CMP      R0,R4
...
// 4581   if (IS_TIM_REPETITION_COUNTER_INSTANCE(TIMx))
        ...
        LDR.N    R2,??DataTable28_3  ;; 0x40013400
        CMP      R0,R2
...
// 4626   if(IS_TIM_CCXN_INSTANCE(TIMx, TIM_CHANNEL_1))
        LDR.N    R5,??DataTable28_2  ;; 0x40012c00
        CMP      R0,R5
        BEQ.N    ??TIM_OC1_SetConfig_0
        LDR.N    R6,??DataTable28_3  ;; 0x40013400
        CMP      R0,R6
...
??TIM_OC1_SetConfig_1:
        ...
        LDR.N    R5,??DataTable28_3  ;; 0x40013400
        CMP      R0,R5
...
// 5038   if(IS_TIM_CC2_INSTANCE(TIMx) != RESET)
        LDR.N    R6,??DataTable28_2  ;; 0x40012c00
        CMP      R0,R6
        ...
        CMP      R0,#+1073741824
        BEQ.N    ??TIM_TI1_SetConfig_0
        LDR.N    R6,??DataTable28_4  ;; 0x40000400
        CMP      R0,R6
        BEQ.N    ??TIM_TI1_SetConfig_0
        LDR.N    R6,??DataTable28_5  ;; 0x40000800
        CMP      R0,R6
        BEQ.N    ??TIM_TI1_SetConfig_0
        LDR.N    R6,??DataTable28_6  ;; 0x40000c00
        CMP      R0,R6
