...
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\EDIT_CreateIndirect.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\EDIT_CreateIndirect.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\EWARM\mksRobin2/List\EDIT_CreateIndirect.s
//
///////////////////////////////////////////////////////////////////////////////
        ...
        EXTERN EDIT_CreateEx
        EXTERN EDIT_SetTextAlign

        PUBLIC EDIT_CreateIndirect
...
//   30 /*********************************************************************
//   31 *
//   32 *       EDIT_CreateIndirect
//   33 */

        SECTION `.text`:CODE:NOROOT(1)
          CFI Block cfiBlock0 Using cfiCommon0
          CFI Function EDIT_CreateIndirect
        THUMB
//   34 EDIT_Handle EDIT_CreateIndirect(const GUI_WIDGET_CREATE_INFO* pCreateInfo, WM_HWIN hWinParent, int x0, int y0, WM_CALLBACK* cb) {
EDIT_CreateIndirect:
        PUSH     {R4,R5,LR}
          CFI R14 Frame(CFA, -4)
          CFI R5 Frame(CFA, -8)
        ...
        MOV      R0,R2
        MOV      R5,R3
//   35   EDIT_Handle hEdit;
//   36   GUI_USE_PARA(cb);
//   37   hEdit = EDIT_CreateEx(pCreateInfo->x0 + x0, pCreateInfo->y0 + y0, pCreateInfo->xSize, pCreateInfo->ySize,
//   38                         hWinParent, 0, pCreateInfo->Flags, pCreateInfo->Id, pCreateInfo->Para);
        LDR      R2,[R4, #+20]
        STR      R2,[SP, #+16]
        LDRSH    R2,[R4, #+8]
        STR      R2,[SP, #+12]
        ...
        LDRSH    R5,[R4, #+10]
        ADDS     R0,R0,R5
          CFI FunCall EDIT_CreateEx
        BL       EDIT_CreateEx
        MOVS     R5,R0
//   39   if (hEdit) {
        BEQ.N    ??EDIT_CreateIndirect_0
//   40     EDIT_SetTextAlign(hEdit, pCreateInfo->Flags);
        LDRH     R1,[R4, #+18]
          CFI FunCall EDIT_SetTextAlign
        BL       EDIT_SetTextAlign
//   41   }
//   42   return hEdit;
...
//   46   void EDIT_CreateIndirect_C(void) {}
//   47 #endif
// 
