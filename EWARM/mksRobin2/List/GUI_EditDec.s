...
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\GUI_EditDec.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\GUI_EditDec.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\EWARM\mksRobin2/List\GUI_EditDec.s
//
///////////////////////////////////////////////////////////////////////////////
...
//   35 */
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI Function GUI_EditDec
        THUMB
//   36 I32 GUI_EditDec(I32 Value, I32 Min, I32 Max, int Len, int xsize, int Shift, U8 Flags) {
GUI_EditDec:
        PUSH     {R4-R11,LR}
          CFI R14 Frame(CFA, -4)
          CFI R11 Frame(CFA, -8)
...
//   49   pObj = EDIT_H2P(hEdit);
        ...
        BL       GUI_ALLOC_h2p
        MOV      R9,R0
//   50   EDIT_SetDecMode(hEdit, Value, Min, Max, Shift, Flags);
        LDR      R0,[SP, #+64]
        STR      R0,[SP, #+4]
        LDR      R0,[SP, #+60]
        STR      R0,[SP, #+0]
...
//   63 
//   64 void GUI_EditDec_C(void);
//   65 void GUI_EditDec_C(void){}
//   66 
//   67 #endif
// 
