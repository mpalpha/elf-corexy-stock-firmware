...
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\WM\WM__ForEachDesc.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\WM\WM__ForEachDesc.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\EWARM\mksRobin2/List\WM__ForEachDesc.s
//
///////////////////////////////////////////////////////////////////////////////
...
//   13 *
//   14 ----------------------------------------------------------------------
//   15 File        : WM__ForEachDesc.c
//   16 Purpose     : Implementation of WM__ForEachDesc
//   17 ----------------------------------------------------------------------
//   18 */
//   19 
...
//   33 */
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI Function WM__ForEachDesc
        THUMB
//   34 void WM__ForEachDesc(WM_HWIN hWin, WM_tfForEach * pcb, void * pData) {
WM__ForEachDesc:
        PUSH     {R3-R7,LR}
          CFI R14 Frame(CFA, -4)
          CFI R7 Frame(CFA, -8)
...
//   38   pWin = WM_H2P(hWin);
        ...
        BL       GUI_ALLOC_h2p
//   39   for (hChild = pWin->hFirstChild; hChild; hChild = pChild->hNext) {
        LDRSH    R6,[R0, #+24]
        B.N      ??WM__ForEachDesc_0
//   40     pChild = WM_H2P(hChild);
??WM__ForEachDesc_1:
        MOV      R0,R6
          CFI FunCall GUI_ALLOC_h2p
        BL       GUI_ALLOC_h2p
...
//   41     pcb(hChild, pData);
        ...
        MOV      R0,R6
          CFI FunCall
        BLX      R4
//   42     WM_ForEachDesc(hChild, pcb, pData);
        MOV      R2,R5
        MOV      R1,R4
        MOV      R0,R6
...
//   45 
//   46 #else
//   47   void WM__ForEachDesc_C(void);
//   48   void WM__ForEachDesc_C(void) {} /* avoid empty object files */
//   49 #endif
//   50 
//   51 /*************************** End of file ****************************/
// 
