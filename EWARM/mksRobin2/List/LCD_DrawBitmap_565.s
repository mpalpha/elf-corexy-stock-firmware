...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_ºŒ∫Ã»˝Œ¨\mksRobin_Nano_code\EWARM\mksRobin2/List\LCD_DrawBitmap_565.s
//
///////////////////////////////////////////////////////////////////////////////
...
//   58     LCD_DrawBitmap(x0, y0, xsize, ysize, 1, 1, 16, BytesPerLine, pPixel, 0);
        ...
        BL       LCD_DrawBitmap
        B.N      ??_DrawBitmap_565_2
//   59   } else {
//   60     if (Mag == 1) {
??_DrawBitmap_565_1:
        CMP      R1,#+1
        BNE.N    ??_DrawBitmap_565_3
//   61       /* Perform clipping */
//   62       int x1, y1, Diff;
//   63       y1 = y0 + ysize - 1;
        ADDS     R0,R6,R4
...
//  106           if (Index != PrevIndex) {
        CMP      R10,R11
        BEQ.N    ??_DrawBitmap_565_10
//  107             LCD_SetColor(LCD_Index2Color_565(Index));
        MOV      R0,R10
          CFI FunCall LCD_Index2Color_565
        BL       LCD_Index2Color_565
...
??_DrawBitmap_565_8:
        CMP      R8,R6
        BGE.N    ??_DrawBitmap_565_12
        STR      R7,[SP, #+0]
        MOV      R9,#+0
        B.N      ??_DrawBitmap_565_11
//  113       }
//  114     } else {
...
GUI_BitmapMethods565:
        DC32 _DrawBitmap_565, LCD_Index2Color_565
