...
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\ConvertMono\LCDP2.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\ConvertMono\LCDP2.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\EWARM\mksRobin2/List\LCDP2.s
//
///////////////////////////////////////////////////////////////////////////////
        ...
        PUBLIC LCD_Color2Index_2
        PUBLIC LCD_GetIndexMask_2
        PUBLIC LCD_Index2Color_2
...
//   31 /*********************************************************************
//   32 *
//   33 *       LCD_Color2Index_2
//   34 *
//   35 * Purpose
//   36 *   API table for this color conversion mode. Only used by memory
//   37 *   devices in this mode.
//   38 */
//   39 const LCD_API_COLOR_CONV LCD_API_ColorConv_2 = {
//   40   LCD_Color2Index_2,
//   41   LCD_Index2Color_2,
//   42   LCD_GetIndexMask_2
//   43 };
//   44 
//   45 #endif
//   46 
...
//   53 /*********************************************************************
//   54 *
//   55 *       LCD_Color2Index_2
//   56 */

        SECTION `.text`:CODE:NOROOT(1)
          CFI Block cfiBlock0 Using cfiCommon0
          CFI Function LCD_Color2Index_2
          CFI NoCalls
        THUMB
...
//   65 /*********************************************************************
//   66 *
//   67 *       LCD_Index2Color_2
//   68 */

        SECTION `.text`:CODE:NOROOT(1)
          CFI Block cfiBlock1 Using cfiCommon0
          CFI Function LCD_Index2Color_2
          CFI NoCalls
        THUMB
//   69 LCD_COLOR LCD_Index2Color_2(int Index) {
//   70   return ((U32)Index)*0x555555;
LCD_Index2Color_2:
        LDR.N    R1,??DataTable0  ;; 0x555555
        MULS     R0,R1,R0
        BX       LR               ;; return
...
//   73 /*********************************************************************
//   74 *
//   75 *       LCD_GetIndexMask_2
//   76 */

        SECTION `.text`:CODE:NOROOT(1)
          CFI Block cfiBlock2 Using cfiCommon0
          CFI Function LCD_GetIndexMask_2
          CFI NoCalls
        THUMB
