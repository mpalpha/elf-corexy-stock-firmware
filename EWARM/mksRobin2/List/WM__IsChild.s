...
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\WM\WM__IsChild.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\WM\WM__IsChild.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\EWARM\mksRobin2/List\WM__IsChild.s
//
///////////////////////////////////////////////////////////////////////////////
...
//   13 *
//   14 ----------------------------------------------------------------------
//   15 File        : WM__IsChild.c
//   16 Purpose     : Implementation of WM__IsChild
//   17 ----------------------------------------------------------------------
//   18 */
//   19 
...
//   33 */
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI Function WM__IsChild
        THUMB
//   34 int WM__IsChild(WM_HWIN hWin, WM_HWIN hParent) {
WM__IsChild:
        PUSH     {R3-R5,LR}
          CFI R14 Frame(CFA, -4)
          CFI R5 Frame(CFA, -8)
...
//   36   if (hWin) {
        CMP      R0,#+0
        BEQ.N    ??WM__IsChild_0
//   37     WM_Obj *pObj = WM_H2P(hWin);
          CFI FunCall GUI_ALLOC_h2p
        BL       GUI_ALLOC_h2p
//   38     if (pObj) {
        CMP      R0,#+0
        BEQ.N    ??WM__IsChild_0
//   39       if (pObj->hParent == hParent) {
        LDRSH    R0,[R0, #+22]
        CMP      R0,R4
        BNE.N    ??WM__IsChild_0
//   40         r = 1;
...
//   46 
//   47 #else
//   48   void WM__IsChild_c(void) {} /* avoid empty object files */
//   49 #endif
//   50 
//   51 /*************************** End of file ****************************/
// 
