...
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\WM\WM_IsVisible.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\WM\WM_IsVisible.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\EWARM\mksRobin2/List\WM_IsVisible.s
//
///////////////////////////////////////////////////////////////////////////////
...
//   34 */
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI Function WM_IsVisible
        THUMB
//   35 int WM_IsVisible(WM_HWIN hWin) {
WM_IsVisible:
        PUSH     {R4,LR}
          CFI R14 Frame(CFA, -4)
          CFI R4 Frame(CFA, -8)
...
//   37   if (hWin) {
        CMP      R0,#+0
        BEQ.N    ??WM_IsVisible_0
//   38     WM_Obj * pWin;
//   39     WM_LOCK();
//   40     pWin = WM_H2P(hWin);
          CFI FunCall GUI_ALLOC_h2p
        BL       GUI_ALLOC_h2p
//   41     if (pWin->Status & WM_SF_ISVIS) {
        LDRB     R0,[R0, #+28]
        LSLS     R0,R0,#+30
        BPL.N    ??WM_IsVisible_0
//   42       r = 1;
        MOVS     R4,#+1
//   43     }
//   44     WM_UNLOCK();
...
//   48 
//   49 #else
//   50   void WM_IsVisible_C(void) {} /* avoid empty object files */
//   51 #endif
//   52 
//   53 /*************************** End of file ****************************/
// 
