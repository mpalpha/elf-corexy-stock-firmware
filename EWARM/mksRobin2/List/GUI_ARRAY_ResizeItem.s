...
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_ºŒ∫Ã»˝Œ¨\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\GUI_ARRAY_ResizeItem.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_ºŒ∫Ã»˝Œ¨\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\GUI_ARRAY_ResizeItem.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_ºŒ∫Ã»˝Œ¨\mksRobin_Nano_code\EWARM\mksRobin2/List\GUI_ARRAY_ResizeItem.s
//
///////////////////////////////////////////////////////////////////////////////
        ...
        EXTERN GUI_ARRAY_SethItem
        EXTERN memcpy

        PUBLIC GUI_ARRAY_ResizeItem
...
//   41 */
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI Function GUI_ARRAY_ResizeItem
        THUMB
...
//   50     if (GUI_ARRAY_SethItem(pThis, Index, hNew)) {
        ...
        MOV      R1,R5
        MOV      R0,R4
          CFI FunCall GUI_ARRAY_SethItem
        BL       GUI_ARRAY_SethItem
        CMP      R0,#+0
        BEQ.N    ??GUI_ARRAY_ResizeItem_1
//   51       GUI_ALLOC_FreePtr(&hNew);    /* Free on error */
        ADD      R0,SP,#+0
          CFI FunCall GUI_ALLOC_FreePtr
        BL       GUI_ALLOC_FreePtr
        B.N      ??GUI_ARRAY_ResizeItem_0
//   52     } else {
//   53       r = pNew;
??GUI_ARRAY_ResizeItem_1:
        MOV      R7,R9
//   54     }
//   55   }
//   56   return r;
??GUI_ARRAY_ResizeItem_0:
        MOV      R0,R7
