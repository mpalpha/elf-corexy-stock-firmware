...
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_ºŒ∫Ã»˝Œ¨\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\GUI_ARRAY_DeleteItem.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_ºŒ∫Ã»˝Œ¨\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\GUI_ARRAY_DeleteItem.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_ºŒ∫Ã»˝Œ¨\mksRobin_Nano_code\EWARM\mksRobin2/List\GUI_ARRAY_DeleteItem.s
//
///////////////////////////////////////////////////////////////////////////////
...
//   42 */
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI Function GUI_ARRAY_DeleteItem
        THUMB
...
//   47   if (Index < (unsigned)pThis->NumItems) {
        LDRH     R0,[R5, #+0]
        CMP      R4,R0
        BCS.N    ??GUI_ARRAY_DeleteItem_0
//   48     ha = pThis->haHandle;
        LDRSH    R0,[R5, #+2]
//   49     if (ha) {
        CMP      R0,#+0
        BEQ.N    ??GUI_ARRAY_DeleteItem_0
//   50       int NumItems;
//   51       WM_LOCK();
