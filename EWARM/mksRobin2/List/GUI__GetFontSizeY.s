...
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Core\GUI__GetFontSizeY.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Core\GUI__GetFontSizeY.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\EWARM\mksRobin2/List\GUI__GetFontSizeY.s
//
///////////////////////////////////////////////////////////////////////////////
...
//   31 */
        ...
        SECTION `.text`:CODE:NOROOT(2)
          ...
          CFI Function GUI__GetFontSizeY
          CFI NoCalls
        THUMB
//   32 int GUI__GetFontSizeY(void) {
GUI__GetFontSizeY:
        LDR.N    R0,??GUI__GetFontSizeY_0
        LDR      R0,[R0, #+24]
        LDRB     R1,[R0, #+20]
        LDRSB    R0,[R0, #+23]
        MULS     R0,R0,R1
