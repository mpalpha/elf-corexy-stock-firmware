///////////////////////////////////////////////////////////////////////////////
//
// IAR ANSI C/C++ Compiler V7.10.1.6676/W32 for ARM       25/Feb/2020  16:59:40
// Copyright 1999-2014 IAR Systems AB.
//
//    Cpu mode     =  thumb
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\GUI_DRAW_BITMAP.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\GUI_DRAW_BITMAP.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\EWARM\mksRobin2/List\GUI_DRAW_BITMAP.s
//
///////////////////////////////////////////////////////////////////////////////
...
//   35 */
        ...
        THUMB
//   36 static void _DrawBitmap(const GUI_DRAW* pObj, int x, int y) {
//   37   GUI_DrawBitmap((const GUI_BITMAP *)pObj->Data.pData, x + pObj->xOff, y + pObj->yOff);
_DrawBitmap:
        LDRSH    R3,[R0, #+10]
        ADDS     R2,R3,R2
        LDRSH    R3,[R0, #+8]
...
//   45   return ((const GUI_BITMAP *)pObj->Data.pData)->XSize;
_GetXSize:
        LDR      R0,[R0, #+4]
        LDRH     R0,[R0, #+0]
        BX       LR               ;; return
...
//   53   return ((const GUI_BITMAP *)pObj->Data.pData)->YSize;
_GetYSize:
        LDR      R0,[R0, #+4]
        LDRH     R0,[R0, #+2]
        BX       LR               ;; return
...
//   74 /*********************************************************************
//   75 *
//   76 *       GUI_DRAW_BITMAP_Create
//   77 */

        SECTION `.text`:CODE:NOROOT(1)
          CFI Block cfiBlock3 Using cfiCommon0
          CFI Function GUI_DRAW_BITMAP_Create
        THUMB
//   78 WM_HMEM GUI_DRAW_BITMAP_Create(const GUI_BITMAP* pBitmap, int x, int y) {
...
//   79   GUI_DRAW* pObj;
//   80   WM_HMEM hMem;
//   81   hMem = GUI_ALLOC_AllocZero(sizeof(GUI_DRAW));
        MOVS     R0,#+12
          CFI FunCall GUI_ALLOC_AllocZero
        BL       GUI_ALLOC_AllocZero
        MOVS     R7,R0
//   82   if (hMem) {
        BEQ.N    ??GUI_DRAW_BITMAP_Create_0
//   83     WM_LOCK();
...
//   85     pObj->pConsts    = &_ConstObjData;
        ...
        STR      R1,[R0, #+0]
//   86     pObj->Data.pData = (const void*)pBitmap;
        STR      R4,[R0, #+4]
//   87     pObj->xOff       = x;
        STRH     R5,[R0, #+8]
//   88     pObj->yOff       = y;
...
//   92 }
        ...
        DATA
_ConstObjData:
        DC32 _DrawBitmap, _GetXSize, _GetYSize
...
//   96   void GUI_DRAW_BITMAP_C(void) {}
//   97 #endif
// 
