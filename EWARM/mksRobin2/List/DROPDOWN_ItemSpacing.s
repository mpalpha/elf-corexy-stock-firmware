...
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\DROPDOWN_ItemSpacing.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\Middlewares\Ucgui\GUI\Widget\DROPDOWN_ItemSpacing.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano_tft35_¼ÎºÌÈýÎ¬\mksRobin_Nano_code\EWARM\mksRobin2/List\DROPDOWN_ItemSpacing.s
//
///////////////////////////////////////////////////////////////////////////////
        ...
        PUBLIC DROPDOWN_GetItemSpacing
        PUBLIC DROPDOWN_SetItemSpacing
...
//   13 *
//   14 ----------------------------------------------------------------------
//   15 File        : DROPDOWN_ItemSpacing.c
//   16 Purpose     : Implementation of DROPDOWN_SetItemSpacing & DROPDOWN_GetItemSpacing
//   17 ---------------------------END-OF-HEADER------------------------------
//   18 */
//   19 
...
//   32 /*********************************************************************
//   33 *
//   34 *       DROPDOWN_SetItemSpacing
//   35 */

        SECTION `.text`:CODE:NOROOT(1)
          CFI Block cfiBlock0 Using cfiCommon0
          CFI Function DROPDOWN_SetItemSpacing
        THUMB
//   36 void DROPDOWN_SetItemSpacing(DROPDOWN_Handle hObj, unsigned Value) {
...
//   37   if (hObj) {
        CMP      R0,#+0
        BEQ.N    ??DROPDOWN_SetItemSpacing_0
//   38     DROPDOWN_Obj* pObj;
//   39     WM_LOCK();
//   40     pObj = DROPDOWN_H2P(hObj);
          CFI FunCall GUI_ALLOC_h2p
        BL       GUI_ALLOC_h2p
//   41     pObj->ItemSpacing = Value;
        STRH     R4,[R0, #+100]
//   42     if (pObj->hListWin) {
        LDRSH    R0,[R0, #+96]
        CMP      R0,#+0
        BEQ.N    ??DROPDOWN_SetItemSpacing_0
//   43       LISTBOX_SetItemSpacing(pObj->hListWin, Value);
        MOV      R1,R4
        POP      {R4,LR}
          CFI R4 SameValue
          CFI R14 SameValue
...
//   49 /*********************************************************************
//   50 *
//   51 *       DROPDOWN_GetItemSpacing
//   52 */

        SECTION `.text`:CODE:NOROOT(1)
          CFI Block cfiBlock1 Using cfiCommon0
          CFI Function DROPDOWN_GetItemSpacing
        THUMB
//   53 unsigned DROPDOWN_GetItemSpacing(DROPDOWN_Handle hObj) {
...
//   55   if (hObj) {
        CMP      R1,#+0
        BNE.N    ??DROPDOWN_GetItemSpacing_0
        BX       LR
//   56     DROPDOWN_Obj* pObj;
//   57     WM_LOCK();
//   58     pObj = DROPDOWN_H2P(hObj);
...
//   66   void DROPDOWN_ItemSpacing_C(void);
//   67   void DROPDOWN_ItemSpacing_C(void) {}
//   68 #endif
// 
