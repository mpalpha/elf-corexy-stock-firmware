...
uint8_t FATFS_LinkDriverEx_sd(Diskio_drvTypeDef *drv, char *path, uint8_t lun)
{
  uint8_t ret = 1;
  uint8_t DiskNum = 0;
...
uint8_t FATFS_LinkDriverEx_usb(Diskio_drvTypeDef *drv, char *path, uint8_t lun)
{
  uint8_t ret = 1;
  uint8_t DiskNum = 0;
...
uint8_t FATFS_LinkDriver_sd(Diskio_drvTypeDef *drv, char *path)
{
  return FATFS_LinkDriverEx_sd(drv, path, 0);
}
uint8_t FATFS_LinkDriver_usb(Diskio_drvTypeDef *drv, char *path)
{
  return FATFS_LinkDriverEx_usb(drv, path, 0);
}
