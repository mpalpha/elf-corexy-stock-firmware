...
char *cfg_file = "robin_nano_cfg.txt";	
char *cfg_file_cur = "robin_nano_cfg.CUR";
#endif
...
//FILAMENT_CHANGE_X_POS
	...
	eprBurnValue(">HOME_X_POS", &mksReprint.mks_zero_x, EPR_ZERO_X_POS);
	eprBurnValue(">HOME_Y_POS", &mksReprint.mks_zero_y, EPR_ZERO_Y_POS);
...
//CUSTOMER CMD
	...
	eprBurnValue(">ENABLE_LED", (uint8_t *)&gCfgItems.enable_led, EPR_ENABLE_LED);
	eprBurnValue(">ENABLE_OFF", (uint8_t *)&gCfgItems.enable_off, EPR_ENABLE_OFF);
...
//#if ENABLED(DELTA)
	...
	mksReprint.mks_zero_x=50;
	mksReprint.mks_zero_y=50;
...
/*--mks cfg XYZ_CONSTS_FROM_CONFIG END--*/
	...
	epr_read_data((int)EPR_ZERO_X_POS, (uint8_t*)&mksReprint.mks_zero_x, sizeof(mksReprint.mks_zero_x)); 
	epr_read_data((int)EPR_ZERO_Y_POS, (uint8_t*)&mksReprint.mks_zero_y, sizeof(mksReprint.mks_zero_y)); 
